...
#line 66 "../INSTALL/dsecndtst.f"
	y[i__ - 1] = (doublereal) (1000 - i__) / 1e3;
#line 67 "../INSTALL/dsecndtst.f"
/* L10: */
#line 67 "../INSTALL/dsecndtst.f"
    }
#line 68 "../INSTALL/dsecndtst.f"
    alpha = .315;
...
#line 83 "../INSTALL/dsecndtst.f"
	e_wsfe();
#line 84 "../INSTALL/dsecndtst.f"
    } else {
#line 85 "../INSTALL/dsecndtst.f"
	s_wsfe(&io___12);
#line 85 "../INSTALL/dsecndtst.f"
	e_wsfe();
#line 86 "../INSTALL/dsecndtst.f"
    }
...
#line 95 "../INSTALL/dsecndtst.f"
	alpha = -alpha;
#line 96 "../INSTALL/dsecndtst.f"
	t2 = dsecnd_();
#line 97 "../INSTALL/dsecndtst.f"
/* L50: */
#line 97 "../INSTALL/dsecndtst.f"
    }
...
#line 102 "../INSTALL/dsecndtst.f"
    e_wsfe();
#line 103 "../INSTALL/dsecndtst.f"
    avg = (t2 - t1 - tnosec) * 1e3 / 5e4;
#line 104 "../INSTALL/dsecndtst.f"
    if (avg > 0.) {
#line 104 "../INSTALL/dsecndtst.f"
	s_wsfe(&io___15);
#line 104 "../INSTALL/dsecndtst.f"
...
#line 121 "../INSTALL/dsecndtst.f"
    mysub_(&c__1000, x, y);
#line 122 "../INSTALL/dsecndtst.f"
    return 0;
} /* MAIN__ */

/* Subroutine */ int mysub_(integer *n, doublereal *x, doublereal *y)
{
#line 126 "../INSTALL/dsecndtst.f"
