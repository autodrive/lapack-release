#line 1 "../INSTALL/second_EXT_ETIME.f"
/* ../INSTALL/second_EXT_ETIME.f -- translated by f2c (version 20100827).
...
#line 57 "../INSTALL/second_EXT_ETIME.f"
    t1 = etime_(tarray);
#line 58 "../INSTALL/second_EXT_ETIME.f"
    ret_val = tarray[0];
#line 59 "../INSTALL/second_EXT_ETIME.f"
    return ret_val;
