	...
	integer *lwork, doublereal *rwork, integer *info)
{
    ...
    extern /* Subroutine */ int cgebrd_(), slabad_(doublereal *, doublereal *)
	    ;
...
#line 288 "cgelss.f"
		cgebrd_(&mm, n, &a[a_offset], lda, &s[1], dum, dum, dum, dum, 
			&c_n1, info);
#line 290 "cgelss.f"
...
/*                 Compute space needed for CGEBRD */
#line 318 "cgelss.f"
		    cgebrd_(m, m, &a[a_offset], lda, &s[1], dum, dum, dum, 
			    dum, &c_n1, info);
#line 320 "cgelss.f"
		    lwork_cgebrd__ = (integer) dum[0].r;
/*                 Compute space needed for CUNMBR */
...
/*                 Compute space needed for CGEBRD */
#line 349 "cgelss.f"
		    cgebrd_(m, n, &a[a_offset], lda, &s[1], dum, dum, dum, 
			    dum, &c_n1, info);
#line 351 "cgelss.f"
		    lwork_cgebrd__ = (integer) dum[0].r;
/*                 Compute space needed for CUNMBR */
