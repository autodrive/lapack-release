...
#line 286 "chbev_2stage.f"
	    lwtrd = ilaenv_(&c__20, "CHETRD_HB2ST", jobz, n, kd, &ib, &c_n1, (
		    ftnlen)12, (ftnlen)1);
#line 287 "chbev_2stage.f"
	    lwmin = lhtrd + lwtrd;
#line 288 "chbev_2stage.f"
	    work[1].r = (doublereal) lwmin, work[1].i = 0.;
#line 289 "chbev_2stage.f"
	}
...
#line 293 "chbev_2stage.f"
    }

#line 295 "chbev_2stage.f"
    if (*info != 0) {
#line 296 "chbev_2stage.f"
	i__1 = -(*info);
#line 296 "chbev_2stage.f"
	xerbla_("CHBEV_2STAGE ", &i__1, (ftnlen)13);
#line 297 "chbev_2stage.f"
	return 0;
...
#line 307 "chbev_2stage.f"
    if (*n == 1) {
#line 308 "chbev_2stage.f"
	if (lower) {
#line 309 "chbev_2stage.f"
	    i__1 = ab_dim1 + 1;
#line 309 "chbev_2stage.f"
	    w[1] = ab[i__1].r;
...
#line 320 "chbev_2stage.f"
    safmin = slamch_("Safe minimum", (ftnlen)12);
#line 321 "chbev_2stage.f"
    eps = slamch_("Precision", (ftnlen)9);
#line 322 "chbev_2stage.f"
    smlnum = safmin / eps;
...
#line 329 "chbev_2stage.f"
    anrm = clanhb_("M", uplo, n, kd, &ab[ab_offset], ldab, &rwork[1], (ftnlen)
	    1, (ftnlen)1);
#line 330 "chbev_2stage.f"
    iscale = 0;
#line 331 "chbev_2stage.f"
    if (anrm > 0. && anrm < rmin) {
...
#line 348 "chbev_2stage.f"
    inde = 1;
#line 349 "chbev_2stage.f"
    indhous = 1;
#line 350 "chbev_2stage.f"
...
#line 359 "chbev_2stage.f"
    if (! wantz) {
#line 360 "chbev_2stage.f"
	ssterf_(n, &w[1], &rwork[inde], info);
#line 361 "chbev_2stage.f"
    } else {
...
#line 369 "chbev_2stage.f"
    if (iscale == 1) {
#line 370 "chbev_2stage.f"
	if (*info == 0) {
#line 371 "chbev_2stage.f"
	    imax = *n;
...
#line 380 "chbev_2stage.f"
    work[1].r = (doublereal) lwmin, work[1].i = 0.;

#line 382 "chbev_2stage.f"
    return 0;
