...
#line 369 "cheevd_2stage.f"
    if (*n == 1) {
#line 370 "cheevd_2stage.f"
	i__1 = a_dim1 + 1;
#line 370 "cheevd_2stage.f"
	w[1] = a[i__1].r;
#line 371 "cheevd_2stage.f"
	if (wantz) {
#line 371 "cheevd_2stage.f"
	    i__1 = a_dim1 + 1;
#line 371 "cheevd_2stage.f"
...
#line 379 "cheevd_2stage.f"
    eps = slamch_("Precision", (ftnlen)9);
#line 380 "cheevd_2stage.f"
    smlnum = safmin / eps;
#line 381 "cheevd_2stage.f"
    bignum = 1. / smlnum;
...
#line 387 "cheevd_2stage.f"
    anrm = clanhe_("M", uplo, n, &a[a_offset], lda, &rwork[1], (ftnlen)1, (
	    ftnlen)1);
#line 388 "cheevd_2stage.f"
    iscale = 0;
#line 389 "cheevd_2stage.f"
    if (anrm > 0. && anrm < rmin) {
#line 390 "cheevd_2stage.f"
	iscale = 1;
...
#line 401 "cheevd_2stage.f"
    inde = 1;
#line 402 "cheevd_2stage.f"
    indrwk = inde + *n;
#line 403 "cheevd_2stage.f"
    llrwk = *lrwork - indrwk + 1;
#line 404 "cheevd_2stage.f"
    indtau = 1;
...
#line 421 "cheevd_2stage.f"
    if (! wantz) {
#line 422 "cheevd_2stage.f"
	ssterf_(n, &w[1], &rwork[inde], info);
#line 423 "cheevd_2stage.f"
    } else {
#line 424 "cheevd_2stage.f"
...
#line 434 "cheevd_2stage.f"
    if (iscale == 1) {
#line 435 "cheevd_2stage.f"
	if (*info == 0) {
#line 436 "cheevd_2stage.f"
	    imax = *n;
#line 437 "cheevd_2stage.f"
	} else {
