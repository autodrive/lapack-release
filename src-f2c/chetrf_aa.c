...
#line 205 "chetrf_aa.f"
	return 0;
#line 206 "chetrf_aa.f"
    } else if (lquery) {
#line 207 "chetrf_aa.f"
	return 0;
...
#line 215 "chetrf_aa.f"
    ipiv[1] = 1;
#line 216 "chetrf_aa.f"
    if (*n == 1) {
#line 217 "chetrf_aa.f"
	i__1 = a_dim1 + 1;
#line 217 "chetrf_aa.f"
	i__2 = a_dim1 + 1;
#line 217 "chetrf_aa.f"
...
#line 221 "chetrf_aa.f"
	return 0;
#line 222 "chetrf_aa.f"
    }

/*     Adjubst block size based on the workspace size */

#line 226 "chetrf_aa.f"
    if (*lwork < (nb + 1) * *n) {
#line 227 "chetrf_aa.f"
	nb = (*lwork - *n) / *n;
#line 228 "chetrf_aa.f"
    }

#line 230 "chetrf_aa.f"
    if (upper) {
...
#line 244 "chetrf_aa.f"
	j = 0;
#line 245 "chetrf_aa.f"
L10:
#line 246 "chetrf_aa.f"
	if (j >= *n) {
#line 246 "chetrf_aa.f"
	    goto L20;
#line 246 "chetrf_aa.f"
...
#line 256 "chetrf_aa.f"
	j1 = j + 1;
/* Computing MIN */
#line 257 "chetrf_aa.f"
	i__1 = *n - j1 + 1;
#line 257 "chetrf_aa.f"
	jb = min(i__1,nb);
#line 258 "chetrf_aa.f"
	k1 = max(1,j) - j;
...
#line 285 "chetrf_aa.f"
	if (j < *n) {

/*          if the first panel and JB=1 (NB=1), then nothing to do */

#line 289 "chetrf_aa.f"
	    if (j1 > 1 || jb > 1) {

/*              Merge rank-1 update with BLAS-3 update */

#line 293 "chetrf_aa.f"
		d_cnjg(&z__1, &a[j + (j + 1) * a_dim1]);
#line 293 "chetrf_aa.f"
		alpha.r = z__1.r, alpha.i = z__1.i;
#line 294 "chetrf_aa.f"
		i__1 = j + (j + 1) * a_dim1;
#line 294 "chetrf_aa.f"
		a[i__1].r = 1., a[i__1].i = 0.;
#line 295 "chetrf_aa.f"
		i__1 = *n - j;
#line 295 "chetrf_aa.f"
...
#line 303 "chetrf_aa.f"
		if (j1 > 1) {

/*                 Not first panel */

#line 307 "chetrf_aa.f"
		    k2 = 1;
...
#line 312 "chetrf_aa.f"
		    k2 = 0;

/*                 First update skips the first column */

#line 316 "chetrf_aa.f"
		    --jb;
#line 317 "chetrf_aa.f"
		}

#line 319 "chetrf_aa.f"
		i__1 = *n;
#line 319 "chetrf_aa.f"
		i__2 = nb;
#line 319 "chetrf_aa.f"
...
#line 324 "chetrf_aa.f"
		    j3 = j2;
#line 325 "chetrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
#line 326 "chetrf_aa.f"
			i__3 = jb + 1;
#line 326 "chetrf_aa.f"
			z__1.r = -1., z__1.i = -0.;
#line 326 "chetrf_aa.f"
			cgemm_("Conjugate transpose", "Transpose", &c__1, &mj,
				...
				;
#line 331 "chetrf_aa.f"
			++j3;
#line 332 "chetrf_aa.f"
		    }

/*                 Update off-diagonal block of J2-th block row with CGEMM */

#line 336 "chetrf_aa.f"
		    i__3 = *n - j3 + 1;
#line 336 "chetrf_aa.f"
		    i__4 = jb + 1;
#line 336 "chetrf_aa.f"
...
#line 345 "chetrf_aa.f"
		i__2 = j + (j + 1) * a_dim1;
#line 345 "chetrf_aa.f"
		d_cnjg(&z__1, &alpha);
#line 345 "chetrf_aa.f"
		a[i__2].r = z__1.r, a[i__2].i = z__1.i;
#line 346 "chetrf_aa.f"
	    }

/*           WORK(J+1, 1) stores H(J+1, 1) */

#line 350 "chetrf_aa.f"
	    i__2 = *n - j;
#line 350 "chetrf_aa.f"
	    ccopy_(&i__2, &a[j + 1 + (j + 1) * a_dim1], lda, &work[1], &c__1);
#line 351 "chetrf_aa.f"
	}
#line 352 "chetrf_aa.f"
	goto L10;
#line 353 "chetrf_aa.f"
    } else {
...
#line 386 "chetrf_aa.f"
	clahef_aa__(uplo, &i__2, &i__1, &jb, &a[j + 1 + max(1,j) * a_dim1], 
		lda, &ipiv[j + 1], &work[1], n, &work[*n * nb + 1], &iinfo, (
		ftnlen)1);
#line 389 "chetrf_aa.f"
	if (iinfo > 0 && *info == 0) {
#line 390 "chetrf_aa.f"
	    *info = iinfo + j;
#line 391 "chetrf_aa.f"
	}

/*        Ajust IPIV and apply it back (J-th step picks (J+1)-th pivot) */

/* Computing MIN */
#line 395 "chetrf_aa.f"
	i__1 = *n, i__3 = j + jb + 1;
#line 395 "chetrf_aa.f"
	i__2 = min(i__1,i__3);
#line 395 "chetrf_aa.f"
	for (j2 = j + 2; j2 <= i__2; ++j2) {
#line 396 "chetrf_aa.f"
	    ipiv[j2] += j;
#line 397 "chetrf_aa.f"
	    if (j2 != ipiv[j2] && j1 - k1 > 2) {
...
#line 398 "chetrf_aa.f"
		cswap_(&i__1, &a[j2 + a_dim1], lda, &a[ipiv[j2] + a_dim1], 
			lda);
#line 400 "chetrf_aa.f"
	    }
#line 401 "chetrf_aa.f"
	}
...
#line 418 "chetrf_aa.f"
		i__2 = *n - j;
#line 418 "chetrf_aa.f"
		ccopy_(&i__2, &a[j + 1 + (j - 1) * a_dim1], &c__1, &work[j + 
			1 - j1 + 1 + jb * *n], &c__1);
#line 420 "chetrf_aa.f"
		i__2 = *n - j;
#line 420 "chetrf_aa.f"
...
#line 430 "chetrf_aa.f"
		    k2 = 1;
#line 431 "chetrf_aa.f"
		} else {
...
#line 439 "chetrf_aa.f"
		    --jb;
#line 440 "chetrf_aa.f"
		}

#line 442 "chetrf_aa.f"
		i__2 = *n;
#line 442 "chetrf_aa.f"
		i__1 = nb;
#line 442 "chetrf_aa.f"
...
#line 447 "chetrf_aa.f"
		    j3 = j2;
#line 448 "chetrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
#line 449 "chetrf_aa.f"
			i__3 = jb + 1;
#line 449 "chetrf_aa.f"
			z__1.r = -1., z__1.i = -0.;
#line 449 "chetrf_aa.f"
...
#line 468 "chetrf_aa.f"
		i__1 = j + 1 + j * a_dim1;
#line 468 "chetrf_aa.f"
		d_cnjg(&z__1, &alpha);
#line 468 "chetrf_aa.f"
		a[i__1].r = z__1.r, a[i__1].i = z__1.i;
#line 469 "chetrf_aa.f"
	    }

/*           WORK(J+1, 1) stores H(J+1, 1) */

#line 473 "chetrf_aa.f"
	    i__1 = *n - j;
#line 473 "chetrf_aa.f"
	    ccopy_(&i__1, &a[j + 1 + (j + 1) * a_dim1], &c__1, &work[1], &
		    c__1);
#line 474 "chetrf_aa.f"
	}
#line 475 "chetrf_aa.f"
	goto L11;
#line 476 "chetrf_aa.f"
    }

#line 478 "chetrf_aa.f"
L20:
#line 479 "chetrf_aa.f"
    return 0;
