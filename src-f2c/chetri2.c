...
/*  ===================================================================== */
/* Subroutine */ int chetri2_(char *uplo, integer *n, doublecomplex *a, 
	...
	integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int chetri2x_(char *, integer *, doublecomplex *, 
    ...
    extern /* Subroutine */ int chetri_(char *, integer *, doublecomplex *, 
