	...
	uplo_len)
{
    ...
    extern /* Subroutine */ int chpcon_(char *, integer *, doublecomplex *, 
	    integer *, doublereal *, doublereal *, doublecomplex *, integer *,
	     ftnlen), clacpy_(char *, integer *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, ftnlen), xerbla_(char *, 
	    integer *, ftnlen), chprfs_(char *, integer *, integer *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, doublereal *, doublereal *,
	     doublecomplex *, doublereal *, integer *, ftnlen), chptrf_(char *
	    , integer *, doublecomplex *, integer *, integer *, ftnlen), 
	    chptrs_(char *, integer *, integer *, doublecomplex *, integer *, 
