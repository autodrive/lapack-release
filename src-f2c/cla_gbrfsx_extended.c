	...
	integer *info)
{
    ...
    extern /* Subroutine */ int blas_cgbmv2_x__(integer *, integer *, integer 
	    *, integer *, integer *, doublecomplex *, doublecomplex *, 
	    ...
	    doublecomplex *, doublecomplex *, integer *, integer *), cgbmv_(
...
#line 491 "cla_gbrfsx_extended.f"
...
#line 492 "cla_gbrfsx_extended.f"
    chla_transtype__(ch__1, (ftnlen)1, trans_type__);
#line 492 "cla_gbrfsx_extended.f"
    *(unsigned char *)trans = *(unsigned char *)&ch__1[0];
#line 493 "cla_gbrfsx_extended.f"
    eps = slamch_("Epsilon", (ftnlen)7);
#line 494 "cla_gbrfsx_extended.f"
    hugeval = slamch_("Overflow", (ftnlen)8);
/*     Force HUGEVAL to Inf */
#line 496 "cla_gbrfsx_extended.f"
    hugeval *= hugeval;
/*     Using HUGEVAL may lead to spurious underflows. */
#line 498 "cla_gbrfsx_extended.f"
    incr_thresh__ = (doublereal) (*n) * eps;
#line 499 "cla_gbrfsx_extended.f"
    m = *kl + *ku + 1;
#line 501 "cla_gbrfsx_extended.f"
    i__1 = *nrhs;
#line 501 "cla_gbrfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 502 "cla_gbrfsx_extended.f"
	y_prec_state__ = 1;
#line 503 "cla_gbrfsx_extended.f"
	if (y_prec_state__ == 2) {
#line 504 "cla_gbrfsx_extended.f"
	    i__2 = *n;
#line 504 "cla_gbrfsx_extended.f"
	    for (i__ = 1; i__ <= i__2; ++i__) {
#line 505 "cla_gbrfsx_extended.f"
		i__3 = i__;
#line 505 "cla_gbrfsx_extended.f"
		y_tail__[i__3].r = 0., y_tail__[i__3].i = 0.;
#line 506 "cla_gbrfsx_extended.f"
	    }
#line 507 "cla_gbrfsx_extended.f"
	}
#line 509 "cla_gbrfsx_extended.f"
	dxrat = 0.;
#line 510 "cla_gbrfsx_extended.f"
	dxratmax = 0.;
#line 511 "cla_gbrfsx_extended.f"
	dzrat = 0.;
#line 512 "cla_gbrfsx_extended.f"
	dzratmax = 0.;
#line 513 "cla_gbrfsx_extended.f"
	final_dx_x__ = hugeval;
#line 514 "cla_gbrfsx_extended.f"
	final_dz_z__ = hugeval;
#line 515 "cla_gbrfsx_extended.f"
	prevnormdx = hugeval;
#line 516 "cla_gbrfsx_extended.f"
	prev_dz_z__ = hugeval;
#line 517 "cla_gbrfsx_extended.f"
	dz_z__ = hugeval;
#line 518 "cla_gbrfsx_extended.f"
	dx_x__ = hugeval;
#line 520 "cla_gbrfsx_extended.f"
	x_state__ = 1;
#line 521 "cla_gbrfsx_extended.f"
	z_state__ = 0;
#line 522 "cla_gbrfsx_extended.f"
	incr_prec__ = FALSE_;
#line 524 "cla_gbrfsx_extended.f"
	i__2 = *ithresh;
#line 524 "cla_gbrfsx_extended.f"
...
#line 529 "cla_gbrfsx_extended.f"
	    ccopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 530 "cla_gbrfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 531 "cla_gbrfsx_extended.f"
		cgbmv_(trans, &m, n, kl, ku, &c_b6, &ab[ab_offset], ldab, &y[
			j * y_dim1 + 1], &c__1, &c_b8, &res[1], &c__1, (
			ftnlen)1);
#line 533 "cla_gbrfsx_extended.f"
	    } else if (y_prec_state__ == 1) {
#line 534 "cla_gbrfsx_extended.f"
		blas_cgbmv_x__(trans_type__, n, n, kl, ku, &c_b6, &ab[
			ab_offset], ldab, &y[j * y_dim1 + 1], &c__1, &c_b8, &
			res[1], &c__1, prec_type__);
#line 537 "cla_gbrfsx_extended.f"
	    } else {
#line 538 "cla_gbrfsx_extended.f"
		blas_cgbmv2_x__(trans_type__, n, n, kl, ku, &c_b6, &ab[
			ab_offset], ldab, &y[j * y_dim1 + 1], &y_tail__[1], &
			c__1, &c_b8, &res[1], &c__1, prec_type__);
#line 541 "cla_gbrfsx_extended.f"
	    }
/*        XXX: RES is no longer needed. */
#line 544 "cla_gbrfsx_extended.f"
	    ccopy_(n, &res[1], &c__1, &dy[1], &c__1);
#line 545 "cla_gbrfsx_extended.f"
	    cgbtrs_(trans, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &ipiv[1]
		    , &dy[1], n, info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 550 "cla_gbrfsx_extended.f"
	    normx = 0.;
#line 551 "cla_gbrfsx_extended.f"
	    normy = 0.;
#line 552 "cla_gbrfsx_extended.f"
	    normdx = 0.;
#line 553 "cla_gbrfsx_extended.f"
	    dz_z__ = 0.;
#line 554 "cla_gbrfsx_extended.f"
	    ymin = hugeval;
#line 556 "cla_gbrfsx_extended.f"
	    i__3 = *n;
#line 556 "cla_gbrfsx_extended.f"
	    for (i__ = 1; i__ <= i__3; ++i__) {
#line 557 "cla_gbrfsx_extended.f"
		i__4 = i__ + j * y_dim1;
#line 557 "cla_gbrfsx_extended.f"
		yk = (d__1 = y[i__4].r, abs(d__1)) + (d__2 = d_imag(&y[i__ + 
			j * y_dim1]), abs(d__2));
#line 558 "cla_gbrfsx_extended.f"
		i__4 = i__;
#line 558 "cla_gbrfsx_extended.f"
		dyk = (d__1 = dy[i__4].r, abs(d__1)) + (d__2 = d_imag(&dy[i__]
			), abs(d__2));
#line 560 "cla_gbrfsx_extended.f"
		if (yk != 0.) {
/* Computing MAX */
#line 561 "cla_gbrfsx_extended.f"
		    d__1 = dz_z__, d__2 = dyk / yk;
#line 561 "cla_gbrfsx_extended.f"
		    dz_z__ = max(d__1,d__2);
#line 562 "cla_gbrfsx_extended.f"
		} else if (dyk != 0.) {
#line 563 "cla_gbrfsx_extended.f"
		    dz_z__ = hugeval;
#line 564 "cla_gbrfsx_extended.f"
		}
#line 566 "cla_gbrfsx_extended.f"
		ymin = min(ymin,yk);
#line 568 "cla_gbrfsx_extended.f"
		normy = max(normy,yk);
#line 570 "cla_gbrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
#line 571 "cla_gbrfsx_extended.f"
		    d__1 = normx, d__2 = yk * c__[i__];
#line 571 "cla_gbrfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 572 "cla_gbrfsx_extended.f"
		    d__1 = normdx, d__2 = dyk * c__[i__];
#line 572 "cla_gbrfsx_extended.f"
		    normdx = max(d__1,d__2);
#line 573 "cla_gbrfsx_extended.f"
		} else {
#line 574 "cla_gbrfsx_extended.f"
		    normx = normy;
#line 575 "cla_gbrfsx_extended.f"
		    normdx = max(normdx,dyk);
#line 576 "cla_gbrfsx_extended.f"
		}
#line 577 "cla_gbrfsx_extended.f"
	    }
#line 579 "cla_gbrfsx_extended.f"
	    if (normx != 0.) {
#line 580 "cla_gbrfsx_extended.f"
		dx_x__ = normdx / normx;
#line 581 "cla_gbrfsx_extended.f"
	    } else if (normdx == 0.) {
#line 582 "cla_gbrfsx_extended.f"
		dx_x__ = 0.;
#line 583 "cla_gbrfsx_extended.f"
	    } else {
#line 584 "cla_gbrfsx_extended.f"
		dx_x__ = hugeval;
#line 585 "cla_gbrfsx_extended.f"
	    }
#line 587 "cla_gbrfsx_extended.f"
	    dxrat = normdx / prevnormdx;
#line 588 "cla_gbrfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria. */

#line 592 "cla_gbrfsx_extended.f"
...
#line 597 "cla_gbrfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 597 "cla_gbrfsx_extended.f"
		x_state__ = 1;
#line 597 "cla_gbrfsx_extended.f"
	    }
#line 599 "cla_gbrfsx_extended.f"
	    if (x_state__ == 1) {
#line 600 "cla_gbrfsx_extended.f"
		if (dx_x__ <= eps) {
#line 601 "cla_gbrfsx_extended.f"
		    x_state__ = 2;
#line 602 "cla_gbrfsx_extended.f"
		} else if (dxrat > *rthresh) {
#line 603 "cla_gbrfsx_extended.f"
		    if (y_prec_state__ != 2) {
#line 604 "cla_gbrfsx_extended.f"
			incr_prec__ = TRUE_;
#line 605 "cla_gbrfsx_extended.f"
		    } else {
#line 606 "cla_gbrfsx_extended.f"
			x_state__ = 3;
#line 607 "cla_gbrfsx_extended.f"
		    }
#line 608 "cla_gbrfsx_extended.f"
		} else {
#line 609 "cla_gbrfsx_extended.f"
		    if (dxrat > dxratmax) {
#line 609 "cla_gbrfsx_extended.f"
			dxratmax = dxrat;
#line 609 "cla_gbrfsx_extended.f"
		    }
#line 610 "cla_gbrfsx_extended.f"
		}
#line 611 "cla_gbrfsx_extended.f"
		if (x_state__ > 1) {
#line 611 "cla_gbrfsx_extended.f"
		    final_dx_x__ = dx_x__;
#line 611 "cla_gbrfsx_extended.f"
		}
#line 612 "cla_gbrfsx_extended.f"
	    }
#line 614 "cla_gbrfsx_extended.f"
	    if (z_state__ == 0 && dz_z__ <= *dz_ub__) {
#line 614 "cla_gbrfsx_extended.f"
		z_state__ = 1;
#line 614 "cla_gbrfsx_extended.f"
	    }
#line 616 "cla_gbrfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 616 "cla_gbrfsx_extended.f"
		z_state__ = 1;
#line 616 "cla_gbrfsx_extended.f"
	    }
#line 618 "cla_gbrfsx_extended.f"
	    if (z_state__ == 1) {
#line 619 "cla_gbrfsx_extended.f"
		if (dz_z__ <= eps) {
#line 620 "cla_gbrfsx_extended.f"
		    z_state__ = 2;
#line 621 "cla_gbrfsx_extended.f"
		} else if (dz_z__ > *dz_ub__) {
#line 622 "cla_gbrfsx_extended.f"
		    z_state__ = 0;
#line 623 "cla_gbrfsx_extended.f"
		    dzratmax = 0.;
#line 624 "cla_gbrfsx_extended.f"
		    final_dz_z__ = hugeval;
#line 625 "cla_gbrfsx_extended.f"
		} else if (dzrat > *rthresh) {
#line 626 "cla_gbrfsx_extended.f"
		    if (y_prec_state__ != 2) {
#line 627 "cla_gbrfsx_extended.f"
			incr_prec__ = TRUE_;
#line 628 "cla_gbrfsx_extended.f"
		    } else {
#line 629 "cla_gbrfsx_extended.f"
			z_state__ = 3;
#line 630 "cla_gbrfsx_extended.f"
		    }
#line 631 "cla_gbrfsx_extended.f"
		} else {
#line 632 "cla_gbrfsx_extended.f"
		    if (dzrat > dzratmax) {
#line 632 "cla_gbrfsx_extended.f"
			dzratmax = dzrat;
#line 632 "cla_gbrfsx_extended.f"
		    }
#line 633 "cla_gbrfsx_extended.f"
		}
#line 634 "cla_gbrfsx_extended.f"
		if (z_state__ > 1) {
#line 634 "cla_gbrfsx_extended.f"
		    final_dz_z__ = dz_z__;
#line 634 "cla_gbrfsx_extended.f"
		}
#line 635 "cla_gbrfsx_extended.f"
	    }
...
#line 641 "cla_gbrfsx_extended.f"
	    if (x_state__ != 1) {
#line 642 "cla_gbrfsx_extended.f"
		if (*ignore_cwise__) {
#line 642 "cla_gbrfsx_extended.f"
		    goto L666;
#line 642 "cla_gbrfsx_extended.f"
		}
#line 643 "cla_gbrfsx_extended.f"
		if (z_state__ == 3 || z_state__ == 2) {
#line 643 "cla_gbrfsx_extended.f"
		    goto L666;
#line 643 "cla_gbrfsx_extended.f"
		}
#line 645 "cla_gbrfsx_extended.f"
		if (z_state__ == 0 && cnt > 1) {
#line 645 "cla_gbrfsx_extended.f"
		    goto L666;
#line 645 "cla_gbrfsx_extended.f"
		}
#line 646 "cla_gbrfsx_extended.f"
	    }
#line 648 "cla_gbrfsx_extended.f"
	    if (incr_prec__) {
#line 649 "cla_gbrfsx_extended.f"
		incr_prec__ = FALSE_;
#line 650 "cla_gbrfsx_extended.f"
		++y_prec_state__;
#line 651 "cla_gbrfsx_extended.f"
		i__3 = *n;
#line 651 "cla_gbrfsx_extended.f"
		for (i__ = 1; i__ <= i__3; ++i__) {
#line 652 "cla_gbrfsx_extended.f"
		    i__4 = i__;
#line 652 "cla_gbrfsx_extended.f"
		    y_tail__[i__4].r = 0., y_tail__[i__4].i = 0.;
#line 653 "cla_gbrfsx_extended.f"
		}
#line 654 "cla_gbrfsx_extended.f"
	    }
#line 656 "cla_gbrfsx_extended.f"
	    prevnormdx = normdx;
#line 657 "cla_gbrfsx_extended.f"
	    prev_dz_z__ = dz_z__;

/*           Update soluton. */

#line 661 "cla_gbrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 662 "cla_gbrfsx_extended.f"
		caxpy_(n, &c_b8, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 663 "cla_gbrfsx_extended.f"
	    } else {
#line 664 "cla_gbrfsx_extended.f"
		cla_wwaddw__(n, &y[j * y_dim1 + 1], &y_tail__[1], &dy[1]);
#line 665 "cla_gbrfsx_extended.f"
	    }
#line 667 "cla_gbrfsx_extended.f"
	}
/*        Target of "IF (Z_STOP .AND. X_STOP)".  Sun's f77 won't EXIT. */
#line 669 "cla_gbrfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 673 "cla_gbrfsx_extended.f"
	if (x_state__ == 1) {
#line 673 "cla_gbrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 673 "cla_gbrfsx_extended.f"
	}
#line 674 "cla_gbrfsx_extended.f"
	if (z_state__ == 1) {
#line 674 "cla_gbrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 674 "cla_gbrfsx_extended.f"
...
#line 678 "cla_gbrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 679 "cla_gbrfsx_extended.f"
	    err_bnds_norm__[j + (err_bnds_norm_dim1 << 1)] = final_dx_x__ / (
		    1 - dxratmax);
#line 681 "cla_gbrfsx_extended.f"
	}
#line 682 "cla_gbrfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 683 "cla_gbrfsx_extended.f"
	    err_bnds_comp__[j + (err_bnds_comp_dim1 << 1)] = final_dz_z__ / (
		    1 - dzratmax);
#line 685 "cla_gbrfsx_extended.f"
	}
