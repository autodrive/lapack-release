...
#line 489 "cla_gbrfsx_extended.f"
...
#line 490 "cla_gbrfsx_extended.f"
...
#line 497 "cla_gbrfsx_extended.f"
    m = *kl + *ku + 1;
#line 499 "cla_gbrfsx_extended.f"
    i__1 = *nrhs;
#line 499 "cla_gbrfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 500 "cla_gbrfsx_extended.f"
	y_prec_state__ = 1;
...
#line 507 "cla_gbrfsx_extended.f"
	dxrat = 0.;
#line 508 "cla_gbrfsx_extended.f"
	dxratmax = 0.;
...
#line 518 "cla_gbrfsx_extended.f"
	x_state__ = 1;
#line 519 "cla_gbrfsx_extended.f"
	z_state__ = 0;
...
#line 527 "cla_gbrfsx_extended.f"
	    ccopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 528 "cla_gbrfsx_extended.f"
	    if (y_prec_state__ == 0) {
...
#line 555 "cla_gbrfsx_extended.f"
		i__4 = i__ + j * y_dim1;
#line 555 "cla_gbrfsx_extended.f"
...
#line 558 "cla_gbrfsx_extended.f"
		if (yk != 0.) {
/* Computing MAX */
#line 559 "cla_gbrfsx_extended.f"
...
#line 568 "cla_gbrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
#line 569 "cla_gbrfsx_extended.f"
...
#line 577 "cla_gbrfsx_extended.f"
	    if (normx != 0.) {
#line 578 "cla_gbrfsx_extended.f"
		dx_x__ = normdx / normx;
...
#line 586 "cla_gbrfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria. */

#line 590 "cla_gbrfsx_extended.f"
...
#line 595 "cla_gbrfsx_extended.f"
...
#line 597 "cla_gbrfsx_extended.f"
	    if (x_state__ == 1) {
#line 598 "cla_gbrfsx_extended.f"
		if (dx_x__ <= eps) {
...
#line 616 "cla_gbrfsx_extended.f"
	    if (z_state__ == 1) {
#line 617 "cla_gbrfsx_extended.f"
		if (dz_z__ <= eps) {
...
#line 639 "cla_gbrfsx_extended.f"
	    if (x_state__ != 1) {
#line 640 "cla_gbrfsx_extended.f"
		if (*ignore_cwise__) {
#line 640 "cla_gbrfsx_extended.f"
		    goto L666;
#line 640 "cla_gbrfsx_extended.f"
...
#line 644 "cla_gbrfsx_extended.f"
	    }
#line 646 "cla_gbrfsx_extended.f"
	    if (incr_prec__) {
#line 647 "cla_gbrfsx_extended.f"
		incr_prec__ = FALSE_;
...
#line 654 "cla_gbrfsx_extended.f"
	    prevnormdx = normdx;
#line 655 "cla_gbrfsx_extended.f"
	    prev_dz_z__ = dz_z__;

/*           Update soluton. */

#line 659 "cla_gbrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 660 "cla_gbrfsx_extended.f"
...
#line 671 "cla_gbrfsx_extended.f"
	if (x_state__ == 1) {
#line 671 "cla_gbrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 671 "cla_gbrfsx_extended.f"
	}
#line 672 "cla_gbrfsx_extended.f"
	if (z_state__ == 1) {
#line 672 "cla_gbrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 672 "cla_gbrfsx_extended.f"
...
#line 676 "cla_gbrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 677 "cla_gbrfsx_extended.f"
	    err_bnds_norm__[j + (err_bnds_norm_dim1 << 1)] = final_dx_x__ / (
		    1 - dxratmax);
#line 679 "cla_gbrfsx_extended.f"
	}
#line 680 "cla_gbrfsx_extended.f"
	if (*n_norms__ >= 2) {
...
#line 693 "cla_gbrfsx_extended.f"
	ccopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 694 "cla_gbrfsx_extended.f"
	cgbmv_(trans, n, n, kl, ku, &c_b6, &ab[ab_offset], ldab, &y[j * 
		y_dim1 + 1], &c__1, &c_b8, &res[1], &c__1, (ftnlen)1);
#line 697 "cla_gbrfsx_extended.f"
	i__2 = *n;
#line 697 "cla_gbrfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 698 "cla_gbrfsx_extended.f"
	    i__3 = i__ + j * b_dim1;
#line 698 "cla_gbrfsx_extended.f"
