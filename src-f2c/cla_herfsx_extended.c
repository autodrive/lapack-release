...
#line 501 "cla_herfsx_extended.f"
	return 0;
#line 502 "cla_herfsx_extended.f"
    }
#line 503 "cla_herfsx_extended.f"
    eps = slamch_("Epsilon", (ftnlen)7);
#line 504 "cla_herfsx_extended.f"
    hugeval = slamch_("Overflow", (ftnlen)8);
/*     Force HUGEVAL to Inf */
#line 506 "cla_herfsx_extended.f"
    hugeval *= hugeval;
...
#line 512 "cla_herfsx_extended.f"
    } else {
...
#line 520 "cla_herfsx_extended.f"
		i__3 = i__;
#line 520 "cla_herfsx_extended.f"
...
#line 530 "cla_herfsx_extended.f"
	prevnormdx = hugeval;
#line 531 "cla_herfsx_extended.f"
	prev_dz_z__ = hugeval;
#line 532 "cla_herfsx_extended.f"
	dz_z__ = hugeval;
#line 533 "cla_herfsx_extended.f"
	dx_x__ = hugeval;
#line 535 "cla_herfsx_extended.f"
	x_state__ = 1;
#line 536 "cla_herfsx_extended.f"
	z_state__ = 0;
#line 537 "cla_herfsx_extended.f"
	incr_prec__ = FALSE_;
#line 539 "cla_herfsx_extended.f"
	i__2 = *ithresh;
#line 539 "cla_herfsx_extended.f"
...
#line 544 "cla_herfsx_extended.f"
...
#line 552 "cla_herfsx_extended.f"
...
#line 557 "cla_herfsx_extended.f"
	    ccopy_(n, &res[1], &c__1, &dy[1], &c__1);
#line 558 "cla_herfsx_extended.f"
...
#line 563 "cla_herfsx_extended.f"
	    normy = 0.;
#line 564 "cla_herfsx_extended.f"
	    normdx = 0.;
#line 565 "cla_herfsx_extended.f"
	    dz_z__ = 0.;
#line 566 "cla_herfsx_extended.f"
	    ymin = hugeval;
#line 568 "cla_herfsx_extended.f"
	    i__3 = *n;
#line 568 "cla_herfsx_extended.f"
...
#line 574 "cla_herfsx_extended.f"
		} else if (dyk != 0.) {
#line 575 "cla_herfsx_extended.f"
		    dz_z__ = hugeval;
#line 576 "cla_herfsx_extended.f"
		}
#line 578 "cla_herfsx_extended.f"
		ymin = min(ymin,yk);
...
#line 586 "cla_herfsx_extended.f"
		    normx = normy;
#line 587 "cla_herfsx_extended.f"
...
#line 594 "cla_herfsx_extended.f"
		dx_x__ = 0.;
#line 595 "cla_herfsx_extended.f"
	    } else {
#line 596 "cla_herfsx_extended.f"
		dx_x__ = hugeval;
#line 597 "cla_herfsx_extended.f"
	    }
#line 599 "cla_herfsx_extended.f"
	    dxrat = normdx / prevnormdx;
#line 600 "cla_herfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria. */

#line 604 "cla_herfsx_extended.f"
...
#line 621 "cla_herfsx_extended.f"
		}
...
#line 623 "cla_herfsx_extended.f"
	    }
#line 625 "cla_herfsx_extended.f"
...
#line 644 "cla_herfsx_extended.f"
		}
...
#line 646 "cla_herfsx_extended.f"
	    }
#line 648 "cla_herfsx_extended.f"
...
#line 655 "cla_herfsx_extended.f"
		for (i__ = 1; i__ <= i__3; ++i__) {
#line 656 "cla_herfsx_extended.f"
		    i__4 = i__;
#line 656 "cla_herfsx_extended.f"
...
#line 660 "cla_herfsx_extended.f"
	    prevnormdx = normdx;
#line 661 "cla_herfsx_extended.f"
	    prev_dz_z__ = dz_z__;
...
#line 667 "cla_herfsx_extended.f"
	    } else {
#line 668 "cla_herfsx_extended.f"
		cla_wwaddw__(n, &y[j * y_dim1 + 1], &y_tail__[1], &dy[1]);
#line 669 "cla_herfsx_extended.f"
	    }
#line 671 "cla_herfsx_extended.f"
	}
/*        Target of "IF (Z_STOP .AND. X_STOP)".  Sun's f77 won't EXIT. */
#line 673 "cla_herfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 677 "cla_herfsx_extended.f"
	if (x_state__ == 1) {
#line 677 "cla_herfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 677 "cla_herfsx_extended.f"
	}
#line 678 "cla_herfsx_extended.f"
	if (z_state__ == 1) {
#line 678 "cla_herfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 678 "cla_herfsx_extended.f"
...
#line 683 "cla_herfsx_extended.f"
	    err_bnds_norm__[j + (err_bnds_norm_dim1 << 1)] = final_dx_x__ / (
		    1 - dxratmax);
#line 685 "cla_herfsx_extended.f"
	}
#line 686 "cla_herfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 687 "cla_herfsx_extended.f"
	    err_bnds_comp__[j + (err_bnds_comp_dim1 << 1)] = final_dz_z__ / (
		    1 - dzratmax);
#line 689 "cla_herfsx_extended.f"
	}
...
#line 712 "cla_herfsx_extended.f"
	cla_lin_berr__(n, n, &c__1, &res[1], &ayb[1], &berr_out__[j]);

/*     End of loop for each RHS. */

#line 716 "cla_herfsx_extended.f"
    }

#line 718 "cla_herfsx_extended.f"
    return 0;
