...
#line 479 "cla_syrfsx_extended.f"
...
#line 479 "cla_syrfsx_extended.f"
    *info = 0;
#line 480 "cla_syrfsx_extended.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 481 "cla_syrfsx_extended.f"
...
#line 514 "cla_syrfsx_extended.f"
	y_prec_state__ = 1;
#line 515 "cla_syrfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 522 "cla_syrfsx_extended.f"
	dxratmax = 0.;
#line 523 "cla_syrfsx_extended.f"
	dzrat = 0.;
...
#line 533 "cla_syrfsx_extended.f"
	z_state__ = 0;
#line 534 "cla_syrfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 541 "cla_syrfsx_extended.f"
	    ccopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 542 "cla_syrfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 543 "cla_syrfsx_extended.f"
...
#line 555 "cla_syrfsx_extended.f"
	    csytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &dy[1], n,
		     info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 559 "cla_syrfsx_extended.f"
	    normx = 0.;
#line 560 "cla_syrfsx_extended.f"
	    normy = 0.;
#line 561 "cla_syrfsx_extended.f"
	    normdx = 0.;
...
#line 566 "cla_syrfsx_extended.f"
		yk = (d__1 = y[i__4].r, abs(d__1)) + (d__2 = d_imag(&y[i__ + 
			j * y_dim1]), abs(d__2));
#line 567 "cla_syrfsx_extended.f"
		i__4 = i__;
#line 567 "cla_syrfsx_extended.f"
...
#line 571 "cla_syrfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 575 "cla_syrfsx_extended.f"
		ymin = min(ymin,yk);
#line 577 "cla_syrfsx_extended.f"
		normy = max(normy,yk);
#line 579 "cla_syrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 580 "cla_syrfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 581 "cla_syrfsx_extended.f"
...
#line 589 "cla_syrfsx_extended.f"
		dx_x__ = normdx / normx;
#line 590 "cla_syrfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 601 "cla_syrfsx_extended.f"
	    if (ymin * *rcond < incr_thresh__ * normy && y_prec_state__ < 2) {
#line 601 "cla_syrfsx_extended.f"
		incr_prec__ = TRUE_;
#line 601 "cla_syrfsx_extended.f"
	    }
#line 605 "cla_syrfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 605 "cla_syrfsx_extended.f"
		x_state__ = 1;
#line 605 "cla_syrfsx_extended.f"
	    }
#line 607 "cla_syrfsx_extended.f"
	    if (x_state__ == 1) {
#line 608 "cla_syrfsx_extended.f"
		if (dx_x__ <= eps) {
#line 609 "cla_syrfsx_extended.f"
		    x_state__ = 2;
...
#line 624 "cla_syrfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 624 "cla_syrfsx_extended.f"
		z_state__ = 1;
#line 624 "cla_syrfsx_extended.f"
	    }
#line 626 "cla_syrfsx_extended.f"
	    if (z_state__ == 1) {
#line 627 "cla_syrfsx_extended.f"
		if (dz_z__ <= eps) {
#line 628 "cla_syrfsx_extended.f"
		    z_state__ = 2;
...
#line 649 "cla_syrfsx_extended.f"
	    if (incr_prec__) {
#line 650 "cla_syrfsx_extended.f"
		incr_prec__ = FALSE_;
#line 651 "cla_syrfsx_extended.f"
		++y_prec_state__;
...
#line 662 "cla_syrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 663 "cla_syrfsx_extended.f"
		caxpy_(n, &c_b15, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 664 "cla_syrfsx_extended.f"
	    } else {
...
#line 670 "cla_syrfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 674 "cla_syrfsx_extended.f"
	if (x_state__ == 1) {
#line 674 "cla_syrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 674 "cla_syrfsx_extended.f"
	}
#line 675 "cla_syrfsx_extended.f"
	if (z_state__ == 1) {
#line 675 "cla_syrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 675 "cla_syrfsx_extended.f"
...
#line 679 "cla_syrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 680 "cla_syrfsx_extended.f"
...
#line 683 "cla_syrfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 684 "cla_syrfsx_extended.f"
...
#line 696 "cla_syrfsx_extended.f"
	ccopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 697 "cla_syrfsx_extended.f"
...
#line 700 "cla_syrfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 701 "cla_syrfsx_extended.f"
	    i__3 = i__ + j * b_dim1;
#line 701 "cla_syrfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__3].r, abs(d__1)) + (d__2 = d_imag(&b[i__ 
		    + j * b_dim1]), abs(d__2));
#line 702 "cla_syrfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 706 "cla_syrfsx_extended.f"
...
#line 713 "cla_syrfsx_extended.f"
    }

#line 715 "cla_syrfsx_extended.f"
    return 0;
