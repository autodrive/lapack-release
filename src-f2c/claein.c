	...
	doublereal *smlnum, integer *info)
{
    ...
    extern /* Subroutine */ int csscal_(integer *, doublereal *, 
	    doublecomplex *, integer *), clatrs_(char *, char *, char *, char 
...
#line 247 "claein.f"
		cladiv_(&z__1, &b[i__ + i__ * b_dim1], &ei);
#line 247 "claein.f"
...
#line 260 "claein.f"
		cladiv_(&z__1, &ei, &b[i__ + i__ * b_dim1]);
#line 260 "claein.f"
		x.r = z__1.r, x.i = z__1.i;
#line 261 "claein.f"
		if (x.r != 0. || x.i != 0.) {
