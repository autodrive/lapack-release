...
#line 199 "clarz.f"
	    caxpy_(n, &z__1, &work[1], &c__1, &c__[c_offset], ldc);
...
#line 204 "clarz.f"
	    z__1.r = -tau->r, z__1.i = -tau->i;
#line 204 "clarz.f"
	    cgeru_(l, n, &z__1, &v[1], incv, &work[1], &c__1, &c__[*m - *l + 
		    1 + c_dim1], ldc);
#line 206 "clarz.f"
	}
...
#line 225 "clarz.f"
	    z__1.r = -tau->r, z__1.i = -tau->i;
#line 225 "clarz.f"
	    caxpy_(m, &z__1, &work[1], &c__1, &c__[c_offset], &c__1);
...
#line 230 "clarz.f"
	    z__1.r = -tau->r, z__1.i = -tau->i;
#line 230 "clarz.f"
	    cgerc_(m, l, &z__1, &work[1], &c__1, &v[1], incv, &c__[(*n - *l + 
		    1) * c_dim1 + 1], ldc);
