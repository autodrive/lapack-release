	...
	ftnlen trans_len, ftnlen diag_len, ftnlen normin_len)
{
    ...
    extern /* Subroutine */ int ctrsv_(char *, char *, char *, integer *, 
	    ...
	    ftnlen, ftnlen), slabad_(doublereal *, doublereal *);
...
#line 664 "clatrs.f"
			caxpy_(&i__3, &z__1, &a[j * a_dim1 + 1], &c__1, &x[1],
				 &c__1);
#line 666 "clatrs.f"
			i__3 = j - 1;
#line 666 "clatrs.f"
...
#line 675 "clatrs.f"
			z__1.r = tscal * z__2.r, z__1.i = tscal * z__2.i;
#line 675 "clatrs.f"
			caxpy_(&i__3, &z__1, &a[j + 1 + j * a_dim1], &c__1, &
				x[j + 1], &c__1);
#line 677 "clatrs.f"
			i__3 = *n - j;
#line 677 "clatrs.f"
...
#line 727 "clatrs.f"
			i__3 = j - 1;
#line 727 "clatrs.f"
			cdotu_(&z__1, &i__3, &a[j * a_dim1 + 1], &c__1, &x[1],
				 &c__1);
#line 727 "clatrs.f"
...
#line 729 "clatrs.f"
			i__3 = *n - j;
#line 729 "clatrs.f"
			cdotu_(&z__1, &i__3, &a[j + 1 + j * a_dim1], &c__1, &
				x[j + 1], &c__1);
#line 729 "clatrs.f"
			csumj.r = z__1.r, csumj.i = z__1.i;
#line 730 "clatrs.f"
...
#line 861 "clatrs.f"
			i__3 = j - 1;
#line 861 "clatrs.f"
			cdotc_(&z__1, &i__3, &a[j * a_dim1 + 1], &c__1, &x[1],
				 &c__1);
#line 861 "clatrs.f"
			csumj.r = z__1.r, csumj.i = z__1.i;
#line 862 "clatrs.f"
...
#line 863 "clatrs.f"
			i__3 = *n - j;
#line 863 "clatrs.f"
			cdotc_(&z__1, &i__3, &a[j + 1 + j * a_dim1], &c__1, &
				x[j + 1], &c__1);
#line 863 "clatrs.f"
			csumj.r = z__1.r, csumj.i = z__1.i;
#line 864 "clatrs.f"
