	...
	integer *info, ftnlen fact_len, ftnlen uplo_len, ftnlen equed_len)
{
    ...
    extern doublereal cla_syrpvgrw__(char *, integer *, integer *, 
    ...
    extern /* Subroutine */ int claqsy_(char *, integer *, doublecomplex *, 
	    integer *, doublereal *, doublereal *, doublereal *, char *, 
	    ftnlen, ftnlen), csytrf_(char *, integer *, doublecomplex *, 
	    integer *, integer *, doublecomplex *, integer *, integer *, 
	    ftnlen);
    static doublereal smlnum;
    extern /* Subroutine */ int clascl2_(integer *, integer *, doublereal *, 
	    doublecomplex *, integer *), csytrs_(char *, integer *, integer *,
	     doublecomplex *, integer *, integer *, doublecomplex *, integer *
	    , integer *, ftnlen), csyequb_(char *, integer *, doublecomplex *,
	     integer *, doublereal *, doublereal *, doublereal *, 
	    doublecomplex *, integer *, ftnlen), csyrfsx_(char *, char *, 
