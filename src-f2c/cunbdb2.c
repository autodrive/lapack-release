...
/* > */
/*  ===================================================================== */
/* Subroutine */ int cunbdb2_(integer *m, integer *p, integer *q, 
...
/* Computing 2nd power */
#line 299 "cunbdb2.f"
	d__1 = scnrm2_(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &x11[i__ 
		+ 1 + i__ * x11_dim1], &c__1);
#line 299 "cunbdb2.f"
	i__3 = *m - *p - i__ + 1;
/* Computing 2nd power */
#line 299 "cunbdb2.f"
	d__2 = scnrm2_(&i__3, &x21[i__ + i__ * x21_dim1], &c__1, &x21[i__ + 
		i__ * x21_dim1], &c__1);
#line 299 "cunbdb2.f"
