	...
	info, ftnlen jobu1_len, ftnlen jobu2_len, ftnlen jobv1t_len)
{
    ...
    extern /* Subroutine */ int clacpy_(char *, integer *, integer *, 
	    ...
	    integer *), cunglq_(integer *, integer *, integer *, 
    ...
    extern /* Subroutine */ int cunbdb1_(integer *, integer *, integer *, 
	    ...
	    doublecomplex *, doublecomplex *, integer *, integer *), cunbdb2_(
    ...
    extern /* Subroutine */ int cunbdb3_(integer *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublereal *, doublereal *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, integer *, integer *), cunbdb4_(
	    integer *, integer *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *, doublereal *, doublereal *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *
...
#line 480 "cuncsd2by1.f"
		cungqr_(p, p, &i__1, &u1[u1_offset], ldu1, cdum, &work[1], &
			c_n1, &childinfo);
#line 482 "cuncsd2by1.f"
		lorgqrmin = max(lorgqrmin,*p);
/* Computing MAX */
#line 483 "cuncsd2by1.f"
		i__1 = lorgqropt, i__2 = (integer) work[1].r;
#line 483 "cuncsd2by1.f"
		lorgqropt = max(i__1,i__2);
...
#line 513 "cuncsd2by1.f"
	if (*lwork < lworkmin && ! lquery) {
#line 514 "cuncsd2by1.f"
	    *info = -19;
#line 515 "cuncsd2by1.f"
	}
...
#line 598 "cuncsd2by1.f"
	    for (j = 2; j <= i__1; ++j) {
#line 599 "cuncsd2by1.f"
		i__2 = j * u1_dim1 + 1;
#line 599 "cuncsd2by1.f"
		u1[i__2].r = 0., u1[i__2].i = 0.;
#line 600 "cuncsd2by1.f"
		i__2 = j + u1_dim1;
#line 600 "cuncsd2by1.f"
		u1[i__2].r = 0., u1[i__2].i = 0.;
#line 601 "cuncsd2by1.f"
	    }
...
#line 651 "cuncsd2by1.f"
	    clacpy_("L", p, q, &x11[x11_offset], ldx11, &u1[u1_offset], ldu1, 
		    (ftnlen)1);
#line 652 "cuncsd2by1.f"
	    cungqr_(p, p, q, &u1[u1_offset], ldu1, &work[itaup1], &work[
		    iorgqr], &lorgqr, &childinfo);
#line 654 "cuncsd2by1.f"
	}
#line 655 "cuncsd2by1.f"
	if (wantu2 && *m - *p > 0) {
#line 656 "cuncsd2by1.f"
	    i__1 = u2_dim1 + 1;
#line 656 "cuncsd2by1.f"
...
#line 684 "cuncsd2by1.f"
	if (*q > r__) {
#line 685 "cuncsd2by1.f"
	    i__1 = r__;
#line 685 "cuncsd2by1.f"
	    for (i__ = 1; i__ <= i__1; ++i__) {
...
#line 721 "cuncsd2by1.f"
	if (wantu2 && *m - *p > 0) {
#line 722 "cuncsd2by1.f"
	    i__1 = *m - *p;
#line 722 "cuncsd2by1.f"
	    ccopy_(&i__1, &work[iorbdb + *p], &c__1, &u2[u2_offset], &c__1);
#line 723 "cuncsd2by1.f"
	    i__1 = *m - *p;
#line 723 "cuncsd2by1.f"
	    for (j = 2; j <= i__1; ++j) {
#line 724 "cuncsd2by1.f"
		i__2 = j * u2_dim1 + 1;
#line 724 "cuncsd2by1.f"
		u2[i__2].r = 0., u2[i__2].i = 0.;
#line 725 "cuncsd2by1.f"
	    }
...
#line 753 "cuncsd2by1.f"
	if (*p > r__) {
#line 754 "cuncsd2by1.f"
	    i__1 = r__;
#line 754 "cuncsd2by1.f"
	    for (i__ = 1; i__ <= i__1; ++i__) {
#line 755 "cuncsd2by1.f"
		iwork[i__] = *p - r__ + i__;
#line 756 "cuncsd2by1.f"
	    }
#line 757 "cuncsd2by1.f"
	    i__1 = *p;
#line 757 "cuncsd2by1.f"
	    for (i__ = r__ + 1; i__ <= i__1; ++i__) {
#line 758 "cuncsd2by1.f"
		iwork[i__] = i__ - r__;
#line 759 "cuncsd2by1.f"
	    }
#line 760 "cuncsd2by1.f"
	    if (wantu1) {
#line 761 "cuncsd2by1.f"
		clapmt_(&c_false, p, p, &u1[u1_offset], ldu1, &iwork[1]);
#line 762 "cuncsd2by1.f"
	    }
#line 763 "cuncsd2by1.f"
	    if (wantv1t) {
#line 764 "cuncsd2by1.f"
		clapmr_(&c_false, p, q, &v1t[v1t_offset], ldv1t, &iwork[1]);
#line 765 "cuncsd2by1.f"
	    }
#line 766 "cuncsd2by1.f"
	}
#line 767 "cuncsd2by1.f"
    }

#line 769 "cuncsd2by1.f"
    return 0;
