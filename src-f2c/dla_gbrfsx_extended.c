...
#line 483 "dla_gbrfsx_extended.f"
...
#line 490 "dla_gbrfsx_extended.f"
...
#line 494 "dla_gbrfsx_extended.f"
	y_prec_state__ = 1;
#line 495 "dla_gbrfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 502 "dla_gbrfsx_extended.f"
	dxratmax = 0.;
#line 503 "dla_gbrfsx_extended.f"
	dzrat = 0.;
...
#line 513 "dla_gbrfsx_extended.f"
	z_state__ = 0;
#line 514 "dla_gbrfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 521 "dla_gbrfsx_extended.f"
	    dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 522 "dla_gbrfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 523 "dla_gbrfsx_extended.f"
...
#line 530 "dla_gbrfsx_extended.f"
...
#line 537 "dla_gbrfsx_extended.f"
	    dgbtrs_(trans, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &ipiv[1]
		    , &dy[1], n, info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 542 "dla_gbrfsx_extended.f"
	    normx = 0.;
#line 543 "dla_gbrfsx_extended.f"
	    normy = 0.;
#line 544 "dla_gbrfsx_extended.f"
	    normdx = 0.;
...
#line 550 "dla_gbrfsx_extended.f"
...
#line 554 "dla_gbrfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 558 "dla_gbrfsx_extended.f"
		ymin = min(ymin,yk);
#line 560 "dla_gbrfsx_extended.f"
		normy = max(normy,yk);
#line 562 "dla_gbrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 563 "dla_gbrfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 564 "dla_gbrfsx_extended.f"
...
#line 572 "dla_gbrfsx_extended.f"
		dx_x__ = normdx / normx;
#line 573 "dla_gbrfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 584 "dla_gbrfsx_extended.f"
...
#line 589 "dla_gbrfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 589 "dla_gbrfsx_extended.f"
		x_state__ = 1;
#line 589 "dla_gbrfsx_extended.f"
	    }
#line 591 "dla_gbrfsx_extended.f"
	    if (x_state__ == 1) {
#line 592 "dla_gbrfsx_extended.f"
		if (dx_x__ <= eps) {
#line 593 "dla_gbrfsx_extended.f"
		    x_state__ = 2;
...
#line 608 "dla_gbrfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 608 "dla_gbrfsx_extended.f"
		z_state__ = 1;
#line 608 "dla_gbrfsx_extended.f"
	    }
#line 610 "dla_gbrfsx_extended.f"
	    if (z_state__ == 1) {
#line 611 "dla_gbrfsx_extended.f"
		if (dz_z__ <= eps) {
#line 612 "dla_gbrfsx_extended.f"
		    z_state__ = 2;
...
#line 633 "dla_gbrfsx_extended.f"
	    if (x_state__ != 1) {
#line 634 "dla_gbrfsx_extended.f"
		if (*ignore_cwise__) {
#line 634 "dla_gbrfsx_extended.f"
		    goto L666;
#line 634 "dla_gbrfsx_extended.f"
		}
#line 635 "dla_gbrfsx_extended.f"
...
#line 641 "dla_gbrfsx_extended.f"
		incr_prec__ = FALSE_;
#line 642 "dla_gbrfsx_extended.f"
		++y_prec_state__;
...
#line 653 "dla_gbrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 654 "dla_gbrfsx_extended.f"
		daxpy_(n, &c_b8, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 655 "dla_gbrfsx_extended.f"
	    } else {
...
#line 661 "dla_gbrfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 665 "dla_gbrfsx_extended.f"
	if (x_state__ == 1) {
#line 665 "dla_gbrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 665 "dla_gbrfsx_extended.f"
	}
#line 666 "dla_gbrfsx_extended.f"
	if (z_state__ == 1) {
#line 666 "dla_gbrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 666 "dla_gbrfsx_extended.f"
...
#line 670 "dla_gbrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 671 "dla_gbrfsx_extended.f"
...
#line 674 "dla_gbrfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 675 "dla_gbrfsx_extended.f"
...
#line 687 "dla_gbrfsx_extended.f"
	dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 688 "dla_gbrfsx_extended.f"
...
#line 691 "dla_gbrfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 692 "dla_gbrfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__ + j * b_dim1], abs(d__1));
#line 693 "dla_gbrfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 697 "dla_gbrfsx_extended.f"
...
#line 704 "dla_gbrfsx_extended.f"
    }

#line 706 "dla_gbrfsx_extended.f"
    return 0;
