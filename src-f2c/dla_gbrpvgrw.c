...
#line 143 "dla_gbrpvgrw.f"
    rpvgrw = 1.;
#line 145 "dla_gbrpvgrw.f"
    kd = *ku + 1;
#line 146 "dla_gbrpvgrw.f"
    i__1 = *ncols;
#line 146 "dla_gbrpvgrw.f"
    for (j = 1; j <= i__1; ++j) {
#line 147 "dla_gbrpvgrw.f"
	amax = 0.;
#line 148 "dla_gbrpvgrw.f"
	umax = 0.;
/* Computing MAX */
#line 149 "dla_gbrpvgrw.f"
	i__2 = j - *ku;
/* Computing MIN */
#line 149 "dla_gbrpvgrw.f"
	i__4 = j + *kl;
...
/* Computing MAX */
#line 150 "dla_gbrpvgrw.f"
	    d__2 = (d__1 = ab[kd + i__ - j + j * ab_dim1], abs(d__1));
#line 150 "dla_gbrpvgrw.f"
	    amax = max(d__2,amax);
#line 151 "dla_gbrpvgrw.f"
	}
/* Computing MAX */
#line 152 "dla_gbrpvgrw.f"
	i__3 = j - *ku;
#line 152 "dla_gbrpvgrw.f"
	i__2 = j;
#line 152 "dla_gbrpvgrw.f"
...
/* Computing MAX */
#line 153 "dla_gbrpvgrw.f"
	    d__2 = (d__1 = afb[kd + i__ - j + j * afb_dim1], abs(d__1));
#line 153 "dla_gbrpvgrw.f"
	    umax = max(d__2,umax);
#line 154 "dla_gbrpvgrw.f"
	}
#line 155 "dla_gbrpvgrw.f"
	if (umax != 0.) {
/* Computing MIN */
#line 156 "dla_gbrpvgrw.f"
	    d__1 = amax / umax;
#line 156 "dla_gbrpvgrw.f"
	    rpvgrw = min(d__1,rpvgrw);
#line 157 "dla_gbrpvgrw.f"
	}
#line 158 "dla_gbrpvgrw.f"
    }
#line 159 "dla_gbrpvgrw.f"
    ret_val = rpvgrw;
#line 160 "dla_gbrpvgrw.f"
    return ret_val;
} /* dla_gbrpvgrw__ */
