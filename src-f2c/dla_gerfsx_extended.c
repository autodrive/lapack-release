...
#line 467 "dla_gerfsx_extended.f"
...
#line 474 "dla_gerfsx_extended.f"
    incr_thresh__ = (doublereal) (*n) * eps;

#line 476 "dla_gerfsx_extended.f"
    i__1 = *nrhs;
#line 476 "dla_gerfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 477 "dla_gerfsx_extended.f"
	y_prec_state__ = 1;
#line 478 "dla_gerfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 485 "dla_gerfsx_extended.f"
	dxratmax = 0.;
#line 486 "dla_gerfsx_extended.f"
	dzrat = 0.;
...
#line 496 "dla_gerfsx_extended.f"
	z_state__ = 0;
#line 497 "dla_gerfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 504 "dla_gerfsx_extended.f"
	    dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 505 "dla_gerfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 506 "dla_gerfsx_extended.f"
...
#line 518 "dla_gerfsx_extended.f"
	    dgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &dy[1], 
		    n, info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 522 "dla_gerfsx_extended.f"
	    normx = 0.;
#line 523 "dla_gerfsx_extended.f"
	    normy = 0.;
#line 524 "dla_gerfsx_extended.f"
	    normdx = 0.;
...
#line 530 "dla_gerfsx_extended.f"
...
#line 534 "dla_gerfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 538 "dla_gerfsx_extended.f"
		ymin = min(ymin,yk);
#line 540 "dla_gerfsx_extended.f"
		normy = max(normy,yk);
#line 542 "dla_gerfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 543 "dla_gerfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 544 "dla_gerfsx_extended.f"
...
#line 552 "dla_gerfsx_extended.f"
		dx_x__ = normdx / normx;
#line 553 "dla_gerfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 564 "dla_gerfsx_extended.f"
...
#line 569 "dla_gerfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 569 "dla_gerfsx_extended.f"
		x_state__ = 1;
#line 569 "dla_gerfsx_extended.f"
	    }
#line 571 "dla_gerfsx_extended.f"
	    if (x_state__ == 1) {
#line 572 "dla_gerfsx_extended.f"
		if (dx_x__ <= eps) {
#line 573 "dla_gerfsx_extended.f"
		    x_state__ = 2;
...
#line 588 "dla_gerfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 588 "dla_gerfsx_extended.f"
		z_state__ = 1;
#line 588 "dla_gerfsx_extended.f"
	    }
#line 590 "dla_gerfsx_extended.f"
	    if (z_state__ == 1) {
#line 591 "dla_gerfsx_extended.f"
		if (dz_z__ <= eps) {
#line 592 "dla_gerfsx_extended.f"
		    z_state__ = 2;
...
#line 613 "dla_gerfsx_extended.f"
	    if (x_state__ != 1) {
#line 614 "dla_gerfsx_extended.f"
		if (*ignore_cwise__) {
#line 614 "dla_gerfsx_extended.f"
		    goto L666;
#line 614 "dla_gerfsx_extended.f"
		}
#line 615 "dla_gerfsx_extended.f"
...
#line 621 "dla_gerfsx_extended.f"
		incr_prec__ = FALSE_;
#line 622 "dla_gerfsx_extended.f"
		++y_prec_state__;
...
#line 633 "dla_gerfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 634 "dla_gerfsx_extended.f"
		daxpy_(n, &c_b8, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 635 "dla_gerfsx_extended.f"
	    } else {
...
#line 641 "dla_gerfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 645 "dla_gerfsx_extended.f"
	if (x_state__ == 1) {
#line 645 "dla_gerfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 645 "dla_gerfsx_extended.f"
	}
#line 646 "dla_gerfsx_extended.f"
	if (z_state__ == 1) {
#line 646 "dla_gerfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 646 "dla_gerfsx_extended.f"
...
#line 650 "dla_gerfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 651 "dla_gerfsx_extended.f"
	    errs_n__[j + (errs_n_dim1 << 1)] = final_dx_x__ / (1 - dxratmax);
#line 652 "dla_gerfsx_extended.f"
	}
...
#line 665 "dla_gerfsx_extended.f"
	dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 666 "dla_gerfsx_extended.f"
...
#line 669 "dla_gerfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 670 "dla_gerfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__ + j * b_dim1], abs(d__1));
#line 671 "dla_gerfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 675 "dla_gerfsx_extended.f"
...
#line 682 "dla_gerfsx_extended.f"
    }

#line 684 "dla_gerfsx_extended.f"
    return 0;
