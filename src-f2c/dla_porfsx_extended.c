...
#line 462 "dla_porfsx_extended.f"
...
#line 477 "dla_porfsx_extended.f"
	y_prec_state__ = 1;
#line 478 "dla_porfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 485 "dla_porfsx_extended.f"
	dxratmax = 0.;
#line 486 "dla_porfsx_extended.f"
	dzrat = 0.;
...
#line 496 "dla_porfsx_extended.f"
	z_state__ = 0;
#line 497 "dla_porfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 504 "dla_porfsx_extended.f"
	    dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 505 "dla_porfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 506 "dla_porfsx_extended.f"
...
#line 518 "dla_porfsx_extended.f"
	    dpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &dy[1], n, info, (
		    ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 522 "dla_porfsx_extended.f"
	    normx = 0.;
#line 523 "dla_porfsx_extended.f"
	    normy = 0.;
#line 524 "dla_porfsx_extended.f"
	    normdx = 0.;
...
#line 530 "dla_porfsx_extended.f"
...
#line 534 "dla_porfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 538 "dla_porfsx_extended.f"
		ymin = min(ymin,yk);
#line 540 "dla_porfsx_extended.f"
		normy = max(normy,yk);
#line 542 "dla_porfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 543 "dla_porfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 544 "dla_porfsx_extended.f"
...
#line 552 "dla_porfsx_extended.f"
		dx_x__ = normdx / normx;
#line 553 "dla_porfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 564 "dla_porfsx_extended.f"
	    if (ymin * *rcond < incr_thresh__ * normy && y_prec_state__ < 2) {
#line 564 "dla_porfsx_extended.f"
		incr_prec__ = TRUE_;
#line 564 "dla_porfsx_extended.f"
	    }
#line 568 "dla_porfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 568 "dla_porfsx_extended.f"
		x_state__ = 1;
#line 568 "dla_porfsx_extended.f"
	    }
#line 570 "dla_porfsx_extended.f"
	    if (x_state__ == 1) {
#line 571 "dla_porfsx_extended.f"
		if (dx_x__ <= eps) {
#line 572 "dla_porfsx_extended.f"
		    x_state__ = 2;
...
#line 587 "dla_porfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 587 "dla_porfsx_extended.f"
		z_state__ = 1;
#line 587 "dla_porfsx_extended.f"
	    }
#line 589 "dla_porfsx_extended.f"
	    if (z_state__ == 1) {
#line 590 "dla_porfsx_extended.f"
		if (dz_z__ <= eps) {
#line 591 "dla_porfsx_extended.f"
		    z_state__ = 2;
...
#line 612 "dla_porfsx_extended.f"
	    if (incr_prec__) {
#line 613 "dla_porfsx_extended.f"
		incr_prec__ = FALSE_;
#line 614 "dla_porfsx_extended.f"
		++y_prec_state__;
...
#line 625 "dla_porfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 626 "dla_porfsx_extended.f"
		daxpy_(n, &c_b11, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 627 "dla_porfsx_extended.f"
	    } else {
...
#line 633 "dla_porfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 637 "dla_porfsx_extended.f"
	if (x_state__ == 1) {
#line 637 "dla_porfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 637 "dla_porfsx_extended.f"
	}
#line 638 "dla_porfsx_extended.f"
	if (z_state__ == 1) {
#line 638 "dla_porfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 638 "dla_porfsx_extended.f"
...
#line 642 "dla_porfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 643 "dla_porfsx_extended.f"
...
#line 646 "dla_porfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 647 "dla_porfsx_extended.f"
...
#line 659 "dla_porfsx_extended.f"
	dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 660 "dla_porfsx_extended.f"
...
#line 663 "dla_porfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 664 "dla_porfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__ + j * b_dim1], abs(d__1));
#line 665 "dla_porfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 669 "dla_porfsx_extended.f"
...
#line 676 "dla_porfsx_extended.f"
    }

#line 678 "dla_porfsx_extended.f"
    return 0;
