...
#line 472 "dla_syrfsx_extended.f"
...
#line 472 "dla_syrfsx_extended.f"
    *info = 0;
#line 473 "dla_syrfsx_extended.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 474 "dla_syrfsx_extended.f"
...
#line 507 "dla_syrfsx_extended.f"
	y_prec_state__ = 1;
#line 508 "dla_syrfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 515 "dla_syrfsx_extended.f"
	dxratmax = 0.;
#line 516 "dla_syrfsx_extended.f"
	dzrat = 0.;
...
#line 526 "dla_syrfsx_extended.f"
	z_state__ = 0;
#line 527 "dla_syrfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 534 "dla_syrfsx_extended.f"
	    dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 535 "dla_syrfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 536 "dla_syrfsx_extended.f"
...
#line 548 "dla_syrfsx_extended.f"
	    dsytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &dy[1], n,
		     info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 552 "dla_syrfsx_extended.f"
	    normx = 0.;
#line 553 "dla_syrfsx_extended.f"
	    normy = 0.;
#line 554 "dla_syrfsx_extended.f"
	    normdx = 0.;
...
#line 560 "dla_syrfsx_extended.f"
...
#line 564 "dla_syrfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 568 "dla_syrfsx_extended.f"
		ymin = min(ymin,yk);
#line 570 "dla_syrfsx_extended.f"
		normy = max(normy,yk);
#line 572 "dla_syrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 573 "dla_syrfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 574 "dla_syrfsx_extended.f"
...
#line 582 "dla_syrfsx_extended.f"
		dx_x__ = normdx / normx;
#line 583 "dla_syrfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 594 "dla_syrfsx_extended.f"
	    if (ymin * *rcond < incr_thresh__ * normy && y_prec_state__ < 2) {
#line 594 "dla_syrfsx_extended.f"
		incr_prec__ = TRUE_;
#line 594 "dla_syrfsx_extended.f"
	    }
#line 598 "dla_syrfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 598 "dla_syrfsx_extended.f"
		x_state__ = 1;
#line 598 "dla_syrfsx_extended.f"
	    }
#line 600 "dla_syrfsx_extended.f"
	    if (x_state__ == 1) {
#line 601 "dla_syrfsx_extended.f"
		if (dx_x__ <= eps) {
#line 602 "dla_syrfsx_extended.f"
		    x_state__ = 2;
...
#line 617 "dla_syrfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 617 "dla_syrfsx_extended.f"
		z_state__ = 1;
#line 617 "dla_syrfsx_extended.f"
	    }
#line 619 "dla_syrfsx_extended.f"
	    if (z_state__ == 1) {
#line 620 "dla_syrfsx_extended.f"
		if (dz_z__ <= eps) {
#line 621 "dla_syrfsx_extended.f"
		    z_state__ = 2;
...
#line 642 "dla_syrfsx_extended.f"
	    if (incr_prec__) {
#line 643 "dla_syrfsx_extended.f"
		incr_prec__ = FALSE_;
#line 644 "dla_syrfsx_extended.f"
		++y_prec_state__;
...
#line 655 "dla_syrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 656 "dla_syrfsx_extended.f"
		daxpy_(n, &c_b14, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 657 "dla_syrfsx_extended.f"
	    } else {
...
#line 663 "dla_syrfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 667 "dla_syrfsx_extended.f"
	if (x_state__ == 1) {
#line 667 "dla_syrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 667 "dla_syrfsx_extended.f"
	}
#line 668 "dla_syrfsx_extended.f"
	if (z_state__ == 1) {
#line 668 "dla_syrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 668 "dla_syrfsx_extended.f"
...
#line 672 "dla_syrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 673 "dla_syrfsx_extended.f"
...
#line 676 "dla_syrfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 677 "dla_syrfsx_extended.f"
...
/*        Compute residual RES = B_s - op(A_s) * Y, */
/*            op(A) = A, A**T, or A**H depending on TRANS (and type). */
#line 688 "dla_syrfsx_extended.f"
	dcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 689 "dla_syrfsx_extended.f"
...
#line 692 "dla_syrfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 693 "dla_syrfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__ + j * b_dim1], abs(d__1));
#line 694 "dla_syrfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 698 "dla_syrfsx_extended.f"
...
#line 705 "dla_syrfsx_extended.f"
    }

#line 707 "dla_syrfsx_extended.f"
    return 0;
