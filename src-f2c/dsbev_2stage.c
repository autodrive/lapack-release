...
#line 278 "dsbev_2stage.f"
	    lwtrd = ilaenv_(&c__20, "DSYTRD_SB2ST", jobz, n, kd, &ib, &c_n1, (
		    ftnlen)12, (ftnlen)1);
#line 279 "dsbev_2stage.f"
	    lwmin = *n + lhtrd + lwtrd;
#line 280 "dsbev_2stage.f"
	    work[1] = (doublereal) lwmin;
#line 281 "dsbev_2stage.f"
	}
...
#line 285 "dsbev_2stage.f"
    }

#line 287 "dsbev_2stage.f"
    if (*info != 0) {
#line 288 "dsbev_2stage.f"
	i__1 = -(*info);
#line 288 "dsbev_2stage.f"
	xerbla_("DSBEV_2STAGE ", &i__1, (ftnlen)13);
#line 289 "dsbev_2stage.f"
	return 0;
...
#line 299 "dsbev_2stage.f"
    if (*n == 1) {
#line 300 "dsbev_2stage.f"
	if (lower) {
#line 301 "dsbev_2stage.f"
	    w[1] = ab[ab_dim1 + 1];
...
#line 312 "dsbev_2stage.f"
    safmin = dlamch_("Safe minimum", (ftnlen)12);
#line 313 "dsbev_2stage.f"
    eps = dlamch_("Precision", (ftnlen)9);
#line 314 "dsbev_2stage.f"
    smlnum = safmin / eps;
...
#line 321 "dsbev_2stage.f"
    anrm = dlansb_("M", uplo, n, kd, &ab[ab_offset], ldab, &work[1], (ftnlen)
	    1, (ftnlen)1);
#line 322 "dsbev_2stage.f"
    iscale = 0;
#line 323 "dsbev_2stage.f"
    if (anrm > 0. && anrm < rmin) {
...
#line 340 "dsbev_2stage.f"
    inde = 1;
#line 341 "dsbev_2stage.f"
    indhous = inde + *n;
#line 342 "dsbev_2stage.f"
...
#line 351 "dsbev_2stage.f"
    if (! wantz) {
#line 352 "dsbev_2stage.f"
	dsterf_(n, &w[1], &work[inde], info);
#line 353 "dsbev_2stage.f"
    } else {
...
#line 360 "dsbev_2stage.f"
    if (iscale == 1) {
#line 361 "dsbev_2stage.f"
	if (*info == 0) {
#line 362 "dsbev_2stage.f"
	    imax = *n;
...
#line 371 "dsbev_2stage.f"
    work[1] = (doublereal) lwmin;

#line 373 "dsbev_2stage.f"
    return 0;
