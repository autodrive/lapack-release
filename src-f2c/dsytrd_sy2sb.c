...
#line 296 "dsytrd_sy2sb.f"
    *info = 0;
#line 297 "dsytrd_sy2sb.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 298 "dsytrd_sy2sb.f"
    lquery = *lwork == -1;
#line 299 "dsytrd_sy2sb.f"
    lwmin = ilaenv_(&c__20, "DSYTRD_SY2SB", "", n, kd, &c_n1, &c_n1, (ftnlen)
	    12, (ftnlen)0);
#line 301 "dsytrd_sy2sb.f"
    if (! upper && ! lsame_(uplo, "L", (ftnlen)1, (ftnlen)1)) {
#line 302 "dsytrd_sy2sb.f"
	*info = -1;
#line 303 "dsytrd_sy2sb.f"
    } else if (*n < 0) {
#line 304 "dsytrd_sy2sb.f"
	*info = -2;
#line 305 "dsytrd_sy2sb.f"
    } else if (*kd < 0) {
#line 306 "dsytrd_sy2sb.f"
	*info = -3;
#line 307 "dsytrd_sy2sb.f"
    } else if (*lda < max(1,*n)) {
#line 308 "dsytrd_sy2sb.f"
	*info = -5;
#line 309 "dsytrd_sy2sb.f"
...
#line 310 "dsytrd_sy2sb.f"
	    *info = -7;
#line 311 "dsytrd_sy2sb.f"
	} else if (*lwork < lwmin && ! lquery) {
#line 312 "dsytrd_sy2sb.f"
	    *info = -10;
#line 313 "dsytrd_sy2sb.f"
	}
#line 313 "dsytrd_sy2sb.f"
    }

#line 315 "dsytrd_sy2sb.f"
    if (*info != 0) {
#line 316 "dsytrd_sy2sb.f"
	i__1 = -(*info);
#line 316 "dsytrd_sy2sb.f"
	xerbla_("DSYTRD_SY2SB", &i__1, (ftnlen)12);
#line 317 "dsytrd_sy2sb.f"
	return 0;
#line 318 "dsytrd_sy2sb.f"
    } else if (lquery) {
#line 319 "dsytrd_sy2sb.f"
	work[1] = (doublereal) lwmin;
#line 320 "dsytrd_sy2sb.f"
	return 0;
#line 321 "dsytrd_sy2sb.f"
    }

/*     Quick return if possible */
/*     Copy the upper/lower portion of A into AB */

#line 326 "dsytrd_sy2sb.f"
    if (*n <= *kd + 1) {
#line 327 "dsytrd_sy2sb.f"
	if (upper) {
#line 328 "dsytrd_sy2sb.f"
	    i__1 = *n;
#line 328 "dsytrd_sy2sb.f"
	    for (i__ = 1; i__ <= i__1; ++i__) {
/* Computing MIN */
#line 329 "dsytrd_sy2sb.f"
		i__2 = *kd + 1;
#line 329 "dsytrd_sy2sb.f"
		lk = min(i__2,i__);
#line 330 "dsytrd_sy2sb.f"
		dcopy_(&lk, &a[i__ - lk + 1 + i__ * a_dim1], &c__1, &ab[*kd + 
			1 - lk + 1 + i__ * ab_dim1], &c__1);
#line 332 "dsytrd_sy2sb.f"
/* L100: */
#line 332 "dsytrd_sy2sb.f"
	    }
#line 333 "dsytrd_sy2sb.f"
	} else {
#line 334 "dsytrd_sy2sb.f"
	    i__1 = *n;
#line 334 "dsytrd_sy2sb.f"
	    for (i__ = 1; i__ <= i__1; ++i__) {
/* Computing MIN */
#line 335 "dsytrd_sy2sb.f"
		i__2 = *kd + 1, i__3 = *n - i__ + 1;
#line 335 "dsytrd_sy2sb.f"
		lk = min(i__2,i__3);
#line 336 "dsytrd_sy2sb.f"
		dcopy_(&lk, &a[i__ + i__ * a_dim1], &c__1, &ab[i__ * ab_dim1 
			+ 1], &c__1);
#line 337 "dsytrd_sy2sb.f"
/* L110: */
#line 337 "dsytrd_sy2sb.f"
	    }
#line 338 "dsytrd_sy2sb.f"
	}
#line 339 "dsytrd_sy2sb.f"
	work[1] = 1.;
#line 340 "dsytrd_sy2sb.f"
	return 0;
#line 341 "dsytrd_sy2sb.f"
    }

/*     Determine the pointer position for the workspace */

#line 345 "dsytrd_sy2sb.f"
    ldt = *kd;
#line 346 "dsytrd_sy2sb.f"
    lds1 = *kd;
#line 347 "dsytrd_sy2sb.f"
    lt = ldt * *kd;
#line 348 "dsytrd_sy2sb.f"
    lw = *n * *kd;
#line 349 "dsytrd_sy2sb.f"
    ls1 = lds1 * *kd;
#line 350 "dsytrd_sy2sb.f"
    ls2 = lwmin - lt - lw - ls1;
/*      LS2 = N*MAX(KD,FACTOPTNB) */
#line 352 "dsytrd_sy2sb.f"
    tpos = 1;
#line 353 "dsytrd_sy2sb.f"
    wpos = tpos + lt;
#line 354 "dsytrd_sy2sb.f"
    s1pos = wpos + lw;
#line 355 "dsytrd_sy2sb.f"
    s2pos = s1pos + ls1;
#line 356 "dsytrd_sy2sb.f"
    if (upper) {
#line 357 "dsytrd_sy2sb.f"
	ldw = *kd;
#line 358 "dsytrd_sy2sb.f"
	lds2 = *kd;
#line 359 "dsytrd_sy2sb.f"
    } else {
#line 360 "dsytrd_sy2sb.f"
	ldw = *n;
#line 361 "dsytrd_sy2sb.f"
	lds2 = *n;
#line 362 "dsytrd_sy2sb.f"
    }
...
#line 368 "dsytrd_sy2sb.f"
    dlaset_("A", &ldt, kd, &c_b17, &c_b17, &work[tpos], &ldt, (ftnlen)1);

#line 370 "dsytrd_sy2sb.f"
    if (upper) {
#line 371 "dsytrd_sy2sb.f"
	i__1 = *n - *kd;
#line 371 "dsytrd_sy2sb.f"
	i__2 = *kd;
#line 371 "dsytrd_sy2sb.f"
	for (i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2) {
#line 372 "dsytrd_sy2sb.f"
	    pn = *n - i__ - *kd + 1;
/* Computing MIN */
#line 373 "dsytrd_sy2sb.f"
	    i__3 = *n - i__ - *kd + 1;
#line 373 "dsytrd_sy2sb.f"
	    pk = min(i__3,*kd);
...
#line 377 "dsytrd_sy2sb.f"
	    dgelqf_(kd, &pn, &a[i__ + (i__ + *kd) * a_dim1], lda, &tau[i__], &
		    work[s2pos], &ls2, &iinfo);

/*            Copy the upper portion of A into AB */

#line 382 "dsytrd_sy2sb.f"
	    i__3 = i__ + pk - 1;
#line 382 "dsytrd_sy2sb.f"
	    for (j = i__; j <= i__3; ++j) {
/* Computing MIN */
#line 383 "dsytrd_sy2sb.f"
		i__4 = *kd, i__5 = *n - j;
#line 383 "dsytrd_sy2sb.f"
		lk = min(i__4,i__5) + 1;
#line 384 "dsytrd_sy2sb.f"
		i__4 = *ldab - 1;
#line 384 "dsytrd_sy2sb.f"
		dcopy_(&lk, &a[j + j * a_dim1], lda, &ab[*kd + 1 + j * 
			ab_dim1], &i__4);
#line 385 "dsytrd_sy2sb.f"
/* L20: */
#line 385 "dsytrd_sy2sb.f"
	    }

#line 387 "dsytrd_sy2sb.f"
	    dlaset_("Lower", &pk, &pk, &c_b17, &c_b23, &a[i__ + (i__ + *kd) * 
		    a_dim1], lda, (ftnlen)5);

/*            Form the matrix T */

#line 392 "dsytrd_sy2sb.f"
...
#line 430 "dsytrd_sy2sb.f"
	i__2 = *n;
#line 430 "dsytrd_sy2sb.f"
	for (j = *n - *kd + 1; j <= i__2; ++j) {
/* Computing MIN */
#line 431 "dsytrd_sy2sb.f"
	    i__1 = *kd, i__3 = *n - j;
#line 431 "dsytrd_sy2sb.f"
	    lk = min(i__1,i__3) + 1;
#line 432 "dsytrd_sy2sb.f"
	    i__1 = *ldab - 1;
#line 432 "dsytrd_sy2sb.f"
	    dcopy_(&lk, &a[j + j * a_dim1], lda, &ab[*kd + 1 + j * ab_dim1], &
		    i__1);
#line 433 "dsytrd_sy2sb.f"
/* L30: */
#line 433 "dsytrd_sy2sb.f"
	}

#line 435 "dsytrd_sy2sb.f"
    } else {

/*         Reduce the lower triangle of A to lower band matrix */

#line 439 "dsytrd_sy2sb.f"
	i__2 = *n - *kd;
#line 439 "dsytrd_sy2sb.f"
	i__1 = *kd;
#line 439 "dsytrd_sy2sb.f"
	for (i__ = 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1) {
#line 440 "dsytrd_sy2sb.f"
	    pn = *n - i__ - *kd + 1;
/* Computing MIN */
#line 441 "dsytrd_sy2sb.f"
	    i__3 = *n - i__ - *kd + 1;
#line 441 "dsytrd_sy2sb.f"
	    pk = min(i__3,*kd);
...
#line 445 "dsytrd_sy2sb.f"
	    dgeqrf_(&pn, kd, &a[i__ + *kd + i__ * a_dim1], lda, &tau[i__], &
		    work[s2pos], &ls2, &iinfo);

/*            Copy the upper portion of A into AB */

#line 450 "dsytrd_sy2sb.f"
	    i__3 = i__ + pk - 1;
#line 450 "dsytrd_sy2sb.f"
	    for (j = i__; j <= i__3; ++j) {
/* Computing MIN */
#line 451 "dsytrd_sy2sb.f"
		i__4 = *kd, i__5 = *n - j;
#line 451 "dsytrd_sy2sb.f"
		lk = min(i__4,i__5) + 1;
#line 452 "dsytrd_sy2sb.f"
		dcopy_(&lk, &a[j + j * a_dim1], &c__1, &ab[j * ab_dim1 + 1], &
			c__1);
#line 453 "dsytrd_sy2sb.f"
/* L50: */
#line 453 "dsytrd_sy2sb.f"
	    }

#line 455 "dsytrd_sy2sb.f"
	    dlaset_("Upper", &pk, &pk, &c_b17, &c_b23, &a[i__ + *kd + i__ * 
		    a_dim1], lda, (ftnlen)5);

/*            Form the matrix T */

#line 460 "dsytrd_sy2sb.f"
...
#line 505 "dsytrd_sy2sb.f"
	i__1 = *n;
#line 505 "dsytrd_sy2sb.f"
	for (j = *n - *kd + 1; j <= i__1; ++j) {
/* Computing MIN */
#line 506 "dsytrd_sy2sb.f"
	    i__2 = *kd, i__3 = *n - j;
#line 506 "dsytrd_sy2sb.f"
	    lk = min(i__2,i__3) + 1;
#line 507 "dsytrd_sy2sb.f"
	    dcopy_(&lk, &a[j + j * a_dim1], &c__1, &ab[j * ab_dim1 + 1], &
		    c__1);
#line 508 "dsytrd_sy2sb.f"
/* L60: */
#line 508 "dsytrd_sy2sb.f"
	}
#line 510 "dsytrd_sy2sb.f"
    }

#line 512 "dsytrd_sy2sb.f"
    work[1] = (doublereal) lwmin;
#line 513 "dsytrd_sy2sb.f"
    return 0;
