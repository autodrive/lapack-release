...
#line 182 "dsytrf_aa.f"
    *info = 0;
#line 183 "dsytrf_aa.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 184 "dsytrf_aa.f"
    lquery = *lwork == -1;
...
#line 209 "dsytrf_aa.f"
    if (*n == 0) {
#line 210 "dsytrf_aa.f"
	return 0;
#line 211 "dsytrf_aa.f"
    }
...
#line 237 "dsytrf_aa.f"
	j = 0;
#line 238 "dsytrf_aa.f"
L10:
#line 239 "dsytrf_aa.f"
	if (j >= *n) {
#line 239 "dsytrf_aa.f"
	    goto L20;
#line 239 "dsytrf_aa.f"
...
#line 249 "dsytrf_aa.f"
	j1 = j + 1;
/* Computing MIN */
#line 250 "dsytrf_aa.f"
	i__1 = *n - j1 + 1;
#line 250 "dsytrf_aa.f"
	jb = min(i__1,nb);
#line 251 "dsytrf_aa.f"
	k1 = max(1,j) - j;
...
#line 262 "dsytrf_aa.f"
	    ipiv[j2] += j;
#line 263 "dsytrf_aa.f"
	    if (j2 != ipiv[j2] && j1 - k1 > 2) {
#line 264 "dsytrf_aa.f"
		i__2 = j1 - k1 - 2;
#line 264 "dsytrf_aa.f"
...
#line 282 "dsytrf_aa.f"
		alpha = a[j + (j + 1) * a_dim1];
#line 283 "dsytrf_aa.f"
		a[j + (j + 1) * a_dim1] = 1.;
...
#line 296 "dsytrf_aa.f"
		    k2 = 1;
#line 297 "dsytrf_aa.f"
		} else {

/*                 First panel */

#line 301 "dsytrf_aa.f"
		    k2 = 0;

/*                 First update skips the first column */

#line 305 "dsytrf_aa.f"
		    --jb;
#line 306 "dsytrf_aa.f"
		}

#line 308 "dsytrf_aa.f"
		i__1 = *n;
#line 308 "dsytrf_aa.f"
		i__2 = nb;
#line 308 "dsytrf_aa.f"
...
#line 313 "dsytrf_aa.f"
		    j3 = j2;
#line 314 "dsytrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
...
#line 356 "dsytrf_aa.f"
	j = 0;
#line 357 "dsytrf_aa.f"
L11:
#line 358 "dsytrf_aa.f"
	if (j >= *n) {
#line 358 "dsytrf_aa.f"
	    goto L20;
#line 358 "dsytrf_aa.f"
...
#line 368 "dsytrf_aa.f"
	j1 = j + 1;
/* Computing MIN */
#line 369 "dsytrf_aa.f"
	i__2 = *n - j1 + 1;
#line 369 "dsytrf_aa.f"
	jb = min(i__2,nb);
#line 370 "dsytrf_aa.f"
	k1 = max(1,j) - j;

/*        Panel factorization */

#line 374 "dsytrf_aa.f"
	i__2 = 2 - k1;
#line 374 "dsytrf_aa.f"
	i__1 = *n - j;
#line 374 "dsytrf_aa.f"
...
#line 381 "dsytrf_aa.f"
	    ipiv[j2] += j;
#line 382 "dsytrf_aa.f"
	    if (j2 != ipiv[j2] && j1 - k1 > 2) {
#line 383 "dsytrf_aa.f"
		i__1 = j1 - k1 - 2;
#line 383 "dsytrf_aa.f"
		dswap_(&i__1, &a[j2 + a_dim1], lda, &a[ipiv[j2] + a_dim1], 
			lda);
#line 385 "dsytrf_aa.f"
	    }
#line 386 "dsytrf_aa.f"
	}
...
#line 397 "dsytrf_aa.f"
	    if (j1 > 1 || jb > 1) {

/*              Merge rank-1 update with BLAS-3 update */

#line 401 "dsytrf_aa.f"
		alpha = a[j + 1 + j * a_dim1];
#line 402 "dsytrf_aa.f"
		a[j + 1 + j * a_dim1] = 1.;
#line 403 "dsytrf_aa.f"
		i__2 = *n - j;
#line 403 "dsytrf_aa.f"
		dcopy_(&i__2, &a[j + 1 + (j - 1) * a_dim1], &c__1, &work[j + 
			1 - j1 + 1 + jb * *n], &c__1);
#line 405 "dsytrf_aa.f"
		i__2 = *n - j;
#line 405 "dsytrf_aa.f"
...
#line 424 "dsytrf_aa.f"
		    --jb;
#line 425 "dsytrf_aa.f"
		}

#line 427 "dsytrf_aa.f"
		i__2 = *n;
#line 427 "dsytrf_aa.f"
		i__1 = nb;
#line 427 "dsytrf_aa.f"
...
#line 432 "dsytrf_aa.f"
		    j3 = j2;
#line 433 "dsytrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
#line 434 "dsytrf_aa.f"
			i__3 = jb + 1;
#line 434 "dsytrf_aa.f"
			dgemv_("No transpose", &mj, &i__3, &c_b18, &work[j3 - 
...
#line 453 "dsytrf_aa.f"
	    }

/*           WORK(J+1, 1) stores H(J+1, 1) */

#line 457 "dsytrf_aa.f"
	    i__1 = *n - j;
#line 457 "dsytrf_aa.f"
	    dcopy_(&i__1, &a[j + 1 + (j + 1) * a_dim1], &c__1, &work[1], &
		    c__1);
#line 458 "dsytrf_aa.f"
	}
#line 459 "dsytrf_aa.f"
	goto L11;
#line 460 "dsytrf_aa.f"
    }

#line 462 "dsytrf_aa.f"
L20:
#line 463 "dsytrf_aa.f"
    return 0;
