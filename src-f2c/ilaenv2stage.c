#line 1 "ilaenv2stage.f"
/* ilaenv2stage.f -- translated by f2c (version 20100827).
...
#line 177 "ilaenv2stage.f"
    ret_val = -1;
#line 178 "ilaenv2stage.f"
    return ret_val;

#line 180 "ilaenv2stage.f"
L10:

/*     2stage eigenvalues and SVD or related subroutines. */

#line 184 "ilaenv2stage.f"
    iispec = *ispec + 16;
#line 185 "ilaenv2stage.f"
    ret_val = iparam2stage_(&iispec, name__, opts, n1, n2, n3, n4, name_len, 
	    opts_len);
#line 187 "ilaenv2stage.f"
    return ret_val;
