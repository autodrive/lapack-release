...
/* > */
/*  ===================================================================== */
/* Subroutine */ int sgeqrt_(integer *m, integer *n, integer *nb, doublereal *
	...
	integer *info)
{
    ...
    extern /* Subroutine */ int slarfb_(char *, char *, char *, char *, 
	    ...
	    integer *, ftnlen), sgeqrt2_(integer *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, integer *), sgeqrt3_(integer *
