...
/*  ===================================================================== */
/* Subroutine */ int sgetrf_(integer *m, integer *n, doublereal *a, integer *
	lda, integer *ipiv, integer *info)
{
    ...
    extern /* Subroutine */ int sgemm_(char *, char *, integer *, integer *, 
	    ...
	    ftnlen, ftnlen, ftnlen, ftnlen), sgetf2_(integer *, integer *, 
	    doublereal *, integer *, integer *, integer *), xerbla_(char *, 
	    integer *, ftnlen);
