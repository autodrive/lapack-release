...
#line 482 "sla_gbrfsx_extended.f"
...
#line 483 "sla_gbrfsx_extended.f"
...
#line 490 "sla_gbrfsx_extended.f"
    m = *kl + *ku + 1;
#line 492 "sla_gbrfsx_extended.f"
    i__1 = *nrhs;
#line 492 "sla_gbrfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 493 "sla_gbrfsx_extended.f"
	y_prec_state__ = 1;
...
#line 500 "sla_gbrfsx_extended.f"
	dxrat = 0.;
#line 501 "sla_gbrfsx_extended.f"
	dxratmax = 0.;
...
#line 511 "sla_gbrfsx_extended.f"
	x_state__ = 1;
#line 512 "sla_gbrfsx_extended.f"
	z_state__ = 0;
...
#line 520 "sla_gbrfsx_extended.f"
	    scopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 521 "sla_gbrfsx_extended.f"
	    if (y_prec_state__ == 0) {
...
#line 548 "sla_gbrfsx_extended.f"
...
#line 551 "sla_gbrfsx_extended.f"
		if (yk != 0.) {
/* Computing MAX */
#line 552 "sla_gbrfsx_extended.f"
...
#line 561 "sla_gbrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
#line 562 "sla_gbrfsx_extended.f"
...
#line 570 "sla_gbrfsx_extended.f"
	    if (normx != 0.) {
#line 571 "sla_gbrfsx_extended.f"
		dx_x__ = normdx / normx;
...
#line 579 "sla_gbrfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria. */

#line 583 "sla_gbrfsx_extended.f"
...
#line 588 "sla_gbrfsx_extended.f"
...
#line 590 "sla_gbrfsx_extended.f"
	    if (x_state__ == 1) {
#line 591 "sla_gbrfsx_extended.f"
		if (dx_x__ <= eps) {
...
#line 609 "sla_gbrfsx_extended.f"
	    if (z_state__ == 1) {
#line 610 "sla_gbrfsx_extended.f"
		if (dz_z__ <= eps) {
...
#line 632 "sla_gbrfsx_extended.f"
	    if (x_state__ != 1) {
#line 633 "sla_gbrfsx_extended.f"
		if (*ignore_cwise__) {
#line 633 "sla_gbrfsx_extended.f"
		    goto L666;
#line 633 "sla_gbrfsx_extended.f"
...
#line 637 "sla_gbrfsx_extended.f"
	    }
#line 639 "sla_gbrfsx_extended.f"
	    if (incr_prec__) {
#line 640 "sla_gbrfsx_extended.f"
		incr_prec__ = FALSE_;
...
#line 647 "sla_gbrfsx_extended.f"
	    prevnormdx = normdx;
#line 648 "sla_gbrfsx_extended.f"
	    prev_dz_z__ = dz_z__;

/*           Update soluton. */

#line 652 "sla_gbrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 653 "sla_gbrfsx_extended.f"
...
#line 664 "sla_gbrfsx_extended.f"
	if (x_state__ == 1) {
#line 664 "sla_gbrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 664 "sla_gbrfsx_extended.f"
	}
#line 665 "sla_gbrfsx_extended.f"
	if (z_state__ == 1) {
#line 665 "sla_gbrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 665 "sla_gbrfsx_extended.f"
...
#line 669 "sla_gbrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 670 "sla_gbrfsx_extended.f"
	    err_bnds_norm__[j + (err_bnds_norm_dim1 << 1)] = final_dx_x__ / (
		    1 - dxratmax);
#line 672 "sla_gbrfsx_extended.f"
	}
#line 673 "sla_gbrfsx_extended.f"
	if (*n_norms__ >= 2) {
...
#line 686 "sla_gbrfsx_extended.f"
	scopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 687 "sla_gbrfsx_extended.f"
	sgbmv_(trans, n, n, kl, ku, &c_b6, &ab[ab_offset], ldab, &y[j * 
		y_dim1 + 1], &c__1, &c_b8, &res[1], &c__1, (ftnlen)1);
#line 690 "sla_gbrfsx_extended.f"
	i__2 = *n;
#line 690 "sla_gbrfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 691 "sla_gbrfsx_extended.f"
