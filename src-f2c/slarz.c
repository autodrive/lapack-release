...
#line 194 "slarz.f"
	    d__1 = -(*tau);
#line 194 "slarz.f"
	    saxpy_(n, &d__1, &work[1], &c__1, &c__[c_offset], ldc);
...
#line 199 "slarz.f"
	    d__1 = -(*tau);
#line 199 "slarz.f"
	    sger_(l, n, &d__1, &v[1], incv, &work[1], &c__1, &c__[*m - *l + 1 
		    + c_dim1], ldc);
#line 201 "slarz.f"
	}
...
#line 220 "slarz.f"
	    d__1 = -(*tau);
#line 220 "slarz.f"
	    saxpy_(m, &d__1, &work[1], &c__1, &c__[c_offset], &c__1);
...
#line 225 "slarz.f"
	    d__1 = -(*tau);
#line 225 "slarz.f"
	    sger_(m, l, &d__1, &work[1], &c__1, &v[1], incv, &c__[(*n - *l + 
		    1) * c_dim1 + 1], ldc);
