...
/* > */
/*  ===================================================================== */
/* Subroutine */ int sorbdb3_(integer *m, integer *p, integer *q, doublereal *
...
/* Computing 2nd power */
#line 296 "sorbdb3.f"
	d__1 = snrm2_(&i__2, &x11[i__ + i__ * x11_dim1], &c__1, &x11[i__ + 
		i__ * x11_dim1], &c__1);
#line 296 "sorbdb3.f"
	i__3 = *m - *p - i__;
/* Computing 2nd power */
#line 296 "sorbdb3.f"
	d__2 = snrm2_(&i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, &x21[i__ 
		+ 1 + i__ * x21_dim1], &c__1);
#line 296 "sorbdb3.f"
