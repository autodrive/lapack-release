	 ...
	 ftnlen equed_len)
{
    ...
    extern doublereal sla_porpvgrw__(char *, integer *, doublereal *, integer 
    ...
    extern /* Subroutine */ int slaqsy_(char *, integer *, doublereal *, 
	    ...
	    ftnlen, ftnlen), spotrf_(char *, integer *, doublereal *, integer 
	    *, integer *, ftnlen), spotrs_(char *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, integer *, integer *, 
	    ftnlen), slascl2_(integer *, integer *, doublereal *, doublereal *
	    , integer *), spoequb_(integer *, doublereal *, integer *, 
	    doublereal *, doublereal *, doublereal *, integer *), sporfsx_(
