...
#line 285 "ssbevd_2stage.f"
    lower = lsame_(uplo, "L", (ftnlen)1, (ftnlen)1);
#line 286 "ssbevd_2stage.f"
    lquery = *lwork == -1 || *liwork == -1;

#line 288 "ssbevd_2stage.f"
    *info = 0;
#line 289 "ssbevd_2stage.f"
    if (*n <= 1) {
#line 290 "ssbevd_2stage.f"
	liwmin = 1;
#line 291 "ssbevd_2stage.f"
	lwmin = 1;
#line 292 "ssbevd_2stage.f"
    } else {
#line 293 "ssbevd_2stage.f"
	ib = ilaenv_(&c__18, "SSYTRD_SB2ST", jobz, n, kd, &c_n1, &c_n1, (
		ftnlen)12, (ftnlen)1);
#line 294 "ssbevd_2stage.f"
	lhtrd = ilaenv_(&c__19, "SSYTRD_SB2ST", jobz, n, kd, &ib, &c_n1, (
		ftnlen)12, (ftnlen)1);
#line 295 "ssbevd_2stage.f"
	lwtrd = ilaenv_(&c__20, "SSYTRD_SB2ST", jobz, n, kd, &ib, &c_n1, (
		ftnlen)12, (ftnlen)1);
#line 296 "ssbevd_2stage.f"
	if (wantz) {
#line 297 "ssbevd_2stage.f"
	    liwmin = *n * 5 + 3;
/* Computing 2nd power */
#line 298 "ssbevd_2stage.f"
	    i__1 = *n;
#line 298 "ssbevd_2stage.f"
	    lwmin = *n * 5 + 1 + (i__1 * i__1 << 1);
#line 299 "ssbevd_2stage.f"
	} else {
#line 300 "ssbevd_2stage.f"
	    liwmin = 1;
/* Computing MAX */
#line 301 "ssbevd_2stage.f"
	    i__1 = *n << 1, i__2 = *n + lhtrd + lwtrd;
#line 301 "ssbevd_2stage.f"
	    lwmin = max(i__1,i__2);
#line 302 "ssbevd_2stage.f"
	}
#line 303 "ssbevd_2stage.f"
    }
#line 304 "ssbevd_2stage.f"
    if (! lsame_(jobz, "N", (ftnlen)1, (ftnlen)1)) {
#line 305 "ssbevd_2stage.f"
	*info = -1;
#line 306 "ssbevd_2stage.f"
    } else if (! (lower || lsame_(uplo, "U", (ftnlen)1, (ftnlen)1))) {
#line 307 "ssbevd_2stage.f"
	*info = -2;
#line 308 "ssbevd_2stage.f"
    } else if (*n < 0) {
#line 309 "ssbevd_2stage.f"
	*info = -3;
#line 310 "ssbevd_2stage.f"
    } else if (*kd < 0) {
#line 311 "ssbevd_2stage.f"
	*info = -4;
#line 312 "ssbevd_2stage.f"
    } else if (*ldab < *kd + 1) {
#line 313 "ssbevd_2stage.f"
	*info = -6;
#line 314 "ssbevd_2stage.f"
    } else if (*ldz < 1 || wantz && *ldz < *n) {
#line 315 "ssbevd_2stage.f"
	*info = -9;
#line 316 "ssbevd_2stage.f"
    }

#line 318 "ssbevd_2stage.f"
    if (*info == 0) {
#line 319 "ssbevd_2stage.f"
	work[1] = (doublereal) lwmin;
#line 320 "ssbevd_2stage.f"
	iwork[1] = liwmin;

#line 322 "ssbevd_2stage.f"
	if (*lwork < lwmin && ! lquery) {
#line 323 "ssbevd_2stage.f"
	    *info = -11;
#line 324 "ssbevd_2stage.f"
	} else if (*liwork < liwmin && ! lquery) {
#line 325 "ssbevd_2stage.f"
	    *info = -13;
#line 326 "ssbevd_2stage.f"
	}
#line 327 "ssbevd_2stage.f"
    }

#line 329 "ssbevd_2stage.f"
    if (*info != 0) {
#line 330 "ssbevd_2stage.f"
	i__1 = -(*info);
#line 330 "ssbevd_2stage.f"
	xerbla_("SSBEVD_2STAGE", &i__1, (ftnlen)13);
#line 331 "ssbevd_2stage.f"
	return 0;
#line 332 "ssbevd_2stage.f"
    } else if (lquery) {
#line 333 "ssbevd_2stage.f"
	return 0;
#line 334 "ssbevd_2stage.f"
    }

/*     Quick return if possible */

#line 338 "ssbevd_2stage.f"
    if (*n == 0) {
#line 338 "ssbevd_2stage.f"
	return 0;
#line 338 "ssbevd_2stage.f"
...
#line 341 "ssbevd_2stage.f"
    if (*n == 1) {
#line 342 "ssbevd_2stage.f"
	w[1] = ab[ab_dim1 + 1];
#line 343 "ssbevd_2stage.f"
	if (wantz) {
#line 343 "ssbevd_2stage.f"
	    z__[z_dim1 + 1] = 1.;
#line 343 "ssbevd_2stage.f"
	}
#line 345 "ssbevd_2stage.f"
	return 0;
#line 346 "ssbevd_2stage.f"
    }

/*     Get machine constants. */

#line 350 "ssbevd_2stage.f"
    safmin = slamch_("Safe minimum", (ftnlen)12);
#line 351 "ssbevd_2stage.f"
    eps = slamch_("Precision", (ftnlen)9);
#line 352 "ssbevd_2stage.f"
    smlnum = safmin / eps;
#line 353 "ssbevd_2stage.f"
    bignum = 1. / smlnum;
#line 354 "ssbevd_2stage.f"
    rmin = sqrt(smlnum);
#line 355 "ssbevd_2stage.f"
    rmax = sqrt(bignum);

/*     Scale matrix to allowable range, if necessary. */

#line 359 "ssbevd_2stage.f"
    anrm = slansb_("M", uplo, n, kd, &ab[ab_offset], ldab, &work[1], (ftnlen)
	    1, (ftnlen)1);
#line 360 "ssbevd_2stage.f"
    iscale = 0;
#line 361 "ssbevd_2stage.f"
    if (anrm > 0. && anrm < rmin) {
#line 362 "ssbevd_2stage.f"
	iscale = 1;
#line 363 "ssbevd_2stage.f"
	sigma = rmin / anrm;
#line 364 "ssbevd_2stage.f"
    } else if (anrm > rmax) {
#line 365 "ssbevd_2stage.f"
	iscale = 1;
#line 366 "ssbevd_2stage.f"
	sigma = rmax / anrm;
#line 367 "ssbevd_2stage.f"
    }
#line 368 "ssbevd_2stage.f"
    if (iscale == 1) {
#line 369 "ssbevd_2stage.f"
	if (lower) {
#line 370 "ssbevd_2stage.f"
	    slascl_("B", kd, kd, &c_b21, &sigma, n, n, &ab[ab_offset], ldab, 
		    info, (ftnlen)1);
#line 371 "ssbevd_2stage.f"
	} else {
#line 372 "ssbevd_2stage.f"
	    slascl_("Q", kd, kd, &c_b21, &sigma, n, n, &ab[ab_offset], ldab, 
		    info, (ftnlen)1);
#line 373 "ssbevd_2stage.f"
	}
#line 374 "ssbevd_2stage.f"
    }

/*     Call SSYTRD_SB2ST to reduce band symmetric matrix to tridiagonal form. */

#line 378 "ssbevd_2stage.f"
    inde = 1;
#line 379 "ssbevd_2stage.f"
    indhous = inde + *n;
#line 380 "ssbevd_2stage.f"
    indwrk = indhous + lhtrd;
#line 381 "ssbevd_2stage.f"
    llwork = *lwork - indwrk + 1;
#line 382 "ssbevd_2stage.f"
    indwk2 = indwrk + *n * *n;
#line 383 "ssbevd_2stage.f"
    llwrk2 = *lwork - indwk2 + 1;

#line 385 "ssbevd_2stage.f"
...
#line 406 "ssbevd_2stage.f"
    work[1] = (doublereal) lwmin;
#line 407 "ssbevd_2stage.f"
    iwork[1] = liwmin;
#line 408 "ssbevd_2stage.f"
    return 0;
