...
#line 424 "ssbevx_2stage.f"
	    lwtrd = ilaenv_(&c__20, "SSYTRD_SB2ST", jobz, n, kd, &ib, &c_n1, (
		    ftnlen)12, (ftnlen)1);
#line 425 "ssbevx_2stage.f"
	    lwmin = (*n << 1) + lhtrd + lwtrd;
#line 426 "ssbevx_2stage.f"
	    work[1] = (doublereal) lwmin;
#line 427 "ssbevx_2stage.f"
	}
...
#line 431 "ssbevx_2stage.f"
    }

#line 433 "ssbevx_2stage.f"
    if (*info != 0) {
#line 434 "ssbevx_2stage.f"
	i__1 = -(*info);
#line 434 "ssbevx_2stage.f"
	xerbla_("SSBEVX_2STAGE ", &i__1, (ftnlen)14);
#line 435 "ssbevx_2stage.f"
	return 0;
...
#line 442 "ssbevx_2stage.f"
    *m = 0;
#line 443 "ssbevx_2stage.f"
    if (*n == 0) {
#line 443 "ssbevx_2stage.f"
	return 0;
#line 443 "ssbevx_2stage.f"
...
#line 446 "ssbevx_2stage.f"
    if (*n == 1) {
#line 447 "ssbevx_2stage.f"
	*m = 1;
#line 448 "ssbevx_2stage.f"
	if (lower) {
...
#line 462 "ssbevx_2stage.f"
	return 0;
#line 463 "ssbevx_2stage.f"
    }

/*     Get machine constants. */

#line 467 "ssbevx_2stage.f"
    safmin = slamch_("Safe minimum", (ftnlen)12);
#line 468 "ssbevx_2stage.f"
    eps = slamch_("Precision", (ftnlen)9);
#line 469 "ssbevx_2stage.f"
    smlnum = safmin / eps;
...
#line 476 "ssbevx_2stage.f"
    iscale = 0;
#line 477 "ssbevx_2stage.f"
    abstll = *abstol;
#line 478 "ssbevx_2stage.f"
    if (valeig) {
...
#line 509 "ssbevx_2stage.f"
    indd = 1;
#line 510 "ssbevx_2stage.f"
    inde = indd + *n;
#line 511 "ssbevx_2stage.f"
    indhous = inde + *n;
...
#line 523 "ssbevx_2stage.f"
    test = FALSE_;
#line 524 "ssbevx_2stage.f"
    if (indeig) {
#line 525 "ssbevx_2stage.f"
	if (*il == 1 && *iu == *n) {
...
#line 555 "ssbevx_2stage.f"
    if (wantz) {
#line 556 "ssbevx_2stage.f"
	*(unsigned char *)order = 'B';
#line 557 "ssbevx_2stage.f"
    } else {
...
#line 568 "ssbevx_2stage.f"
    if (wantz) {
#line 569 "ssbevx_2stage.f"
...
#line 576 "ssbevx_2stage.f"
	i__1 = *m;
#line 576 "ssbevx_2stage.f"
	for (j = 1; j <= i__1; ++j) {
#line 577 "ssbevx_2stage.f"
	    scopy_(n, &z__[j * z_dim1 + 1], &c__1, &work[1], &c__1);
#line 578 "ssbevx_2stage.f"
...
#line 585 "ssbevx_2stage.f"
L30:
#line 586 "ssbevx_2stage.f"
    if (iscale == 1) {
#line 587 "ssbevx_2stage.f"
	if (*info == 0) {
...
#line 598 "ssbevx_2stage.f"
    if (wantz) {
#line 599 "ssbevx_2stage.f"
	i__1 = *m - 1;
#line 599 "ssbevx_2stage.f"
	for (j = 1; j <= i__1; ++j) {
#line 600 "ssbevx_2stage.f"
	    i__ = 0;
...
#line 627 "ssbevx_2stage.f"
    work[1] = (doublereal) lwmin;

#line 629 "ssbevx_2stage.f"
    return 0;
