	...
	integer *info, ftnlen fact_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int sspcon_(char *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *, 
	    integer *, ftnlen), ssprfs_(char *, integer *, integer *, 
	    doublereal *, doublereal *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, doublereal *,
	     integer *, integer *, ftnlen), ssptrf_(char *, integer *, 
	    doublereal *, integer *, integer *, ftnlen), ssptrs_(char *, 
