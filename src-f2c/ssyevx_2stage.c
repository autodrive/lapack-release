...
#line 417 "ssyevx_2stage.f"
    *m = 0;
#line 418 "ssyevx_2stage.f"
    if (*n == 0) {
#line 419 "ssyevx_2stage.f"
	return 0;
#line 420 "ssyevx_2stage.f"
    }
...
#line 440 "ssyevx_2stage.f"
    eps = slamch_("Precision", (ftnlen)9);
#line 441 "ssyevx_2stage.f"
    smlnum = safmin / eps;
#line 442 "ssyevx_2stage.f"
    bignum = 1. / smlnum;
...
#line 448 "ssyevx_2stage.f"
    iscale = 0;
#line 449 "ssyevx_2stage.f"
    abstll = *abstol;
#line 450 "ssyevx_2stage.f"
    if (valeig) {
#line 451 "ssyevx_2stage.f"
	vll = *vl;
...
#line 482 "ssyevx_2stage.f"
    indtau = 1;
#line 483 "ssyevx_2stage.f"
    inde = indtau + *n;
#line 484 "ssyevx_2stage.f"
    indd = inde + *n;
#line 485 "ssyevx_2stage.f"
    indhous = indd + *n;
...
#line 497 "ssyevx_2stage.f"
    test = FALSE_;
#line 498 "ssyevx_2stage.f"
    if (indeig) {
#line 499 "ssyevx_2stage.f"
	if (*il == 1 && *iu == *n) {
#line 500 "ssyevx_2stage.f"
	    test = TRUE_;
...
#line 531 "ssyevx_2stage.f"
    if (wantz) {
#line 532 "ssyevx_2stage.f"
	*(unsigned char *)order = 'B';
#line 533 "ssyevx_2stage.f"
    } else {
#line 534 "ssyevx_2stage.f"
...
#line 544 "ssyevx_2stage.f"
    if (wantz) {
#line 545 "ssyevx_2stage.f"
...
#line 552 "ssyevx_2stage.f"
	indwkn = inde;
#line 553 "ssyevx_2stage.f"
	llwrkn = *lwork - indwkn + 1;
#line 554 "ssyevx_2stage.f"
...
L40:
#line 561 "ssyevx_2stage.f"
    if (iscale == 1) {
#line 562 "ssyevx_2stage.f"
	if (*info == 0) {
#line 563 "ssyevx_2stage.f"
	    imax = *m;
...
#line 573 "ssyevx_2stage.f"
    if (wantz) {
#line 574 "ssyevx_2stage.f"
	i__1 = *m - 1;
#line 574 "ssyevx_2stage.f"
	for (j = 1; j <= i__1; ++j) {
#line 575 "ssyevx_2stage.f"
	    i__ = 0;
#line 576 "ssyevx_2stage.f"
	    tmp1 = w[j];
