	...
	ftnlen jobz_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int strsm_(char *, char *, char *, char *, 
	    ...
	    char *, integer *, ftnlen), spotrf_(char *, integer *, doublereal 
...
#line 328 "ssygv_2stage.f"
    if (wantz) {

/*        Backtransform eigenvectors to the original problem. */

#line 332 "ssygv_2stage.f"
	neig = *n;
...
#line 335 "ssygv_2stage.f"
	if (*itype == 1 || *itype == 2) {

/*           For A*x=(lambda)*B*x and A*B*x=(lambda)*x; */
/*           backtransform eigenvectors: x = inv(L)**T*y or inv(U)*y */

#line 340 "ssygv_2stage.f"
	    if (upper) {
...
#line 360 "ssygv_2stage.f"
	    strmm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[
		    b_offset], ldb, &a[a_offset], lda, (ftnlen)4, (ftnlen)1, (
		    ftnlen)1, (ftnlen)8);
#line 362 "ssygv_2stage.f"
	}
#line 363 "ssygv_2stage.f"
    }

#line 365 "ssygv_2stage.f"
    work[1] = (doublereal) lwmin;
