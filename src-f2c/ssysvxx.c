	...
	ftnlen fact_len, ftnlen uplo_len, ftnlen equed_len)
{
    ...
    extern doublereal sla_syrpvgrw__(char *, integer *, integer *, doublereal 
    ...
    extern /* Subroutine */ int slaqsy_(char *, integer *, doublereal *, 
	    ...
	    ftnlen, ftnlen), ssytrf_(char *, integer *, doublereal *, integer 
	    *, integer *, doublereal *, integer *, integer *, ftnlen), 
	    slascl2_(integer *, integer *, doublereal *, doublereal *, 
	    integer *), ssytrs_(char *, integer *, integer *, doublereal *, 
	    integer *, integer *, doublereal *, integer *, integer *, ftnlen),
	     ssyequb_(char *, integer *, doublereal *, integer *, doublereal *
