...
/* > */
/*  ===================================================================== */
/* Subroutine */ int ssytrd_2stage__(char *vect, char *uplo, integer *n, 
	 ...
	 integer *lwork, integer *info, ftnlen vect_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int ssytrd_sb2st__(char *, char *, char *, 
	    ...
	    integer *, ftnlen, ftnlen, ftnlen), ssytrd_sy2sb__(char *, 
	    integer *, integer *, doublereal *, integer *, doublereal *, 
...
#line 263 "ssytrd_2stage.f"
    *info = 0;
#line 264 "ssytrd_2stage.f"
    wantq = lsame_(vect, "V", (ftnlen)1, (ftnlen)1);
#line 265 "ssytrd_2stage.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 266 "ssytrd_2stage.f"
    lquery = *lwork == -1 || *lhous2 == -1;

/*     Determine the block size, the workspace size and the hous size. */

#line 270 "ssytrd_2stage.f"
    kd = ilaenv2stage_(&c__1, "SSYTRD_2STAGE", vect, n, &c_n1, &c_n1, &c_n1, (
	    ftnlen)13, (ftnlen)1);
#line 271 "ssytrd_2stage.f"
    ib = ilaenv2stage_(&c__2, "SSYTRD_2STAGE", vect, n, &kd, &c_n1, &c_n1, (
	    ftnlen)13, (ftnlen)1);
#line 272 "ssytrd_2stage.f"
    lhmin = ilaenv2stage_(&c__3, "SSYTRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
#line 273 "ssytrd_2stage.f"
    lwmin = ilaenv2stage_(&c__4, "SSYTRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
/*      WRITE(*,*),'SSYTRD_2STAGE N KD UPLO LHMIN LWMIN ',N, KD, UPLO, */
/*     $            LHMIN, LWMIN */

#line 277 "ssytrd_2stage.f"
    if (! lsame_(vect, "N", (ftnlen)1, (ftnlen)1)) {
#line 278 "ssytrd_2stage.f"
	*info = -1;
#line 279 "ssytrd_2stage.f"
    } else if (! upper && ! lsame_(uplo, "L", (ftnlen)1, (ftnlen)1)) {
#line 280 "ssytrd_2stage.f"
	*info = -2;
#line 281 "ssytrd_2stage.f"
    } else if (*n < 0) {
#line 282 "ssytrd_2stage.f"
	*info = -3;
#line 283 "ssytrd_2stage.f"
    } else if (*lda < max(1,*n)) {
#line 284 "ssytrd_2stage.f"
	*info = -5;
#line 285 "ssytrd_2stage.f"
    } else if (*lhous2 < lhmin && ! lquery) {
#line 286 "ssytrd_2stage.f"
	*info = -10;
#line 287 "ssytrd_2stage.f"
    } else if (*lwork < lwmin && ! lquery) {
#line 288 "ssytrd_2stage.f"
	*info = -12;
#line 289 "ssytrd_2stage.f"
    }

#line 291 "ssytrd_2stage.f"
    if (*info == 0) {
#line 292 "ssytrd_2stage.f"
	hous2[1] = (doublereal) lhmin;
#line 293 "ssytrd_2stage.f"
	work[1] = (doublereal) lwmin;
#line 294 "ssytrd_2stage.f"
    }

#line 296 "ssytrd_2stage.f"
    if (*info != 0) {
#line 297 "ssytrd_2stage.f"
	i__1 = -(*info);
#line 297 "ssytrd_2stage.f"
	xerbla_("SSYTRD_2STAGE", &i__1, (ftnlen)13);
#line 298 "ssytrd_2stage.f"
	return 0;
#line 299 "ssytrd_2stage.f"
    } else if (lquery) {
#line 300 "ssytrd_2stage.f"
	return 0;
#line 301 "ssytrd_2stage.f"
    }

/*     Quick return if possible */

#line 305 "ssytrd_2stage.f"
    if (*n == 0) {
#line 306 "ssytrd_2stage.f"
	work[1] = 1.;
#line 307 "ssytrd_2stage.f"
	return 0;
#line 308 "ssytrd_2stage.f"
    }

/*     Determine pointer position */

#line 312 "ssytrd_2stage.f"
    ldab = kd + 1;
#line 313 "ssytrd_2stage.f"
    lwrk = *lwork - ldab * *n;
#line 314 "ssytrd_2stage.f"
    abpos = 1;
#line 315 "ssytrd_2stage.f"
    wpos = abpos + ldab * *n;
#line 316 "ssytrd_2stage.f"
    ssytrd_sy2sb__(uplo, n, &kd, &a[a_offset], lda, &work[abpos], &ldab, &tau[
	    1], &work[wpos], &lwrk, info, (ftnlen)1);
#line 318 "ssytrd_2stage.f"
    if (*info != 0) {
#line 319 "ssytrd_2stage.f"
	i__1 = -(*info);
#line 319 "ssytrd_2stage.f"
	xerbla_("SSYTRD_SY2SB", &i__1, (ftnlen)12);
#line 320 "ssytrd_2stage.f"
	return 0;
#line 321 "ssytrd_2stage.f"
    }
#line 322 "ssytrd_2stage.f"
    ssytrd_sb2st__("Y", vect, uplo, n, &kd, &work[abpos], &ldab, &d__[1], &e[
	    1], &hous2[1], lhous2, &work[wpos], &lwrk, info, (ftnlen)1, (
	    ftnlen)1, (ftnlen)1);
#line 325 "ssytrd_2stage.f"
    if (*info != 0) {
#line 326 "ssytrd_2stage.f"
	i__1 = -(*info);
#line 326 "ssytrd_2stage.f"
	xerbla_("SSYTRD_SB2ST", &i__1, (ftnlen)12);
#line 327 "ssytrd_2stage.f"
	return 0;
#line 328 "ssytrd_2stage.f"
    }


#line 331 "ssytrd_2stage.f"
    hous2[1] = (doublereal) lhmin;
#line 332 "ssytrd_2stage.f"
    work[1] = (doublereal) lwmin;
#line 333 "ssytrd_2stage.f"
    return 0;
