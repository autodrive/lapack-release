...
#line 205 "ssytrf_aa.f"
	return 0;
#line 206 "ssytrf_aa.f"
    } else if (lquery) {
#line 207 "ssytrf_aa.f"
	return 0;
#line 208 "ssytrf_aa.f"
    }
...
#line 215 "ssytrf_aa.f"
    ipiv[1] = 1;
#line 216 "ssytrf_aa.f"
    if (*n == 1) {
#line 217 "ssytrf_aa.f"
	if (a[a_dim1 + 1] == 0.) {
#line 218 "ssytrf_aa.f"
	    *info = 1;
...
#line 225 "ssytrf_aa.f"
    if (*lwork < (nb + 1) * *n) {
#line 226 "ssytrf_aa.f"
	nb = (*lwork - *n) / *n;
#line 227 "ssytrf_aa.f"
    }

#line 229 "ssytrf_aa.f"
    if (upper) {
...
#line 243 "ssytrf_aa.f"
	j = 0;
#line 244 "ssytrf_aa.f"
L10:
#line 245 "ssytrf_aa.f"
	if (j >= *n) {
#line 245 "ssytrf_aa.f"
	    goto L20;
#line 245 "ssytrf_aa.f"
...
#line 255 "ssytrf_aa.f"
	j1 = j + 1;
/* Computing MIN */
#line 256 "ssytrf_aa.f"
	i__1 = *n - j1 + 1;
#line 256 "ssytrf_aa.f"
	jb = min(i__1,nb);
#line 257 "ssytrf_aa.f"
	k1 = max(1,j) - j;
...
/* Computing MIN */
#line 271 "ssytrf_aa.f"
	i__2 = *n, i__3 = j + jb + 1;
#line 271 "ssytrf_aa.f"
	i__1 = min(i__2,i__3);
#line 271 "ssytrf_aa.f"
	for (j2 = j + 2; j2 <= i__1; ++j2) {
#line 272 "ssytrf_aa.f"
	    ipiv[j2] += j;
#line 273 "ssytrf_aa.f"
...
#line 274 "ssytrf_aa.f"
		sswap_(&i__2, &a[j2 * a_dim1 + 1], &c__1, &a[ipiv[j2] * 
			a_dim1 + 1], &c__1);
#line 276 "ssytrf_aa.f"
	    }
#line 277 "ssytrf_aa.f"
	}
...
#line 293 "ssytrf_aa.f"
		a[j + (j + 1) * a_dim1] = 1.;
#line 294 "ssytrf_aa.f"
		i__1 = *n - j;
#line 294 "ssytrf_aa.f"
...
#line 306 "ssytrf_aa.f"
		    k2 = 1;
#line 307 "ssytrf_aa.f"
		} else {

/*                 First panel */

#line 311 "ssytrf_aa.f"
		    k2 = 0;
...
#line 315 "ssytrf_aa.f"
		    --jb;
#line 316 "ssytrf_aa.f"
		}

#line 318 "ssytrf_aa.f"
		i__1 = *n;
#line 318 "ssytrf_aa.f"
		i__2 = nb;
#line 318 "ssytrf_aa.f"
...
#line 323 "ssytrf_aa.f"
		    j3 = j2;
#line 324 "ssytrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
#line 325 "ssytrf_aa.f"
			i__3 = jb + 1;
#line 325 "ssytrf_aa.f"
...
#line 343 "ssytrf_aa.f"
		a[j + (j + 1) * a_dim1] = alpha;
#line 344 "ssytrf_aa.f"
	    }

/*           WORK(J+1, 1) stores H(J+1, 1) */

#line 348 "ssytrf_aa.f"
	    i__2 = *n - j;
#line 348 "ssytrf_aa.f"
	    scopy_(&i__2, &a[j + 1 + (j + 1) * a_dim1], lda, &work[1], &c__1);
#line 349 "ssytrf_aa.f"
	}
#line 350 "ssytrf_aa.f"
	goto L10;
#line 351 "ssytrf_aa.f"
    } else {
...
#line 366 "ssytrf_aa.f"
	j = 0;
#line 367 "ssytrf_aa.f"
L11:
...
#line 378 "ssytrf_aa.f"
	j1 = j + 1;
/* Computing MIN */
#line 379 "ssytrf_aa.f"
	i__2 = *n - j1 + 1;
#line 379 "ssytrf_aa.f"
	jb = min(i__2,nb);
...
#line 387 "ssytrf_aa.f"
	if (iinfo > 0 && *info == 0) {
#line 388 "ssytrf_aa.f"
	    *info = iinfo + j;
#line 389 "ssytrf_aa.f"
	}
...
#line 394 "ssytrf_aa.f"
	    ipiv[j2] += j;
#line 395 "ssytrf_aa.f"
	    if (j2 != ipiv[j2] && j1 - k1 > 2) {
#line 396 "ssytrf_aa.f"
		i__1 = j1 - k1 - 2;
#line 396 "ssytrf_aa.f"
		sswap_(&i__1, &a[j2 + a_dim1], lda, &a[ipiv[j2] + a_dim1], 
			lda);
#line 398 "ssytrf_aa.f"
	    }
#line 399 "ssytrf_aa.f"
	}
#line 400 "ssytrf_aa.f"
	j += jb;
...
#line 406 "ssytrf_aa.f"
	if (j < *n) {

/*           if first panel and JB=1 (NB=1), then nothing to do */

#line 410 "ssytrf_aa.f"
	    if (j1 > 1 || jb > 1) {

/*              Merge rank-1 update with BLAS-3 update */

#line 414 "ssytrf_aa.f"
...
#line 437 "ssytrf_aa.f"
		    --jb;
#line 438 "ssytrf_aa.f"
		}

#line 440 "ssytrf_aa.f"
		i__2 = *n;
#line 440 "ssytrf_aa.f"
		i__1 = nb;
#line 440 "ssytrf_aa.f"
...
#line 445 "ssytrf_aa.f"
		    j3 = j2;
#line 446 "ssytrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
#line 447 "ssytrf_aa.f"
			i__3 = jb + 1;
#line 447 "ssytrf_aa.f"
			sgemv_("No transpose", &mj, &i__3, &c_b18, &work[j3 - 
...
#line 461 "ssytrf_aa.f"
		}

/*              Recover T( J+1, J ) */

#line 465 "ssytrf_aa.f"
		a[j + 1 + j * a_dim1] = alpha;
#line 466 "ssytrf_aa.f"
	    }

/*           WORK(J+1, 1) stores H(J+1, 1) */

#line 470 "ssytrf_aa.f"
	    i__1 = *n - j;
#line 470 "ssytrf_aa.f"
	    scopy_(&i__1, &a[j + 1 + (j + 1) * a_dim1], &c__1, &work[1], &
		    c__1);
#line 471 "ssytrf_aa.f"
	}
#line 472 "ssytrf_aa.f"
	goto L11;
#line 473 "ssytrf_aa.f"
    }

#line 475 "ssytrf_aa.f"
L20:
#line 476 "ssytrf_aa.f"
    return 0;
