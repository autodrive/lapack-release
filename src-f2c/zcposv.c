...
/* Subroutine */ int zcposv_(char *uplo, integer *n, integer *nrhs, 
	...
	swork, doublereal *rwork, integer *iter, integer *info, ftnlen 
	uplo_len)
{
    ...
    extern /* Subroutine */ int zhemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *, doublecomplex *, integer *, doublecomplex *, integer *,
	     integer *), clag2z_(integer *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, integer *), zlat2c_(char *,
	     integer *, doublecomplex *, integer *, doublecomplex *, integer *
	    , integer *, ftnlen);
    ...
    extern /* Subroutine */ int cpotrf_(char *, integer *, doublecomplex *, 
	    integer *, integer *, ftnlen), zlacpy_(char *, integer *, integer 
	    *, doublecomplex *, integer *, doublecomplex *, integer *, ftnlen)
	    , cpotrs_(char *, integer *, integer *, doublecomplex *, integer *
	    , doublecomplex *, integer *, integer *, ftnlen), zpotrf_(char *, 
