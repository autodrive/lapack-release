	...
	joba_len, ftnlen jobu_len, ftnlen jobv_len)
{
    ...
    static doublereal aapp0, aapq1, temp1, large, apoaq, aqoap;
...
#line 670 "zgesvj.f"
    if (temp1 != 1.) {
#line 671 "zgesvj.f"
	zlascl_("G", &c__0, &c__0, &c_b40, &temp1, n, &c__1, &sva[1], n, &
		ierr, (ftnlen)1);
#line 672 "zgesvj.f"
    }
#line 673 "zgesvj.f"
...
#line 674 "zgesvj.f"
    if (skl != 1.) {
#line 675 "zgesvj.f"
	zlascl_(joba, &c__0, &c__0, &c_b40, &skl, m, n, &a[a_offset], lda, &
		ierr, (ftnlen)1);
#line 676 "zgesvj.f"
	skl = 1. / skl;
#line 677 "zgesvj.f"
...
#line 1375 "zgesvj.f"
	    d__1 = 1. / sva[p];
#line 1375 "zgesvj.f"
	    zdscal_(m, &d__1, &a[p * a_dim1 + 1], &c__1);
#line 1376 "zgesvj.f"
/* L1998: */
#line 1376 "zgesvj.f"
	}
