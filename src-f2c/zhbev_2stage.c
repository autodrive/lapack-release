...
#line 286 "zhbev_2stage.f"
	    lwtrd = ilaenv_(&c__20, "ZHETRD_HB2ST", jobz, n, kd, &ib, &c_n1, (
		    ftnlen)12, (ftnlen)1);
#line 287 "zhbev_2stage.f"
	    lwmin = lhtrd + lwtrd;
#line 288 "zhbev_2stage.f"
	    work[1].r = (doublereal) lwmin, work[1].i = 0.;
#line 289 "zhbev_2stage.f"
	}
...
#line 293 "zhbev_2stage.f"
    }

#line 295 "zhbev_2stage.f"
    if (*info != 0) {
#line 296 "zhbev_2stage.f"
	i__1 = -(*info);
#line 296 "zhbev_2stage.f"
	xerbla_("ZHBEV_2STAGE ", &i__1, (ftnlen)13);
#line 297 "zhbev_2stage.f"
	return 0;
...
#line 307 "zhbev_2stage.f"
    if (*n == 1) {
#line 308 "zhbev_2stage.f"
	if (lower) {
#line 309 "zhbev_2stage.f"
	    i__1 = ab_dim1 + 1;
#line 309 "zhbev_2stage.f"
	    w[1] = ab[i__1].r;
...
#line 320 "zhbev_2stage.f"
    safmin = dlamch_("Safe minimum", (ftnlen)12);
#line 321 "zhbev_2stage.f"
    eps = dlamch_("Precision", (ftnlen)9);
#line 322 "zhbev_2stage.f"
    smlnum = safmin / eps;
...
#line 329 "zhbev_2stage.f"
    anrm = zlanhb_("M", uplo, n, kd, &ab[ab_offset], ldab, &rwork[1], (ftnlen)
	    1, (ftnlen)1);
#line 330 "zhbev_2stage.f"
    iscale = 0;
#line 331 "zhbev_2stage.f"
    if (anrm > 0. && anrm < rmin) {
...
#line 348 "zhbev_2stage.f"
    inde = 1;
#line 349 "zhbev_2stage.f"
    indhous = 1;
#line 350 "zhbev_2stage.f"
...
#line 359 "zhbev_2stage.f"
    if (! wantz) {
#line 360 "zhbev_2stage.f"
	dsterf_(n, &w[1], &rwork[inde], info);
#line 361 "zhbev_2stage.f"
    } else {
...
#line 369 "zhbev_2stage.f"
    if (iscale == 1) {
#line 370 "zhbev_2stage.f"
	if (*info == 0) {
#line 371 "zhbev_2stage.f"
	    imax = *n;
...
#line 380 "zhbev_2stage.f"
    work[1].r = (doublereal) lwmin, work[1].i = 0.;

#line 382 "zhbev_2stage.f"
    return 0;
