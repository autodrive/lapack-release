...
#line 181 "zhetrf_aa.f"
    *info = 0;
#line 182 "zhetrf_aa.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 183 "zhetrf_aa.f"
    lquery = *lwork == -1;
#line 184 "zhetrf_aa.f"
...
#line 208 "zhetrf_aa.f"
    if (*n == 0) {
#line 209 "zhetrf_aa.f"
	return 0;
#line 210 "zhetrf_aa.f"
    }
#line 211 "zhetrf_aa.f"
    ipiv[1] = 1;
...
#line 237 "zhetrf_aa.f"
	j = 0;
#line 238 "zhetrf_aa.f"
L10:
#line 239 "zhetrf_aa.f"
	if (j >= *n) {
#line 239 "zhetrf_aa.f"
	    goto L20;
#line 239 "zhetrf_aa.f"
...
#line 249 "zhetrf_aa.f"
	j1 = j + 1;
/* Computing MIN */
#line 250 "zhetrf_aa.f"
	i__1 = *n - j1 + 1;
#line 250 "zhetrf_aa.f"
	jb = min(i__1,nb);
#line 251 "zhetrf_aa.f"
	k1 = max(1,j) - j;

/*        Panel factorization */

#line 255 "zhetrf_aa.f"
	i__1 = 2 - k1;
#line 255 "zhetrf_aa.f"
	i__2 = *n - j;
#line 255 "zhetrf_aa.f"
...
#line 262 "zhetrf_aa.f"
	    ipiv[j2] += j;
#line 263 "zhetrf_aa.f"
	    if (j2 != ipiv[j2] && j1 - k1 > 2) {
#line 264 "zhetrf_aa.f"
		i__2 = j1 - k1 - 2;
#line 264 "zhetrf_aa.f"
...
#line 282 "zhetrf_aa.f"
		d_cnjg(&z__1, &a[j + (j + 1) * a_dim1]);
#line 282 "zhetrf_aa.f"
		alpha.r = z__1.r, alpha.i = z__1.i;
#line 283 "zhetrf_aa.f"
		i__1 = j + (j + 1) * a_dim1;
#line 283 "zhetrf_aa.f"
		a[i__1].r = 1., a[i__1].i = 0.;
#line 284 "zhetrf_aa.f"
		i__1 = *n - j;
#line 284 "zhetrf_aa.f"
		zcopy_(&i__1, &a[j - 1 + (j + 1) * a_dim1], lda, &work[j + 1 
			- j1 + 1 + jb * *n], &c__1);
#line 286 "zhetrf_aa.f"
		i__1 = *n - j;
#line 286 "zhetrf_aa.f"
...
#line 292 "zhetrf_aa.f"
		if (j1 > 1) {

/*                 Not first panel */

#line 296 "zhetrf_aa.f"
		    k2 = 1;
...
#line 301 "zhetrf_aa.f"
		    k2 = 0;

/*                 First update skips the first column */

#line 305 "zhetrf_aa.f"
		    --jb;
#line 306 "zhetrf_aa.f"
		}
...
#line 313 "zhetrf_aa.f"
		    j3 = j2;
#line 314 "zhetrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
#line 315 "zhetrf_aa.f"
			i__3 = jb + 1;
#line 315 "zhetrf_aa.f"
			z__1.r = -1., z__1.i = -0.;
#line 315 "zhetrf_aa.f"
...
#line 330 "zhetrf_aa.f"
		}

/*              Recover T( J, J+1 ) */

#line 334 "zhetrf_aa.f"
		i__2 = j + (j + 1) * a_dim1;
#line 334 "zhetrf_aa.f"
		d_cnjg(&z__1, &alpha);
#line 334 "zhetrf_aa.f"
		a[i__2].r = z__1.r, a[i__2].i = z__1.i;
#line 335 "zhetrf_aa.f"
	    }

/*           WORK(J+1, 1) stores H(J+1, 1) */

#line 339 "zhetrf_aa.f"
	    i__2 = *n - j;
#line 339 "zhetrf_aa.f"
	    zcopy_(&i__2, &a[j + 1 + (j + 1) * a_dim1], lda, &work[1], &c__1);
#line 340 "zhetrf_aa.f"
	}
#line 341 "zhetrf_aa.f"
	goto L10;
#line 342 "zhetrf_aa.f"
    } else {
...
#line 357 "zhetrf_aa.f"
	j = 0;
#line 358 "zhetrf_aa.f"
L11:
#line 359 "zhetrf_aa.f"
	if (j >= *n) {
#line 359 "zhetrf_aa.f"
	    goto L20;
#line 359 "zhetrf_aa.f"
...
#line 370 "zhetrf_aa.f"
	jb = min(i__2,nb);
#line 371 "zhetrf_aa.f"
	k1 = max(1,j) - j;

/*        Panel factorization */

#line 375 "zhetrf_aa.f"
	i__2 = 2 - k1;
#line 375 "zhetrf_aa.f"
	i__1 = *n - j;
#line 375 "zhetrf_aa.f"
...
#line 382 "zhetrf_aa.f"
	    ipiv[j2] += j;
#line 383 "zhetrf_aa.f"
	    if (j2 != ipiv[j2] && j1 - k1 > 2) {
#line 384 "zhetrf_aa.f"
		i__1 = j1 - k1 - 2;
#line 384 "zhetrf_aa.f"
...
#line 387 "zhetrf_aa.f"
	}
#line 388 "zhetrf_aa.f"
	j += jb;
...
#line 402 "zhetrf_aa.f"
		alpha.r = z__1.r, alpha.i = z__1.i;
#line 403 "zhetrf_aa.f"
		i__2 = j + 1 + j * a_dim1;
#line 403 "zhetrf_aa.f"
		a[i__2].r = 1., a[i__2].i = 0.;
#line 404 "zhetrf_aa.f"
		i__2 = *n - j;
#line 404 "zhetrf_aa.f"
		zcopy_(&i__2, &a[j + 1 + (j - 1) * a_dim1], &c__1, &work[j + 
			1 - j1 + 1 + jb * *n], &c__1);
#line 406 "zhetrf_aa.f"
		i__2 = *n - j;
#line 406 "zhetrf_aa.f"
...
#line 421 "zhetrf_aa.f"
		    k2 = 0;

/*                 First update skips the first column */

#line 425 "zhetrf_aa.f"
		    --jb;
#line 426 "zhetrf_aa.f"
		}

#line 428 "zhetrf_aa.f"
		i__2 = *n;
#line 428 "zhetrf_aa.f"
		i__1 = nb;
#line 428 "zhetrf_aa.f"
...
#line 433 "zhetrf_aa.f"
		    j3 = j2;
#line 434 "zhetrf_aa.f"
		    for (mj = nj - 1; mj >= 1; --mj) {
...
#line 459 "zhetrf_aa.f"
	    zcopy_(&i__1, &a[j + 1 + (j + 1) * a_dim1], &c__1, &work[1], &
		    c__1);
#line 460 "zhetrf_aa.f"
	}
#line 461 "zhetrf_aa.f"
	goto L11;
#line 462 "zhetrf_aa.f"
    }

#line 464 "zhetrf_aa.f"
L20:
#line 465 "zhetrf_aa.f"
    return 0;
