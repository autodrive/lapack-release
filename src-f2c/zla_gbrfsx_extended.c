...
#line 491 "zla_gbrfsx_extended.f"
...
#line 492 "zla_gbrfsx_extended.f"
    chla_transtype__(ch__1, (ftnlen)1, trans_type__);
#line 492 "zla_gbrfsx_extended.f"
    *(unsigned char *)trans = *(unsigned char *)&ch__1[0];
#line 493 "zla_gbrfsx_extended.f"
    eps = dlamch_("Epsilon", (ftnlen)7);
#line 494 "zla_gbrfsx_extended.f"
    hugeval = dlamch_("Overflow", (ftnlen)8);
/*     Force HUGEVAL to Inf */
#line 496 "zla_gbrfsx_extended.f"
    hugeval *= hugeval;
/*     Using HUGEVAL may lead to spurious underflows. */
#line 498 "zla_gbrfsx_extended.f"
    incr_thresh__ = (doublereal) (*n) * eps;
#line 499 "zla_gbrfsx_extended.f"
    m = *kl + *ku + 1;
#line 501 "zla_gbrfsx_extended.f"
    i__1 = *nrhs;
#line 501 "zla_gbrfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 502 "zla_gbrfsx_extended.f"
	y_prec_state__ = 1;
#line 503 "zla_gbrfsx_extended.f"
	if (y_prec_state__ == 2) {
#line 504 "zla_gbrfsx_extended.f"
	    i__2 = *n;
#line 504 "zla_gbrfsx_extended.f"
	    for (i__ = 1; i__ <= i__2; ++i__) {
#line 505 "zla_gbrfsx_extended.f"
		i__3 = i__;
#line 505 "zla_gbrfsx_extended.f"
		y_tail__[i__3].r = 0., y_tail__[i__3].i = 0.;
#line 506 "zla_gbrfsx_extended.f"
	    }
#line 507 "zla_gbrfsx_extended.f"
	}
#line 509 "zla_gbrfsx_extended.f"
	dxrat = 0.;
#line 510 "zla_gbrfsx_extended.f"
	dxratmax = 0.;
#line 511 "zla_gbrfsx_extended.f"
	dzrat = 0.;
#line 512 "zla_gbrfsx_extended.f"
	dzratmax = 0.;
#line 513 "zla_gbrfsx_extended.f"
	final_dx_x__ = hugeval;
#line 514 "zla_gbrfsx_extended.f"
	final_dz_z__ = hugeval;
#line 515 "zla_gbrfsx_extended.f"
	prevnormdx = hugeval;
#line 516 "zla_gbrfsx_extended.f"
	prev_dz_z__ = hugeval;
#line 517 "zla_gbrfsx_extended.f"
	dz_z__ = hugeval;
#line 518 "zla_gbrfsx_extended.f"
	dx_x__ = hugeval;
#line 520 "zla_gbrfsx_extended.f"
	x_state__ = 1;
#line 521 "zla_gbrfsx_extended.f"
	z_state__ = 0;
#line 522 "zla_gbrfsx_extended.f"
	incr_prec__ = FALSE_;
#line 524 "zla_gbrfsx_extended.f"
	i__2 = *ithresh;
#line 524 "zla_gbrfsx_extended.f"
...
#line 529 "zla_gbrfsx_extended.f"
	    zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 530 "zla_gbrfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 531 "zla_gbrfsx_extended.f"
		zgbmv_(trans, &m, n, kl, ku, &c_b6, &ab[ab_offset], ldab, &y[
			j * y_dim1 + 1], &c__1, &c_b8, &res[1], &c__1, (
			ftnlen)1);
#line 533 "zla_gbrfsx_extended.f"
	    } else if (y_prec_state__ == 1) {
#line 534 "zla_gbrfsx_extended.f"
		blas_zgbmv_x__(trans_type__, n, n, kl, ku, &c_b6, &ab[
			ab_offset], ldab, &y[j * y_dim1 + 1], &c__1, &c_b8, &
			res[1], &c__1, prec_type__);
#line 537 "zla_gbrfsx_extended.f"
	    } else {
#line 538 "zla_gbrfsx_extended.f"
		blas_zgbmv2_x__(trans_type__, n, n, kl, ku, &c_b6, &ab[
			ab_offset], ldab, &y[j * y_dim1 + 1], &y_tail__[1], &
			c__1, &c_b8, &res[1], &c__1, prec_type__);
#line 541 "zla_gbrfsx_extended.f"
	    }
/*        XXX: RES is no longer needed. */
#line 544 "zla_gbrfsx_extended.f"
	    zcopy_(n, &res[1], &c__1, &dy[1], &c__1);
#line 545 "zla_gbrfsx_extended.f"
	    zgbtrs_(trans, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &ipiv[1]
		    , &dy[1], n, info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 550 "zla_gbrfsx_extended.f"
	    normx = 0.;
#line 551 "zla_gbrfsx_extended.f"
	    normy = 0.;
#line 552 "zla_gbrfsx_extended.f"
	    normdx = 0.;
#line 553 "zla_gbrfsx_extended.f"
	    dz_z__ = 0.;
#line 554 "zla_gbrfsx_extended.f"
	    ymin = hugeval;
#line 556 "zla_gbrfsx_extended.f"
	    i__3 = *n;
#line 556 "zla_gbrfsx_extended.f"
	    for (i__ = 1; i__ <= i__3; ++i__) {
#line 557 "zla_gbrfsx_extended.f"
		i__4 = i__ + j * y_dim1;
#line 557 "zla_gbrfsx_extended.f"
		yk = (d__1 = y[i__4].r, abs(d__1)) + (d__2 = d_imag(&y[i__ + 
			j * y_dim1]), abs(d__2));
#line 558 "zla_gbrfsx_extended.f"
		i__4 = i__;
#line 558 "zla_gbrfsx_extended.f"
		dyk = (d__1 = dy[i__4].r, abs(d__1)) + (d__2 = d_imag(&dy[i__]
			), abs(d__2));
#line 560 "zla_gbrfsx_extended.f"
		if (yk != 0.) {
/* Computing MAX */
#line 561 "zla_gbrfsx_extended.f"
		    d__1 = dz_z__, d__2 = dyk / yk;
#line 561 "zla_gbrfsx_extended.f"
		    dz_z__ = max(d__1,d__2);
#line 562 "zla_gbrfsx_extended.f"
		} else if (dyk != 0.) {
#line 563 "zla_gbrfsx_extended.f"
		    dz_z__ = hugeval;
#line 564 "zla_gbrfsx_extended.f"
		}
#line 566 "zla_gbrfsx_extended.f"
		ymin = min(ymin,yk);
#line 568 "zla_gbrfsx_extended.f"
		normy = max(normy,yk);
#line 570 "zla_gbrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
#line 571 "zla_gbrfsx_extended.f"
		    d__1 = normx, d__2 = yk * c__[i__];
#line 571 "zla_gbrfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 572 "zla_gbrfsx_extended.f"
		    d__1 = normdx, d__2 = dyk * c__[i__];
#line 572 "zla_gbrfsx_extended.f"
		    normdx = max(d__1,d__2);
#line 573 "zla_gbrfsx_extended.f"
		} else {
#line 574 "zla_gbrfsx_extended.f"
		    normx = normy;
#line 575 "zla_gbrfsx_extended.f"
		    normdx = max(normdx,dyk);
#line 576 "zla_gbrfsx_extended.f"
		}
#line 577 "zla_gbrfsx_extended.f"
	    }
#line 579 "zla_gbrfsx_extended.f"
	    if (normx != 0.) {
#line 580 "zla_gbrfsx_extended.f"
		dx_x__ = normdx / normx;
#line 581 "zla_gbrfsx_extended.f"
	    } else if (normdx == 0.) {
#line 582 "zla_gbrfsx_extended.f"
		dx_x__ = 0.;
#line 583 "zla_gbrfsx_extended.f"
	    } else {
#line 584 "zla_gbrfsx_extended.f"
		dx_x__ = hugeval;
#line 585 "zla_gbrfsx_extended.f"
	    }
#line 587 "zla_gbrfsx_extended.f"
	    dxrat = normdx / prevnormdx;
#line 588 "zla_gbrfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria. */

#line 592 "zla_gbrfsx_extended.f"
...
#line 597 "zla_gbrfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 597 "zla_gbrfsx_extended.f"
		x_state__ = 1;
#line 597 "zla_gbrfsx_extended.f"
	    }
#line 599 "zla_gbrfsx_extended.f"
	    if (x_state__ == 1) {
#line 600 "zla_gbrfsx_extended.f"
		if (dx_x__ <= eps) {
#line 601 "zla_gbrfsx_extended.f"
		    x_state__ = 2;
#line 602 "zla_gbrfsx_extended.f"
		} else if (dxrat > *rthresh) {
#line 603 "zla_gbrfsx_extended.f"
		    if (y_prec_state__ != 2) {
#line 604 "zla_gbrfsx_extended.f"
			incr_prec__ = TRUE_;
#line 605 "zla_gbrfsx_extended.f"
		    } else {
#line 606 "zla_gbrfsx_extended.f"
			x_state__ = 3;
#line 607 "zla_gbrfsx_extended.f"
		    }
#line 608 "zla_gbrfsx_extended.f"
		} else {
#line 609 "zla_gbrfsx_extended.f"
		    if (dxrat > dxratmax) {
#line 609 "zla_gbrfsx_extended.f"
			dxratmax = dxrat;
#line 609 "zla_gbrfsx_extended.f"
		    }
#line 610 "zla_gbrfsx_extended.f"
		}
#line 611 "zla_gbrfsx_extended.f"
		if (x_state__ > 1) {
#line 611 "zla_gbrfsx_extended.f"
		    final_dx_x__ = dx_x__;
#line 611 "zla_gbrfsx_extended.f"
		}
#line 612 "zla_gbrfsx_extended.f"
	    }
#line 614 "zla_gbrfsx_extended.f"
	    if (z_state__ == 0 && dz_z__ <= *dz_ub__) {
#line 614 "zla_gbrfsx_extended.f"
		z_state__ = 1;
#line 614 "zla_gbrfsx_extended.f"
	    }
#line 616 "zla_gbrfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 616 "zla_gbrfsx_extended.f"
		z_state__ = 1;
#line 616 "zla_gbrfsx_extended.f"
	    }
#line 618 "zla_gbrfsx_extended.f"
	    if (z_state__ == 1) {
#line 619 "zla_gbrfsx_extended.f"
		if (dz_z__ <= eps) {
#line 620 "zla_gbrfsx_extended.f"
		    z_state__ = 2;
#line 621 "zla_gbrfsx_extended.f"
		} else if (dz_z__ > *dz_ub__) {
#line 622 "zla_gbrfsx_extended.f"
		    z_state__ = 0;
#line 623 "zla_gbrfsx_extended.f"
		    dzratmax = 0.;
#line 624 "zla_gbrfsx_extended.f"
		    final_dz_z__ = hugeval;
#line 625 "zla_gbrfsx_extended.f"
		} else if (dzrat > *rthresh) {
#line 626 "zla_gbrfsx_extended.f"
		    if (y_prec_state__ != 2) {
#line 627 "zla_gbrfsx_extended.f"
			incr_prec__ = TRUE_;
#line 628 "zla_gbrfsx_extended.f"
		    } else {
#line 629 "zla_gbrfsx_extended.f"
			z_state__ = 3;
#line 630 "zla_gbrfsx_extended.f"
		    }
#line 631 "zla_gbrfsx_extended.f"
		} else {
#line 632 "zla_gbrfsx_extended.f"
		    if (dzrat > dzratmax) {
#line 632 "zla_gbrfsx_extended.f"
			dzratmax = dzrat;
#line 632 "zla_gbrfsx_extended.f"
		    }
#line 633 "zla_gbrfsx_extended.f"
		}
#line 634 "zla_gbrfsx_extended.f"
		if (z_state__ > 1) {
#line 634 "zla_gbrfsx_extended.f"
		    final_dz_z__ = dz_z__;
#line 634 "zla_gbrfsx_extended.f"
		}
#line 635 "zla_gbrfsx_extended.f"
	    }
...
#line 641 "zla_gbrfsx_extended.f"
	    if (x_state__ != 1) {
#line 642 "zla_gbrfsx_extended.f"
		if (*ignore_cwise__) {
#line 642 "zla_gbrfsx_extended.f"
		    goto L666;
#line 642 "zla_gbrfsx_extended.f"
		}
#line 643 "zla_gbrfsx_extended.f"
		if (z_state__ == 3 || z_state__ == 2) {
#line 643 "zla_gbrfsx_extended.f"
		    goto L666;
#line 643 "zla_gbrfsx_extended.f"
		}
#line 645 "zla_gbrfsx_extended.f"
		if (z_state__ == 0 && cnt > 1) {
#line 645 "zla_gbrfsx_extended.f"
		    goto L666;
#line 645 "zla_gbrfsx_extended.f"
		}
#line 646 "zla_gbrfsx_extended.f"
	    }
#line 648 "zla_gbrfsx_extended.f"
	    if (incr_prec__) {
#line 649 "zla_gbrfsx_extended.f"
		incr_prec__ = FALSE_;
#line 650 "zla_gbrfsx_extended.f"
		++y_prec_state__;
#line 651 "zla_gbrfsx_extended.f"
		i__3 = *n;
#line 651 "zla_gbrfsx_extended.f"
		for (i__ = 1; i__ <= i__3; ++i__) {
#line 652 "zla_gbrfsx_extended.f"
		    i__4 = i__;
#line 652 "zla_gbrfsx_extended.f"
		    y_tail__[i__4].r = 0., y_tail__[i__4].i = 0.;
#line 653 "zla_gbrfsx_extended.f"
		}
#line 654 "zla_gbrfsx_extended.f"
	    }
#line 656 "zla_gbrfsx_extended.f"
	    prevnormdx = normdx;
#line 657 "zla_gbrfsx_extended.f"
	    prev_dz_z__ = dz_z__;

/*           Update soluton. */

#line 661 "zla_gbrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 662 "zla_gbrfsx_extended.f"
		zaxpy_(n, &c_b8, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 663 "zla_gbrfsx_extended.f"
	    } else {
#line 664 "zla_gbrfsx_extended.f"
		zla_wwaddw__(n, &y[j * y_dim1 + 1], &y_tail__[1], &dy[1]);
#line 665 "zla_gbrfsx_extended.f"
	    }
#line 667 "zla_gbrfsx_extended.f"
	}
/*        Target of "IF (Z_STOP .AND. X_STOP)".  Sun's f77 won't EXIT. */
#line 669 "zla_gbrfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 673 "zla_gbrfsx_extended.f"
	if (x_state__ == 1) {
#line 673 "zla_gbrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 673 "zla_gbrfsx_extended.f"
	}
#line 674 "zla_gbrfsx_extended.f"
	if (z_state__ == 1) {
#line 674 "zla_gbrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 674 "zla_gbrfsx_extended.f"
...
#line 678 "zla_gbrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 679 "zla_gbrfsx_extended.f"
	    err_bnds_norm__[j + (err_bnds_norm_dim1 << 1)] = final_dx_x__ / (
		    1 - dxratmax);
#line 681 "zla_gbrfsx_extended.f"
	}
#line 682 "zla_gbrfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 683 "zla_gbrfsx_extended.f"
	    err_bnds_comp__[j + (err_bnds_comp_dim1 << 1)] = final_dz_z__ / (
		    1 - dzratmax);
#line 685 "zla_gbrfsx_extended.f"
	}
