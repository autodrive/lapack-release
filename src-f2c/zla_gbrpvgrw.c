...
#line 150 "zla_gbrpvgrw.f"
    rpvgrw = 1.;
#line 152 "zla_gbrpvgrw.f"
    kd = *ku + 1;
#line 153 "zla_gbrpvgrw.f"
    i__1 = *ncols;
#line 153 "zla_gbrpvgrw.f"
    for (j = 1; j <= i__1; ++j) {
#line 154 "zla_gbrpvgrw.f"
	amax = 0.;
#line 155 "zla_gbrpvgrw.f"
	umax = 0.;
/* Computing MAX */
#line 156 "zla_gbrpvgrw.f"
	i__2 = j - *ku;
/* Computing MIN */
#line 156 "zla_gbrpvgrw.f"
	i__4 = j + *kl;
...
#line 157 "zla_gbrpvgrw.f"
	    amax = max(d__3,amax);
#line 158 "zla_gbrpvgrw.f"
	}
/* Computing MAX */
#line 159 "zla_gbrpvgrw.f"
	i__3 = j - *ku;
#line 159 "zla_gbrpvgrw.f"
	i__2 = j;
#line 159 "zla_gbrpvgrw.f"
...
#line 160 "zla_gbrpvgrw.f"
	    umax = max(d__3,umax);
#line 161 "zla_gbrpvgrw.f"
	}
#line 162 "zla_gbrpvgrw.f"
	if (umax != 0.) {
/* Computing MIN */
#line 163 "zla_gbrpvgrw.f"
	    d__1 = amax / umax;
#line 163 "zla_gbrpvgrw.f"
	    rpvgrw = min(d__1,rpvgrw);
#line 164 "zla_gbrpvgrw.f"
	}
#line 165 "zla_gbrpvgrw.f"
    }
#line 166 "zla_gbrpvgrw.f"
    ret_val = rpvgrw;
#line 167 "zla_gbrpvgrw.f"
    return ret_val;
} /* zla_gbrpvgrw__ */
