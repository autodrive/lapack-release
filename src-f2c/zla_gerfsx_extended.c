...
#line 476 "zla_gerfsx_extended.f"
...
#line 477 "zla_gerfsx_extended.f"
...
#line 485 "zla_gerfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 486 "zla_gerfsx_extended.f"
	y_prec_state__ = 1;
...
#line 493 "zla_gerfsx_extended.f"
	dxrat = 0.;
#line 494 "zla_gerfsx_extended.f"
	dxratmax = 0.;
...
#line 504 "zla_gerfsx_extended.f"
	x_state__ = 1;
#line 505 "zla_gerfsx_extended.f"
	z_state__ = 0;
...
#line 513 "zla_gerfsx_extended.f"
	    zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 514 "zla_gerfsx_extended.f"
	    if (y_prec_state__ == 0) {
...
#line 540 "zla_gerfsx_extended.f"
		i__4 = i__ + j * y_dim1;
#line 540 "zla_gerfsx_extended.f"
...
#line 543 "zla_gerfsx_extended.f"
		if (yk != 0.) {
/* Computing MAX */
#line 544 "zla_gerfsx_extended.f"
...
#line 553 "zla_gerfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
#line 554 "zla_gerfsx_extended.f"
...
#line 562 "zla_gerfsx_extended.f"
	    if (normx != 0.) {
#line 563 "zla_gerfsx_extended.f"
		dx_x__ = normdx / normx;
...
#line 571 "zla_gerfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria */

#line 575 "zla_gerfsx_extended.f"
...
#line 580 "zla_gerfsx_extended.f"
...
#line 582 "zla_gerfsx_extended.f"
	    if (x_state__ == 1) {
#line 583 "zla_gerfsx_extended.f"
		if (dx_x__ <= eps) {
...
#line 601 "zla_gerfsx_extended.f"
	    if (z_state__ == 1) {
#line 602 "zla_gerfsx_extended.f"
		if (dz_z__ <= eps) {
...
#line 624 "zla_gerfsx_extended.f"
	    if (x_state__ != 1) {
#line 625 "zla_gerfsx_extended.f"
		if (*ignore_cwise__) {
#line 625 "zla_gerfsx_extended.f"
		    goto L666;
#line 625 "zla_gerfsx_extended.f"
...
#line 629 "zla_gerfsx_extended.f"
	    }
#line 631 "zla_gerfsx_extended.f"
	    if (incr_prec__) {
#line 632 "zla_gerfsx_extended.f"
		incr_prec__ = FALSE_;
...
#line 639 "zla_gerfsx_extended.f"
	    prevnormdx = normdx;
#line 640 "zla_gerfsx_extended.f"
	    prev_dz_z__ = dz_z__;

/*           Update soluton. */

#line 644 "zla_gerfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 645 "zla_gerfsx_extended.f"
...
#line 656 "zla_gerfsx_extended.f"
	if (x_state__ == 1) {
#line 656 "zla_gerfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 656 "zla_gerfsx_extended.f"
	}
#line 657 "zla_gerfsx_extended.f"
	if (z_state__ == 1) {
#line 657 "zla_gerfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 657 "zla_gerfsx_extended.f"
...
#line 661 "zla_gerfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 662 "zla_gerfsx_extended.f"
	    errs_n__[j + (errs_n_dim1 << 1)] = final_dx_x__ / (1 - dxratmax);
#line 664 "zla_gerfsx_extended.f"
	}
#line 665 "zla_gerfsx_extended.f"
	if (*n_norms__ >= 2) {
...
#line 677 "zla_gerfsx_extended.f"
	zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 678 "zla_gerfsx_extended.f"
	zgemv_(trans, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 1], &
		c__1, &c_b8, &res[1], &c__1, (ftnlen)1);
#line 681 "zla_gerfsx_extended.f"
	i__2 = *n;
#line 681 "zla_gerfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 682 "zla_gerfsx_extended.f"
	    i__3 = i__ + j * b_dim1;
#line 682 "zla_gerfsx_extended.f"
