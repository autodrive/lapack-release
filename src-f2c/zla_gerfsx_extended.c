...
#line 478 "zla_gerfsx_extended.f"
...
#line 479 "zla_gerfsx_extended.f"
    chla_transtype__(ch__1, (ftnlen)1, trans_type__);
#line 479 "zla_gerfsx_extended.f"
    *(unsigned char *)trans = *(unsigned char *)&ch__1[0];
#line 480 "zla_gerfsx_extended.f"
    eps = dlamch_("Epsilon", (ftnlen)7);
#line 481 "zla_gerfsx_extended.f"
    hugeval = dlamch_("Overflow", (ftnlen)8);
/*     Force HUGEVAL to Inf */
#line 483 "zla_gerfsx_extended.f"
    hugeval *= hugeval;
/*     Using HUGEVAL may lead to spurious underflows. */
#line 485 "zla_gerfsx_extended.f"
    incr_thresh__ = (doublereal) (*n) * eps;

#line 487 "zla_gerfsx_extended.f"
    i__1 = *nrhs;
#line 487 "zla_gerfsx_extended.f"
    for (j = 1; j <= i__1; ++j) {
#line 488 "zla_gerfsx_extended.f"
	y_prec_state__ = 1;
#line 489 "zla_gerfsx_extended.f"
	if (y_prec_state__ == 2) {
#line 490 "zla_gerfsx_extended.f"
	    i__2 = *n;
#line 490 "zla_gerfsx_extended.f"
	    for (i__ = 1; i__ <= i__2; ++i__) {
#line 491 "zla_gerfsx_extended.f"
		i__3 = i__;
#line 491 "zla_gerfsx_extended.f"
		y_tail__[i__3].r = 0., y_tail__[i__3].i = 0.;
#line 492 "zla_gerfsx_extended.f"
	    }
#line 493 "zla_gerfsx_extended.f"
	}
#line 495 "zla_gerfsx_extended.f"
	dxrat = 0.;
#line 496 "zla_gerfsx_extended.f"
	dxratmax = 0.;
#line 497 "zla_gerfsx_extended.f"
	dzrat = 0.;
#line 498 "zla_gerfsx_extended.f"
	dzratmax = 0.;
#line 499 "zla_gerfsx_extended.f"
	final_dx_x__ = hugeval;
#line 500 "zla_gerfsx_extended.f"
	final_dz_z__ = hugeval;
#line 501 "zla_gerfsx_extended.f"
	prevnormdx = hugeval;
#line 502 "zla_gerfsx_extended.f"
	prev_dz_z__ = hugeval;
#line 503 "zla_gerfsx_extended.f"
	dz_z__ = hugeval;
#line 504 "zla_gerfsx_extended.f"
	dx_x__ = hugeval;
#line 506 "zla_gerfsx_extended.f"
	x_state__ = 1;
#line 507 "zla_gerfsx_extended.f"
	z_state__ = 0;
#line 508 "zla_gerfsx_extended.f"
	incr_prec__ = FALSE_;
#line 510 "zla_gerfsx_extended.f"
	i__2 = *ithresh;
#line 510 "zla_gerfsx_extended.f"
...
#line 515 "zla_gerfsx_extended.f"
	    zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 516 "zla_gerfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 517 "zla_gerfsx_extended.f"
		zgemv_(trans, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 
			1], &c__1, &c_b8, &res[1], &c__1, (ftnlen)1);
#line 519 "zla_gerfsx_extended.f"
	    } else if (y_prec_state__ == 1) {
#line 520 "zla_gerfsx_extended.f"
		blas_zgemv_x__(trans_type__, n, n, &c_b6, &a[a_offset], lda, &
			y[j * y_dim1 + 1], &c__1, &c_b8, &res[1], &c__1, 
			prec_type__);
#line 523 "zla_gerfsx_extended.f"
	    } else {
#line 524 "zla_gerfsx_extended.f"
		blas_zgemv2_x__(trans_type__, n, n, &c_b6, &a[a_offset], lda, 
			&y[j * y_dim1 + 1], &y_tail__[1], &c__1, &c_b8, &res[
			1], &c__1, prec_type__);
#line 527 "zla_gerfsx_extended.f"
	    }
/*         XXX: RES is no longer needed. */
#line 530 "zla_gerfsx_extended.f"
	    zcopy_(n, &res[1], &c__1, &dy[1], &c__1);
#line 531 "zla_gerfsx_extended.f"
	    zgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &dy[1], 
		    n, info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 535 "zla_gerfsx_extended.f"
	    normx = 0.;
#line 536 "zla_gerfsx_extended.f"
	    normy = 0.;
#line 537 "zla_gerfsx_extended.f"
	    normdx = 0.;
#line 538 "zla_gerfsx_extended.f"
	    dz_z__ = 0.;
#line 539 "zla_gerfsx_extended.f"
	    ymin = hugeval;

#line 541 "zla_gerfsx_extended.f"
	    i__3 = *n;
#line 541 "zla_gerfsx_extended.f"
	    for (i__ = 1; i__ <= i__3; ++i__) {
#line 542 "zla_gerfsx_extended.f"
		i__4 = i__ + j * y_dim1;
#line 542 "zla_gerfsx_extended.f"
		yk = (d__1 = y[i__4].r, abs(d__1)) + (d__2 = d_imag(&y[i__ + 
			j * y_dim1]), abs(d__2));
#line 543 "zla_gerfsx_extended.f"
		i__4 = i__;
#line 543 "zla_gerfsx_extended.f"
		dyk = (d__1 = dy[i__4].r, abs(d__1)) + (d__2 = d_imag(&dy[i__]
			), abs(d__2));
#line 545 "zla_gerfsx_extended.f"
		if (yk != 0.) {
/* Computing MAX */
#line 546 "zla_gerfsx_extended.f"
		    d__1 = dz_z__, d__2 = dyk / yk;
#line 546 "zla_gerfsx_extended.f"
		    dz_z__ = max(d__1,d__2);
#line 547 "zla_gerfsx_extended.f"
		} else if (dyk != 0.) {
#line 548 "zla_gerfsx_extended.f"
		    dz_z__ = hugeval;
#line 549 "zla_gerfsx_extended.f"
		}
#line 551 "zla_gerfsx_extended.f"
		ymin = min(ymin,yk);
#line 553 "zla_gerfsx_extended.f"
		normy = max(normy,yk);
#line 555 "zla_gerfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
#line 556 "zla_gerfsx_extended.f"
		    d__1 = normx, d__2 = yk * c__[i__];
#line 556 "zla_gerfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 557 "zla_gerfsx_extended.f"
		    d__1 = normdx, d__2 = dyk * c__[i__];
#line 557 "zla_gerfsx_extended.f"
		    normdx = max(d__1,d__2);
#line 558 "zla_gerfsx_extended.f"
		} else {
#line 559 "zla_gerfsx_extended.f"
		    normx = normy;
#line 560 "zla_gerfsx_extended.f"
		    normdx = max(normdx,dyk);
#line 561 "zla_gerfsx_extended.f"
		}
#line 562 "zla_gerfsx_extended.f"
	    }
#line 564 "zla_gerfsx_extended.f"
	    if (normx != 0.) {
#line 565 "zla_gerfsx_extended.f"
		dx_x__ = normdx / normx;
#line 566 "zla_gerfsx_extended.f"
	    } else if (normdx == 0.) {
#line 567 "zla_gerfsx_extended.f"
		dx_x__ = 0.;
#line 568 "zla_gerfsx_extended.f"
	    } else {
#line 569 "zla_gerfsx_extended.f"
		dx_x__ = hugeval;
#line 570 "zla_gerfsx_extended.f"
	    }
#line 572 "zla_gerfsx_extended.f"
	    dxrat = normdx / prevnormdx;
#line 573 "zla_gerfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria */

#line 577 "zla_gerfsx_extended.f"
...
#line 582 "zla_gerfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 582 "zla_gerfsx_extended.f"
		x_state__ = 1;
#line 582 "zla_gerfsx_extended.f"
	    }
#line 584 "zla_gerfsx_extended.f"
	    if (x_state__ == 1) {
#line 585 "zla_gerfsx_extended.f"
		if (dx_x__ <= eps) {
#line 586 "zla_gerfsx_extended.f"
		    x_state__ = 2;
#line 587 "zla_gerfsx_extended.f"
		} else if (dxrat > *rthresh) {
#line 588 "zla_gerfsx_extended.f"
		    if (y_prec_state__ != 2) {
#line 589 "zla_gerfsx_extended.f"
			incr_prec__ = TRUE_;
#line 590 "zla_gerfsx_extended.f"
		    } else {
#line 591 "zla_gerfsx_extended.f"
			x_state__ = 3;
#line 592 "zla_gerfsx_extended.f"
		    }
#line 593 "zla_gerfsx_extended.f"
		} else {
#line 594 "zla_gerfsx_extended.f"
		    if (dxrat > dxratmax) {
#line 594 "zla_gerfsx_extended.f"
			dxratmax = dxrat;
#line 594 "zla_gerfsx_extended.f"
		    }
#line 595 "zla_gerfsx_extended.f"
		}
#line 596 "zla_gerfsx_extended.f"
		if (x_state__ > 1) {
#line 596 "zla_gerfsx_extended.f"
		    final_dx_x__ = dx_x__;
#line 596 "zla_gerfsx_extended.f"
		}
#line 597 "zla_gerfsx_extended.f"
	    }
#line 599 "zla_gerfsx_extended.f"
	    if (z_state__ == 0 && dz_z__ <= *dz_ub__) {
#line 599 "zla_gerfsx_extended.f"
		z_state__ = 1;
#line 599 "zla_gerfsx_extended.f"
	    }
#line 601 "zla_gerfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 601 "zla_gerfsx_extended.f"
		z_state__ = 1;
#line 601 "zla_gerfsx_extended.f"
	    }
#line 603 "zla_gerfsx_extended.f"
	    if (z_state__ == 1) {
#line 604 "zla_gerfsx_extended.f"
		if (dz_z__ <= eps) {
#line 605 "zla_gerfsx_extended.f"
		    z_state__ = 2;
#line 606 "zla_gerfsx_extended.f"
		} else if (dz_z__ > *dz_ub__) {
#line 607 "zla_gerfsx_extended.f"
		    z_state__ = 0;
#line 608 "zla_gerfsx_extended.f"
		    dzratmax = 0.;
#line 609 "zla_gerfsx_extended.f"
		    final_dz_z__ = hugeval;
#line 610 "zla_gerfsx_extended.f"
		} else if (dzrat > *rthresh) {
#line 611 "zla_gerfsx_extended.f"
		    if (y_prec_state__ != 2) {
#line 612 "zla_gerfsx_extended.f"
			incr_prec__ = TRUE_;
#line 613 "zla_gerfsx_extended.f"
		    } else {
#line 614 "zla_gerfsx_extended.f"
			z_state__ = 3;
#line 615 "zla_gerfsx_extended.f"
		    }
#line 616 "zla_gerfsx_extended.f"
		} else {
#line 617 "zla_gerfsx_extended.f"
		    if (dzrat > dzratmax) {
#line 617 "zla_gerfsx_extended.f"
			dzratmax = dzrat;
#line 617 "zla_gerfsx_extended.f"
		    }
#line 618 "zla_gerfsx_extended.f"
		}
#line 619 "zla_gerfsx_extended.f"
		if (z_state__ > 1) {
#line 619 "zla_gerfsx_extended.f"
		    final_dz_z__ = dz_z__;
#line 619 "zla_gerfsx_extended.f"
		}
#line 620 "zla_gerfsx_extended.f"
	    }
...
#line 626 "zla_gerfsx_extended.f"
	    if (x_state__ != 1) {
#line 627 "zla_gerfsx_extended.f"
		if (*ignore_cwise__) {
#line 627 "zla_gerfsx_extended.f"
		    goto L666;
#line 627 "zla_gerfsx_extended.f"
		}
#line 628 "zla_gerfsx_extended.f"
		if (z_state__ == 3 || z_state__ == 2) {
#line 628 "zla_gerfsx_extended.f"
		    goto L666;
#line 628 "zla_gerfsx_extended.f"
		}
#line 630 "zla_gerfsx_extended.f"
		if (z_state__ == 0 && cnt > 1) {
#line 630 "zla_gerfsx_extended.f"
		    goto L666;
#line 630 "zla_gerfsx_extended.f"
		}
#line 631 "zla_gerfsx_extended.f"
	    }
#line 633 "zla_gerfsx_extended.f"
	    if (incr_prec__) {
#line 634 "zla_gerfsx_extended.f"
		incr_prec__ = FALSE_;
#line 635 "zla_gerfsx_extended.f"
		++y_prec_state__;
#line 636 "zla_gerfsx_extended.f"
		i__3 = *n;
#line 636 "zla_gerfsx_extended.f"
		for (i__ = 1; i__ <= i__3; ++i__) {
#line 637 "zla_gerfsx_extended.f"
		    i__4 = i__;
#line 637 "zla_gerfsx_extended.f"
		    y_tail__[i__4].r = 0., y_tail__[i__4].i = 0.;
#line 638 "zla_gerfsx_extended.f"
		}
#line 639 "zla_gerfsx_extended.f"
	    }
#line 641 "zla_gerfsx_extended.f"
	    prevnormdx = normdx;
#line 642 "zla_gerfsx_extended.f"
	    prev_dz_z__ = dz_z__;

/*           Update soluton. */

#line 646 "zla_gerfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 647 "zla_gerfsx_extended.f"
		zaxpy_(n, &c_b8, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 648 "zla_gerfsx_extended.f"
	    } else {
#line 649 "zla_gerfsx_extended.f"
		zla_wwaddw__(n, &y[j * y_dim1 + 1], &y_tail__[1], &dy[1]);
#line 650 "zla_gerfsx_extended.f"
	    }
#line 652 "zla_gerfsx_extended.f"
	}
/*        Target of "IF (Z_STOP .AND. X_STOP)".  Sun's f77 won't EXIT. */
#line 654 "zla_gerfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh */

#line 658 "zla_gerfsx_extended.f"
	if (x_state__ == 1) {
#line 658 "zla_gerfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 658 "zla_gerfsx_extended.f"
	}
#line 659 "zla_gerfsx_extended.f"
	if (z_state__ == 1) {
#line 659 "zla_gerfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 659 "zla_gerfsx_extended.f"
...
#line 663 "zla_gerfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 664 "zla_gerfsx_extended.f"
	    errs_n__[j + (errs_n_dim1 << 1)] = final_dx_x__ / (1 - dxratmax);
#line 666 "zla_gerfsx_extended.f"
	}
#line 667 "zla_gerfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 668 "zla_gerfsx_extended.f"
	    errs_c__[j + (errs_c_dim1 << 1)] = final_dz_z__ / (1 - dzratmax);
#line 669 "zla_gerfsx_extended.f"
	}
...
#line 679 "zla_gerfsx_extended.f"
	zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 680 "zla_gerfsx_extended.f"
	zgemv_(trans, n, n, &c_b6, &a[a_offset], lda, &y[j * y_dim1 + 1], &
		c__1, &c_b8, &res[1], &c__1, (ftnlen)1);
#line 683 "zla_gerfsx_extended.f"
	i__2 = *n;
#line 683 "zla_gerfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 684 "zla_gerfsx_extended.f"
	    i__3 = i__ + j * b_dim1;
#line 684 "zla_gerfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__3].r, abs(d__1)) + (d__2 = d_imag(&b[i__ 
		    + j * b_dim1]), abs(d__2));
#line 685 "zla_gerfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 689 "zla_gerfsx_extended.f"
	zla_geamv__(trans_type__, n, n, &c_b31, &a[a_offset], lda, &y[j * 
		y_dim1 + 1], &c__1, &c_b31, &ayb[1], &c__1);
#line 692 "zla_gerfsx_extended.f"
	zla_lin_berr__(n, n, &c__1, &res[1], &ayb[1], &berr_out__[j]);

/*     End of loop for each RHS. */

#line 696 "zla_gerfsx_extended.f"
    }

#line 698 "zla_gerfsx_extended.f"
    return 0;
