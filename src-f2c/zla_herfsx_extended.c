...
#line 501 "zla_herfsx_extended.f"
	return 0;
#line 502 "zla_herfsx_extended.f"
    }
#line 503 "zla_herfsx_extended.f"
    eps = dlamch_("Epsilon", (ftnlen)7);
#line 504 "zla_herfsx_extended.f"
    hugeval = dlamch_("Overflow", (ftnlen)8);
/*     Force HUGEVAL to Inf */
#line 506 "zla_herfsx_extended.f"
    hugeval *= hugeval;
...
#line 512 "zla_herfsx_extended.f"
    } else {
...
#line 520 "zla_herfsx_extended.f"
		i__3 = i__;
#line 520 "zla_herfsx_extended.f"
...
#line 530 "zla_herfsx_extended.f"
	prevnormdx = hugeval;
#line 531 "zla_herfsx_extended.f"
	prev_dz_z__ = hugeval;
#line 532 "zla_herfsx_extended.f"
	dz_z__ = hugeval;
#line 533 "zla_herfsx_extended.f"
	dx_x__ = hugeval;
#line 535 "zla_herfsx_extended.f"
	x_state__ = 1;
#line 536 "zla_herfsx_extended.f"
	z_state__ = 0;
#line 537 "zla_herfsx_extended.f"
	incr_prec__ = FALSE_;
#line 539 "zla_herfsx_extended.f"
	i__2 = *ithresh;
#line 539 "zla_herfsx_extended.f"
...
#line 544 "zla_herfsx_extended.f"
...
#line 549 "zla_herfsx_extended.f"
		blas_zhemv_x__(&uplo2, n, &c_b14, &a[a_offset], lda, &y[j * 
			...
			prec_type__);
#line 551 "zla_herfsx_extended.f"
	    } else {
...
#line 558 "zla_herfsx_extended.f"
	    zcopy_(n, &res[1], &c__1, &dy[1], &c__1);
#line 559 "zla_herfsx_extended.f"
...
#line 564 "zla_herfsx_extended.f"
	    normy = 0.;
#line 565 "zla_herfsx_extended.f"
	    normdx = 0.;
#line 566 "zla_herfsx_extended.f"
	    dz_z__ = 0.;
#line 567 "zla_herfsx_extended.f"
	    ymin = hugeval;
#line 569 "zla_herfsx_extended.f"
	    i__3 = *n;
#line 569 "zla_herfsx_extended.f"
...
#line 575 "zla_herfsx_extended.f"
		} else if (dyk != 0.) {
#line 576 "zla_herfsx_extended.f"
		    dz_z__ = hugeval;
#line 577 "zla_herfsx_extended.f"
		}
#line 579 "zla_herfsx_extended.f"
		ymin = min(ymin,yk);
...
#line 587 "zla_herfsx_extended.f"
		    normx = normy;
#line 588 "zla_herfsx_extended.f"
...
#line 595 "zla_herfsx_extended.f"
		dx_x__ = 0.;
#line 596 "zla_herfsx_extended.f"
	    } else {
#line 597 "zla_herfsx_extended.f"
		dx_x__ = hugeval;
#line 598 "zla_herfsx_extended.f"
	    }
#line 600 "zla_herfsx_extended.f"
	    dxrat = normdx / prevnormdx;
#line 601 "zla_herfsx_extended.f"
	    dzrat = dz_z__ / prev_dz_z__;

/*         Check termination criteria. */

#line 605 "zla_herfsx_extended.f"
...
#line 622 "zla_herfsx_extended.f"
		}
...
#line 624 "zla_herfsx_extended.f"
	    }
#line 626 "zla_herfsx_extended.f"
...
#line 645 "zla_herfsx_extended.f"
		}
...
#line 647 "zla_herfsx_extended.f"
	    }
#line 649 "zla_herfsx_extended.f"
...
#line 656 "zla_herfsx_extended.f"
		for (i__ = 1; i__ <= i__3; ++i__) {
#line 657 "zla_herfsx_extended.f"
		    i__4 = i__;
#line 657 "zla_herfsx_extended.f"
...
#line 661 "zla_herfsx_extended.f"
	    prevnormdx = normdx;
#line 662 "zla_herfsx_extended.f"
	    prev_dz_z__ = dz_z__;
...
#line 668 "zla_herfsx_extended.f"
	    } else {
#line 669 "zla_herfsx_extended.f"
		zla_wwaddw__(n, &y[j * y_dim1 + 1], &y_tail__[1], &dy[1]);
#line 670 "zla_herfsx_extended.f"
	    }
#line 672 "zla_herfsx_extended.f"
	}
/*        Target of "IF (Z_STOP .AND. X_STOP)".  Sun's f77 won't EXIT. */
#line 674 "zla_herfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 678 "zla_herfsx_extended.f"
	if (x_state__ == 1) {
#line 678 "zla_herfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 678 "zla_herfsx_extended.f"
	}
#line 679 "zla_herfsx_extended.f"
	if (z_state__ == 1) {
#line 679 "zla_herfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 679 "zla_herfsx_extended.f"
...
#line 684 "zla_herfsx_extended.f"
	    err_bnds_norm__[j + (err_bnds_norm_dim1 << 1)] = final_dx_x__ / (
		    1 - dxratmax);
#line 686 "zla_herfsx_extended.f"
	}
#line 687 "zla_herfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 688 "zla_herfsx_extended.f"
	    err_bnds_comp__[j + (err_bnds_comp_dim1 << 1)] = final_dz_z__ / (
		    1 - dzratmax);
#line 690 "zla_herfsx_extended.f"
	}
...
#line 713 "zla_herfsx_extended.f"
	zla_lin_berr__(n, n, &c__1, &res[1], &ayb[1], &berr_out__[j]);

/*     End of loop for each RHS. */

#line 717 "zla_herfsx_extended.f"
    }

#line 719 "zla_herfsx_extended.f"
    return 0;
