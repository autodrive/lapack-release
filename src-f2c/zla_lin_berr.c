...
#line 145 "zla_lin_berr.f"
    safe1 = (*nz + 1) * safe1;
#line 147 "zla_lin_berr.f"
    i__1 = *nrhs;
#line 147 "zla_lin_berr.f"
    for (j = 1; j <= i__1; ++j) {
#line 148 "zla_lin_berr.f"
	berr[j] = 0.;
#line 149 "zla_lin_berr.f"
	i__2 = *n;
#line 149 "zla_lin_berr.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 150 "zla_lin_berr.f"
	    if (ayb[i__ + j * ayb_dim1] != 0.) {
#line 151 "zla_lin_berr.f"
		i__3 = i__ + j * res_dim1;
#line 151 "zla_lin_berr.f"
...
#line 151 "zla_lin_berr.f"
		tmp = z__1.r;
/* Computing MAX */
#line 152 "zla_lin_berr.f"
		d__1 = berr[j];
#line 152 "zla_lin_berr.f"
		berr[j] = max(d__1,tmp);
#line 153 "zla_lin_berr.f"
	    }

/*     If AYB is exactly 0.0 (and if computed by CLA_yyAMV), then we know */
/*     the true residual also must be exactly 0.0. */

#line 158 "zla_lin_berr.f"
	}
#line 159 "zla_lin_berr.f"
    }
#line 160 "zla_lin_berr.f"
    return 0;
} /* zla_lin_berr__ */
