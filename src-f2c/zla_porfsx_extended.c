...
#line 470 "zla_porfsx_extended.f"
...
#line 485 "zla_porfsx_extended.f"
	y_prec_state__ = 1;
#line 486 "zla_porfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 493 "zla_porfsx_extended.f"
	dxratmax = 0.;
#line 494 "zla_porfsx_extended.f"
	dzrat = 0.;
...
#line 504 "zla_porfsx_extended.f"
	z_state__ = 0;
#line 505 "zla_porfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 512 "zla_porfsx_extended.f"
	    zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 513 "zla_porfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 514 "zla_porfsx_extended.f"
...
#line 527 "zla_porfsx_extended.f"
	    zpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &dy[1], n, info, (
		    ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 531 "zla_porfsx_extended.f"
	    normx = 0.;
#line 532 "zla_porfsx_extended.f"
	    normy = 0.;
#line 533 "zla_porfsx_extended.f"
	    normdx = 0.;
...
#line 538 "zla_porfsx_extended.f"
		yk = (d__1 = y[i__4].r, abs(d__1)) + (d__2 = d_imag(&y[i__ + 
			j * y_dim1]), abs(d__2));
#line 539 "zla_porfsx_extended.f"
		i__4 = i__;
#line 539 "zla_porfsx_extended.f"
...
#line 543 "zla_porfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 547 "zla_porfsx_extended.f"
		ymin = min(ymin,yk);
#line 549 "zla_porfsx_extended.f"
		normy = max(normy,yk);
#line 551 "zla_porfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 552 "zla_porfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 553 "zla_porfsx_extended.f"
...
#line 561 "zla_porfsx_extended.f"
		dx_x__ = normdx / normx;
#line 562 "zla_porfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 573 "zla_porfsx_extended.f"
	    if (ymin * *rcond < incr_thresh__ * normy && y_prec_state__ < 2) {
#line 573 "zla_porfsx_extended.f"
		incr_prec__ = TRUE_;
#line 573 "zla_porfsx_extended.f"
	    }
#line 577 "zla_porfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 577 "zla_porfsx_extended.f"
		x_state__ = 1;
#line 577 "zla_porfsx_extended.f"
	    }
#line 579 "zla_porfsx_extended.f"
	    if (x_state__ == 1) {
#line 580 "zla_porfsx_extended.f"
		if (dx_x__ <= eps) {
#line 581 "zla_porfsx_extended.f"
		    x_state__ = 2;
...
#line 596 "zla_porfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 596 "zla_porfsx_extended.f"
		z_state__ = 1;
#line 596 "zla_porfsx_extended.f"
	    }
#line 598 "zla_porfsx_extended.f"
	    if (z_state__ == 1) {
#line 599 "zla_porfsx_extended.f"
		if (dz_z__ <= eps) {
#line 600 "zla_porfsx_extended.f"
		    z_state__ = 2;
...
#line 621 "zla_porfsx_extended.f"
	    if (incr_prec__) {
#line 622 "zla_porfsx_extended.f"
		incr_prec__ = FALSE_;
#line 623 "zla_porfsx_extended.f"
		++y_prec_state__;
...
#line 634 "zla_porfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 635 "zla_porfsx_extended.f"
		zaxpy_(n, &c_b12, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 636 "zla_porfsx_extended.f"
	    } else {
...
#line 642 "zla_porfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 646 "zla_porfsx_extended.f"
	if (x_state__ == 1) {
#line 646 "zla_porfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 646 "zla_porfsx_extended.f"
	}
#line 647 "zla_porfsx_extended.f"
	if (z_state__ == 1) {
#line 647 "zla_porfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 647 "zla_porfsx_extended.f"
...
#line 651 "zla_porfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 652 "zla_porfsx_extended.f"
...
#line 655 "zla_porfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 656 "zla_porfsx_extended.f"
...
#line 668 "zla_porfsx_extended.f"
	zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 669 "zla_porfsx_extended.f"
...
#line 672 "zla_porfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 673 "zla_porfsx_extended.f"
	    i__3 = i__ + j * b_dim1;
#line 673 "zla_porfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__3].r, abs(d__1)) + (d__2 = d_imag(&b[i__ 
		    + j * b_dim1]), abs(d__2));
#line 674 "zla_porfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 678 "zla_porfsx_extended.f"
...
#line 685 "zla_porfsx_extended.f"
    }

#line 687 "zla_porfsx_extended.f"
    return 0;
