...
#line 479 "zla_syrfsx_extended.f"
...
#line 479 "zla_syrfsx_extended.f"
    *info = 0;
#line 480 "zla_syrfsx_extended.f"
    upper = lsame_(uplo, "U", (ftnlen)1, (ftnlen)1);
#line 481 "zla_syrfsx_extended.f"
...
#line 514 "zla_syrfsx_extended.f"
	y_prec_state__ = 1;
#line 515 "zla_syrfsx_extended.f"
	if (y_prec_state__ == 2) {
...
#line 522 "zla_syrfsx_extended.f"
	dxratmax = 0.;
#line 523 "zla_syrfsx_extended.f"
	dzrat = 0.;
...
#line 533 "zla_syrfsx_extended.f"
	z_state__ = 0;
#line 534 "zla_syrfsx_extended.f"
	incr_prec__ = FALSE_;
...
#line 541 "zla_syrfsx_extended.f"
	    zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 542 "zla_syrfsx_extended.f"
	    if (y_prec_state__ == 0) {
#line 543 "zla_syrfsx_extended.f"
...
#line 556 "zla_syrfsx_extended.f"
	    zsytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &dy[1], n,
		     info, (ftnlen)1);

/*         Calculate relative changes DX_X, DZ_Z and ratios DXRAT, DZRAT. */

#line 560 "zla_syrfsx_extended.f"
	    normx = 0.;
#line 561 "zla_syrfsx_extended.f"
	    normy = 0.;
#line 562 "zla_syrfsx_extended.f"
	    normdx = 0.;
...
#line 567 "zla_syrfsx_extended.f"
		yk = (d__1 = y[i__4].r, abs(d__1)) + (d__2 = d_imag(&y[i__ + 
			j * y_dim1]), abs(d__2));
#line 568 "zla_syrfsx_extended.f"
		i__4 = i__;
#line 568 "zla_syrfsx_extended.f"
...
#line 572 "zla_syrfsx_extended.f"
		} else if (dyk != 0.) {
...
#line 576 "zla_syrfsx_extended.f"
		ymin = min(ymin,yk);
#line 578 "zla_syrfsx_extended.f"
		normy = max(normy,yk);
#line 580 "zla_syrfsx_extended.f"
		if (*colequ) {
/* Computing MAX */
...
#line 581 "zla_syrfsx_extended.f"
		    normx = max(d__1,d__2);
/* Computing MAX */
#line 582 "zla_syrfsx_extended.f"
...
#line 590 "zla_syrfsx_extended.f"
		dx_x__ = normdx / normx;
#line 591 "zla_syrfsx_extended.f"
	    } else if (normdx == 0.) {
...
#line 602 "zla_syrfsx_extended.f"
	    if (ymin * *rcond < incr_thresh__ * normy && y_prec_state__ < 2) {
#line 602 "zla_syrfsx_extended.f"
		incr_prec__ = TRUE_;
#line 602 "zla_syrfsx_extended.f"
	    }
#line 606 "zla_syrfsx_extended.f"
	    if (x_state__ == 3 && dxrat <= *rthresh) {
#line 606 "zla_syrfsx_extended.f"
		x_state__ = 1;
#line 606 "zla_syrfsx_extended.f"
	    }
#line 608 "zla_syrfsx_extended.f"
	    if (x_state__ == 1) {
#line 609 "zla_syrfsx_extended.f"
		if (dx_x__ <= eps) {
#line 610 "zla_syrfsx_extended.f"
		    x_state__ = 2;
...
#line 625 "zla_syrfsx_extended.f"
	    if (z_state__ == 3 && dzrat <= *rthresh) {
#line 625 "zla_syrfsx_extended.f"
		z_state__ = 1;
#line 625 "zla_syrfsx_extended.f"
	    }
#line 627 "zla_syrfsx_extended.f"
	    if (z_state__ == 1) {
#line 628 "zla_syrfsx_extended.f"
		if (dz_z__ <= eps) {
#line 629 "zla_syrfsx_extended.f"
		    z_state__ = 2;
...
#line 650 "zla_syrfsx_extended.f"
	    if (incr_prec__) {
#line 651 "zla_syrfsx_extended.f"
		incr_prec__ = FALSE_;
#line 652 "zla_syrfsx_extended.f"
		++y_prec_state__;
...
#line 663 "zla_syrfsx_extended.f"
	    if (y_prec_state__ < 2) {
#line 664 "zla_syrfsx_extended.f"
		zaxpy_(n, &c_b15, &dy[1], &c__1, &y[j * y_dim1 + 1], &c__1);
#line 665 "zla_syrfsx_extended.f"
	    } else {
...
#line 671 "zla_syrfsx_extended.f"
L666:

/*     Set final_* when cnt hits ithresh. */

#line 675 "zla_syrfsx_extended.f"
	if (x_state__ == 1) {
#line 675 "zla_syrfsx_extended.f"
	    final_dx_x__ = dx_x__;
#line 675 "zla_syrfsx_extended.f"
	}
#line 676 "zla_syrfsx_extended.f"
	if (z_state__ == 1) {
#line 676 "zla_syrfsx_extended.f"
	    final_dz_z__ = dz_z__;
#line 676 "zla_syrfsx_extended.f"
...
#line 680 "zla_syrfsx_extended.f"
	if (*n_norms__ >= 1) {
#line 681 "zla_syrfsx_extended.f"
...
#line 684 "zla_syrfsx_extended.f"
	if (*n_norms__ >= 2) {
#line 685 "zla_syrfsx_extended.f"
...
#line 697 "zla_syrfsx_extended.f"
	zcopy_(n, &b[j * b_dim1 + 1], &c__1, &res[1], &c__1);
#line 698 "zla_syrfsx_extended.f"
...
#line 701 "zla_syrfsx_extended.f"
	for (i__ = 1; i__ <= i__2; ++i__) {
#line 702 "zla_syrfsx_extended.f"
	    i__3 = i__ + j * b_dim1;
#line 702 "zla_syrfsx_extended.f"
	    ayb[i__] = (d__1 = b[i__3].r, abs(d__1)) + (d__2 = d_imag(&b[i__ 
		    + j * b_dim1]), abs(d__2));
#line 703 "zla_syrfsx_extended.f"
	}

/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */

#line 707 "zla_syrfsx_extended.f"
...
#line 714 "zla_syrfsx_extended.f"
    }

#line 716 "zla_syrfsx_extended.f"
    return 0;
