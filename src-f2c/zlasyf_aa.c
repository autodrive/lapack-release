...
#line 195 "zlasyf_aa.f"
    *info = 0;
#line 196 "zlasyf_aa.f"
    j = 1;

/*     K1 is the first column of the panel to be factorized */
/*     i.e.,  K1 is 2 for the first block column, and 1 for the rest of the blocks */

#line 201 "zlasyf_aa.f"
    k1 = 2 - *j1 + 1;

#line 203 "zlasyf_aa.f"
...
#line 261 "zlasyf_aa.f"
		zaxpy_(&i__1, &alpha, &a[k - 1 + (j + 1) * a_dim1], lda, &
			work[2], &c__1);
#line 263 "zlasyf_aa.f"
	    }

/*           Find max(|WORK(2:n)|) */

#line 267 "zlasyf_aa.f"
	    i__1 = *m - j;
#line 267 "zlasyf_aa.f"
	    i2 = izamax_(&i__1, &work[2], &c__1) + 1;
#line 268 "zlasyf_aa.f"
	    i__1 = i2;
#line 268 "zlasyf_aa.f"
...
#line 282 "zlasyf_aa.f"
		i1 = i1 + j - 1;
#line 283 "zlasyf_aa.f"
		i2 = i2 + j - 1;
#line 284 "zlasyf_aa.f"
		i__1 = i2 - i1 - 1;
#line 284 "zlasyf_aa.f"
...
#line 312 "zlasyf_aa.f"
		ipiv[j + 1] = j + 1;
#line 313 "zlasyf_aa.f"
	    }
...
#line 318 "zlasyf_aa.f"
	    if (a[i__1].r == 0. && a[i__1].i == 0. && (j == *m || a[i__2].r ==
		     0. && a[i__2].i == 0.)) {
#line 320 "zlasyf_aa.f"
		if (*info == 0) {
#line 321 "zlasyf_aa.f"
		    *info = j;
#line 322 "zlasyf_aa.f"
		}
#line 323 "zlasyf_aa.f"
	    }

#line 325 "zlasyf_aa.f"
	    if (j < *nb) {
...
#line 341 "zlasyf_aa.f"
		zlaset_("Full", &c__1, &i__1, &c_b18, &c_b18, &a[k + (j + 2) *
			 a_dim1], lda, (ftnlen)4);
#line 343 "zlasyf_aa.f"
	    }
#line 344 "zlasyf_aa.f"
	} else {
#line 345 "zlasyf_aa.f"
	    i__1 = k + j * a_dim1;
#line 345 "zlasyf_aa.f"
	    if (a[i__1].r == 0. && a[i__1].i == 0. && *info == 0) {
#line 346 "zlasyf_aa.f"
		*info = j;
#line 347 "zlasyf_aa.f"
	    }
#line 348 "zlasyf_aa.f"
	}
#line 349 "zlasyf_aa.f"
	++j;
#line 350 "zlasyf_aa.f"
	goto L10;
#line 351 "zlasyf_aa.f"
L20:

#line 353 "zlasyf_aa.f"
	;
#line 353 "zlasyf_aa.f"
    } else {
...
#line 359 "zlasyf_aa.f"
L30:
#line 360 "zlasyf_aa.f"
	if (j > min(*m,*nb)) {
#line 360 "zlasyf_aa.f"
	    goto L40;
#line 360 "zlasyf_aa.f"
...
#line 389 "zlasyf_aa.f"
	i__1 = *m - j + 1;
#line 389 "zlasyf_aa.f"
	zcopy_(&i__1, &h__[j + j * h_dim1], &c__1, &work[1], &c__1);

#line 391 "zlasyf_aa.f"
	if (j > k1) {

/*           Compute WORK := WORK - L(J:N, J-1) * T(J-1,J), */
/*            where A(J-1, J) = T(J-1, J) and A(J, J-2) = L(J, J-1) */

#line 396 "zlasyf_aa.f"
	    i__1 = j + (k - 1) * a_dim1;
#line 396 "zlasyf_aa.f"
	    z__1.r = -a[i__1].r, z__1.i = -a[i__1].i;
#line 396 "zlasyf_aa.f"
	    alpha.r = z__1.r, alpha.i = z__1.i;
#line 397 "zlasyf_aa.f"
	    i__1 = *m - j + 1;
#line 397 "zlasyf_aa.f"
...
#line 402 "zlasyf_aa.f"
	i__1 = j + k * a_dim1;
#line 402 "zlasyf_aa.f"
	a[i__1].r = work[1].r, a[i__1].i = work[1].i;

#line 404 "zlasyf_aa.f"
	if (j < *m) {
...
#line 409 "zlasyf_aa.f"
	    if (k > 1) {
#line 410 "zlasyf_aa.f"
		i__1 = j + k * a_dim1;
#line 410 "zlasyf_aa.f"
		z__1.r = -a[i__1].r, z__1.i = -a[i__1].i;
#line 410 "zlasyf_aa.f"
		alpha.r = z__1.r, alpha.i = z__1.i;
#line 411 "zlasyf_aa.f"
		i__1 = *m - j;
#line 411 "zlasyf_aa.f"
...
#line 426 "zlasyf_aa.f"
		i1 = 2;
#line 427 "zlasyf_aa.f"
		i__1 = i2;
#line 427 "zlasyf_aa.f"
		i__2 = i1;
#line 427 "zlasyf_aa.f"
...
#line 432 "zlasyf_aa.f"
		i1 = i1 + j - 1;
#line 433 "zlasyf_aa.f"
		i2 = i2 + j - 1;
#line 434 "zlasyf_aa.f"
		i__1 = i2 - i1 - 1;
#line 434 "zlasyf_aa.f"
...
#line 444 "zlasyf_aa.f"
		i__1 = i1 + (*j1 + i1 - 1) * a_dim1;
#line 444 "zlasyf_aa.f"
		piv.r = a[i__1].r, piv.i = a[i__1].i;
#line 445 "zlasyf_aa.f"
		i__1 = i1 + (*j1 + i1 - 1) * a_dim1;
#line 445 "zlasyf_aa.f"
...
#line 450 "zlasyf_aa.f"
		i__1 = i1 - 1;
#line 450 "zlasyf_aa.f"
		zswap_(&i__1, &h__[i1 + h_dim1], ldh, &h__[i2 + h_dim1], ldh);
#line 451 "zlasyf_aa.f"
		ipiv[i1] = i2;

#line 453 "zlasyf_aa.f"
		if (i1 > k1 - 1) {
...
#line 460 "zlasyf_aa.f"
		}
#line 461 "zlasyf_aa.f"
	    } else {
#line 462 "zlasyf_aa.f"
		ipiv[j + 1] = j + 1;
...
#line 467 "zlasyf_aa.f"
	    i__1 = j + 1 + k * a_dim1;
#line 467 "zlasyf_aa.f"
	    a[i__1].r = work[2].r, a[i__1].i = work[2].i;
#line 468 "zlasyf_aa.f"
	    i__1 = j + k * a_dim1;
#line 468 "zlasyf_aa.f"
	    i__2 = j + 1 + k * a_dim1;
#line 468 "zlasyf_aa.f"
	    if (a[i__1].r == 0. && a[i__1].i == 0. && (j == *m || a[i__2].r ==
		     0. && a[i__2].i == 0.)) {
#line 470 "zlasyf_aa.f"
		if (*info == 0) {
#line 470 "zlasyf_aa.f"
		    *info = j;
#line 470 "zlasyf_aa.f"
		}
#line 472 "zlasyf_aa.f"
	    }

#line 474 "zlasyf_aa.f"
	    if (j < *nb) {
...
#line 490 "zlasyf_aa.f"
		i__1 = *m - j - 1;
#line 490 "zlasyf_aa.f"
		zlaset_("Full", &i__1, &c__1, &c_b18, &c_b18, &a[j + 2 + k * 
			a_dim1], lda, (ftnlen)4);
#line 492 "zlasyf_aa.f"
	    }
#line 493 "zlasyf_aa.f"
	} else {
#line 494 "zlasyf_aa.f"
	    i__1 = j + k * a_dim1;
#line 494 "zlasyf_aa.f"
	    if (a[i__1].r == 0. && a[i__1].i == 0. && *info == 0) {
#line 495 "zlasyf_aa.f"
		*info = j;
#line 496 "zlasyf_aa.f"
	    }
#line 497 "zlasyf_aa.f"
	}
#line 498 "zlasyf_aa.f"
	++j;
#line 499 "zlasyf_aa.f"
	goto L30;
#line 500 "zlasyf_aa.f"
L40:
#line 501 "zlasyf_aa.f"
	;
#line 501 "zlasyf_aa.f"
    }
#line 502 "zlasyf_aa.f"
    return 0;
