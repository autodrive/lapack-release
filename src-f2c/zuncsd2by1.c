...
#line 480 "zuncsd2by1.f"
		lorgqrmin = max(lorgqrmin,*p);
/* Computing MAX */
#line 481 "zuncsd2by1.f"
		i__1 = lorgqropt, i__2 = (integer) work[1].r;
#line 481 "zuncsd2by1.f"
		lorgqropt = max(i__1,i__2);
#line 482 "zuncsd2by1.f"
	    }
...
#line 544 "zuncsd2by1.f"
	if (wantu2 && *m - *p > 0) {
#line 545 "zuncsd2by1.f"
	    i__1 = *m - *p;
#line 545 "zuncsd2by1.f"
	    zlacpy_("L", &i__1, q, &x21[x21_offset], ldx21, &u2[u2_offset], 
		    ldu2, (ftnlen)1);
#line 546 "zuncsd2by1.f"
	    i__1 = *m - *p;
#line 546 "zuncsd2by1.f"
	    i__2 = *m - *p;
#line 546 "zuncsd2by1.f"
...
#line 598 "zuncsd2by1.f"
		i__2 = j + u1_dim1;
#line 598 "zuncsd2by1.f"
		u1[i__2].r = 0., u1[i__2].i = 0.;
#line 599 "zuncsd2by1.f"
	    }
#line 600 "zuncsd2by1.f"
	    i__1 = *p - 1;
#line 600 "zuncsd2by1.f"
	    i__2 = *p - 1;
#line 600 "zuncsd2by1.f"
...
#line 653 "zuncsd2by1.f"
	if (wantu2 && *m - *p > 0) {
#line 654 "zuncsd2by1.f"
	    i__1 = u2_dim1 + 1;
#line 654 "zuncsd2by1.f"
	    u2[i__1].r = 1., u2[i__1].i = 0.;
#line 655 "zuncsd2by1.f"
	    i__1 = *m - *p;
#line 655 "zuncsd2by1.f"
	    for (j = 2; j <= i__1; ++j) {
...
#line 682 "zuncsd2by1.f"
	if (*q > r__) {
#line 683 "zuncsd2by1.f"
	    i__1 = r__;
#line 683 "zuncsd2by1.f"
	    for (i__ = 1; i__ <= i__1; ++i__) {
#line 684 "zuncsd2by1.f"
		iwork[i__] = *q - r__ + i__;
...
#line 721 "zuncsd2by1.f"
	    for (j = 2; j <= i__1; ++j) {
#line 722 "zuncsd2by1.f"
		i__2 = j * u2_dim1 + 1;
#line 722 "zuncsd2by1.f"
		u2[i__2].r = 0., u2[i__2].i = 0.;
#line 723 "zuncsd2by1.f"
	    }
#line 724 "zuncsd2by1.f"
	    i__1 = *m - *p - 1;
#line 724 "zuncsd2by1.f"
	    i__2 = *m - *q - 1;
#line 724 "zuncsd2by1.f"
...
#line 751 "zuncsd2by1.f"
	if (*p > r__) {
#line 752 "zuncsd2by1.f"
	    i__1 = r__;
#line 752 "zuncsd2by1.f"
	    for (i__ = 1; i__ <= i__1; ++i__) {
#line 753 "zuncsd2by1.f"
		iwork[i__] = *p - r__ + i__;
#line 754 "zuncsd2by1.f"
	    }
#line 755 "zuncsd2by1.f"
	    i__1 = *p;
#line 755 "zuncsd2by1.f"
	    for (i__ = r__ + 1; i__ <= i__1; ++i__) {
#line 756 "zuncsd2by1.f"
		iwork[i__] = i__ - r__;
#line 757 "zuncsd2by1.f"
	    }
#line 758 "zuncsd2by1.f"
	    if (wantu1) {
#line 759 "zuncsd2by1.f"
		zlapmt_(&c_false, p, p, &u1[u1_offset], ldu1, &iwork[1]);
#line 760 "zuncsd2by1.f"
	    }
#line 761 "zuncsd2by1.f"
	    if (wantv1t) {
#line 762 "zuncsd2by1.f"
		zlapmr_(&c_false, p, q, &v1t[v1t_offset], ldv1t, &iwork[1]);
#line 763 "zuncsd2by1.f"
	    }
#line 764 "zuncsd2by1.f"
	}
#line 765 "zuncsd2by1.f"
    }

#line 767 "zuncsd2by1.f"
    return 0;
